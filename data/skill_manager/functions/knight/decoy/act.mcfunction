...
###---演出---Start
execute if score @s SupportSkill matches 12041 as @e[distance=..10] unless entity @s[tag=!Mob,tag=!Animal] at @s run particle minecraft:witch ~ ~-1 ~ 0.2 1 0.2 0 100 force @a[tag=ShowParticles]
execute if score @s SupportSkill matches 12042 as @e[distance=..20] unless entity @s[tag=!Mob,tag=!Animal] at @s run particle minecraft:witch ~ ~1 ~ 0.2 1 0.2 0 100 force @a[tag=ShowParticles]
execute if score @s SupportSkill matches 12043 as @e[distance=..30] unless entity @s[tag=!Mob,tag=!Animal] at @s run particle minecraft:witch ~ ~1 ~ 0.2 1 0.2 0 100 force @a[tag=ShowParticles]
