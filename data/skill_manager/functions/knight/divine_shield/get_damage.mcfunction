...
execute if score @s ModeSkill matches 11032 run scoreboard players operation $Damage Global *= $15 Const
execute if score @s ModeSkill matches 11033 run scoreboard players operation $Damage Global *= $20 Const
