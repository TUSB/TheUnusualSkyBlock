...
execute if score @s ModeSkill matches 999942 run scoreboard players operation $Damage Global *= $3 Const
execute if score @s ModeSkill matches 999942 run scoreboard players operation $Damage Global /= $2 Const
execute if score @s ModeSkill matches 999943 run scoreboard players operation $Damage Global *= $2 Const

execute if score @s ModeSkill matches 999941 run scoreboard players operation $Damage Global < $10000 Const
execute if score @s ModeSkill matches 999942 run scoreboard players operation $Damage Global < $20000 Const
execute if score @s ModeSkill matches 999943 run scoreboard players operation $Damage Global < $30000 Const
