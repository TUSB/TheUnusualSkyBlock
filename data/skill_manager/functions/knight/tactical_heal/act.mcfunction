...
particle minecraft:heart ~ ~ ~ 1.5 0 0.2 1 30 force @a[tag=ShowParticles]
particle minecraft:heart ~ ~ ~ 0.2 0 1.5 1 30 force @a[tag=ShowParticles]
particle minecraft:instant_effect ~ ~0.3 ~ 1 0 1 1 200 force @a[tag=ShowParticles]
###---演出---End
