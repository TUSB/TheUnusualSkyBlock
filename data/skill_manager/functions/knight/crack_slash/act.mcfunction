...
###飛翔物スキル設定
execute if score @s ModeSkill matches 11021 run scoreboard players set @e[tag=Initializing,limit=1] SkillAttribute 15000
execute if score @s ModeSkill matches 11022 run scoreboard players set @e[tag=Initializing,limit=1] SkillAttribute 45000
execute if score @s ModeSkill matches 11023 run scoreboard players set @e[tag=Initializing,limit=1] SkillAttribute 125000
