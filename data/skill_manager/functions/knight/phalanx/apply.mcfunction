...
###---演出---Start
playsound minecraft:block.anvil.use master as @a[distance=..15] ~ ~ ~ 0.8 2
playsound minecraft:block.anvil.use master as @a[distance=..15] ~ ~ ~ 0.8 1.6
playsound minecraft:block.anvil.use master as @a[distance=..15] ~ ~ ~ 0.8 1.2
