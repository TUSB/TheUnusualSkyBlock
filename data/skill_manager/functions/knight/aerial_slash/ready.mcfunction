...
### 的を持ってない場合は生成
execute unless entity @e[tag=ActiveAerial,limit=1] run summon minecraft:horse ~ ~ ~ {Silent:true,NoAI:true,AbsorptionAmount:1E10f,ActiveEffects:[{Id:14b,Duration:2147483647,Amplifier:127b,ShowParticles:false}],Tags:[CooldownRequired,Aerial,ActiveAerial],Team:NoCollision}
