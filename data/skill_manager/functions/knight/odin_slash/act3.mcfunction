...
###ダメージ設定
execute if score @s ModeSkill matches 11071 run scoreboard players set $Damage Global 140000
execute if score @s ModeSkill matches 11072 run scoreboard players set $Damage Global 220000
