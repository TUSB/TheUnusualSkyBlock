...
execute if entity @s[nbt={HandItems:[{Count:1b}]}] run particle minecraft:item iron_sword ~ ~2 ~ 0 0 0 0.2 29 force @a[tag=ShowParticles]
...
scoreboard players set $Damage Global 1400000
