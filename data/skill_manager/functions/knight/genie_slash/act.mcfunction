...
execute if score @s ModeSkill matches 11063 at @e[tag=MeleeTarget,limit=1] as @e[distance=..3,tag=Mob] at @s run function skill_manager:knight/genie_slash/apply3
