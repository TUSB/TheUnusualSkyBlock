...
particle minecraft:entity_effect ~ ~0.5 ~ 0.6 0.6 0.6 1 30 force @a[tag=ShowParticles]
particle minecraft:happy_villager ~ ~0.5 ~ 0.6 0.6 0.6 1 20 force @a[tag=ShowParticles]
###---演出---End
