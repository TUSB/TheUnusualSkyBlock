...
summon minecraft:wolf ~ ~ ~ {Team:Friendly,AbsorptionAmount:40f,ActiveEffects:[{Id:11b,Duration:2147483647,Amplifier:0b,ShowParticles:false}],Attributes:[{Name:"generic.maxHealth",Modifiers:[{Amount:20d}]},{Name:"generic.attackDamage",Modifiers:[{Amount:56d}]},{Name:"generic.movementSpeed",Base:0.4d}],Passengers:[{id:"minecraft:item",Item:{id:"minecraft:bone",Count:3b}}]}
