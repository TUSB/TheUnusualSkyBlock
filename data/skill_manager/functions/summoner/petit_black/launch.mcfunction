...
execute anchored eyes positioned ^ ^ ^5 run summon minecraft:armor_stand ~ ~ ~ {Marker:true,NoGravity:true,Invulnerable:true,Invisible:true,PortalCooldown:60,Tags:[CooldownRequired,PetitBlack,Initializing]}
