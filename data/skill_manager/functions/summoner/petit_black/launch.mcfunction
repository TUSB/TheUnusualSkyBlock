...
execute if score @s ModeSkill matches 61112 anchored eyes positioned ^ ^ ^5 run summon minecraft:armor_stand ~ ~ ~ {Marker:true,NoGravity:true,Invulnerable:true,Invisible:true,PortalCooldown:150,Tags:[CooldownRequired,PetitBlack,Initializing]}
