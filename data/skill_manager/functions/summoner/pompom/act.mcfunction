...
###花火の設定をする
execute positioned ^ ^ ^-0.25 run summon minecraft:snowball ~ ~1.52 ~ {NoGravity:true,PortalCooldown:7,Tags:[CooldownRequired,PomPom,Initializing],Color:-1b}
###座標取得
...
playsound minecraft:entity.parrot.ambient master @a[distance=..16] ~ ~ ~ 1 0
playsound minecraft:entity.parrot.ambient master @a[distance=..16] ~ ~ ~ 1 0
execute anchored eyes run particle minecraft:end_rod ^ ^ ^2 0 0 0 0.05 0 force @a[tag=ShowParticles]
execute anchored eyes run particle minecraft:end_rod ^ ^ ^4 0 0 0 0.05 0 force @a[tag=ShowParticles]
execute anchored eyes run particle minecraft:end_rod ^ ^ ^6 0 0 0 0.05 0 force @a[tag=ShowParticles]
execute anchored eyes run particle minecraft:end_rod ^ ^ ^8 0 0 0 0.05 0 force @a[tag=ShowParticles]
execute anchored eyes run particle minecraft:end_rod ^ ^ ^10 0 0 0 0.05 0 force @a[tag=ShowParticles]
###---演出---End
