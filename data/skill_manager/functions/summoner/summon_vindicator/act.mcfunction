...
summon minecraft:vindicator ~ ~2.4 ~ {Motion:[0d,-1d,0d],Team:Friendly,Health:80f,ActiveEffects:[{Id:11b,Duration:2147483647,Amplifier:0b,ShowParticles:false}],Attributes:[{Name:"generic.maxHealth",Base:80d},{Name:"generic.knockbackResistance",Modifiers:[{Amount:15d,UUIDLeast:0l},{Amount:20d,UUIDLeast:1l},{Amount:100d,UUIDLeast:2l}]},{Name:"generic.attackDamage",Base:1500d},{Name:"generic.movementSpeed",Base:0.4d}],Johnny:true,Tags:[HasSkill,Servant],CustomName:"[\"フレンドリー\"]",CustomNameVisible:true}
...
particle minecraft:angry_villager ~ ~0.3 ~ 0.6 1 0.6 1 15 force
###---演出---End
