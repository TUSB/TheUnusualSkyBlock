...
execute if score @s ModeSkill matches 61021 run scoreboard players set $Damage Global 10000
execute if score @s ModeSkill matches 61022 run scoreboard players set $Damage Global 20000
