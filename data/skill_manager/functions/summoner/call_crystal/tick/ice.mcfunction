...
execute if entity @s[tag=Particle] rotated ~90 0 run particle minecraft:dust 0.527 0.804 0.917 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force
execute if entity @s[tag=Particle] rotated ~150 0 run particle minecraft:dust 0.527 0.804 0.917 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force
execute if entity @s[tag=Particle] rotated ~-150 0 run particle minecraft:dust 0.527 0.804 0.917 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force
execute if entity @s[tag=Particle] rotated ~-90 0 run particle minecraft:dust 0.527 0.804 0.917 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force
execute if entity @s[tag=Particle] rotated ~-30 0 run particle minecraft:dust 0.527 0.804 0.917 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force
###---演出---End
