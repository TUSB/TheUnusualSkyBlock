...
###---演出---Start
execute if entity @s[tag=Particle] rotated ~30 0 run particle minecraft:dust 0 0 0 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force @a[tag=ShowParticles]
execute if entity @s[tag=Particle] rotated ~90 0 run particle minecraft:dust 0 0 0 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force @a[tag=ShowParticles]
execute if entity @s[tag=Particle] rotated ~150 0 run particle minecraft:dust 0 0 0 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force @a[tag=ShowParticles]
execute if entity @s[tag=Particle] rotated ~-150 0 run particle minecraft:dust 0 0 0 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force @a[tag=ShowParticles]
execute if entity @s[tag=Particle] rotated ~-90 0 run particle minecraft:dust 0 0 0 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force @a[tag=ShowParticles]
execute if entity @s[tag=Particle] rotated ~-30 0 run particle minecraft:dust 0 0 0 0.75 ^ ^1.5 ^1 0 1.25 0 0 7 force @a[tag=ShowParticles]
###---演出---End
