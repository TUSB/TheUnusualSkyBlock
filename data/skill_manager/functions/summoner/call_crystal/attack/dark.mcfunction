...
###---演出---Start
particle minecraft:dust 0 0 0 3 ~ ~4 ~ 0.2 2 0.2 0 100 force
particle minecraft:dust 0 0 0 3 ~ ~ ~ 1 0 1 0 100 force
particle minecraft:dust 0 0 0 3 ~ ~-0.5 ~ 2 0 2 0 100 force
particle minecraft:dust 0 0 0 3 ~ ~-1 ~ 5 0 5 0 100 force
###---演出---End

function skill_manager:summoner/call_crystal/attack/common

scoreboard players operation @e[distance=..15,tag=Mob,tag=!WeakToDark,tag=Undead] Damage += $BaseDamage Global
