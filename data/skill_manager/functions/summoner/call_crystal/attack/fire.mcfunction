...
particle minecraft:dust 1 0 0 3 ~ ~-1 ~ 4 0 4 0 100 force
###---演出---End

function skill_manager:summoner/call_crystal/attack/common

scoreboard players operation @e[distance=..10,tag=Mob,tag=!WeakToFire,nbt={Fire:-1s}] Damage += $BaseDamage Global
