...
particle minecraft:dust 1 1 1 3 ~ ~-1 ~ 5 0 5 0 100 force
###---演出---End

function skill_manager:summoner/call_crystal/attack/common

scoreboard players operation @e[distance=..15,tag=Mob,tag=!WeakToLight,tag=!Undead] Damage += $BaseDamage Global
