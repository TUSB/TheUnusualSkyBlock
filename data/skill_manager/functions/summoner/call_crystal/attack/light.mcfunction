...
###---演出---Start
particle minecraft:dust 1 1 1 3 ~ ~4 ~ 0.2 2 0.2 0 100 force @a[tag=ShowParticles]
particle minecraft:dust 1 1 1 3 ~ ~ ~ 1 0 1 0 100 force @a[tag=ShowParticles]
particle minecraft:dust 1 1 1 3 ~ ~-0.5 ~ 2 0 2 0 100 force @a[tag=ShowParticles]
particle minecraft:dust 1 1 1 3 ~ ~-1 ~ 5 0 5 0 100 force @a[tag=ShowParticles]
###---演出---End
