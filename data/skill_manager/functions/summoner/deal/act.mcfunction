...
execute as @e[distance=..30,tag=Mob] at @s if block ~ ~-1 ~ minecraft:white_wool run particle minecraft:item minecraft:white_wool ~ ~0.5 ~ 0 0.5 0 0.2 100 force @a[tag=ShowParticles]
execute as @e[distance=..30,tag=Mob] at @s if block ~ ~-1 ~ minecraft:white_wool run particle minecraft:cloud ~ ~0.5 ~ 0 0 0 0.2 15 force @a[tag=ShowParticles]
###---演出---End
