...
execute if score $ChangeSupNo Global matches 7201 run scoreboard players operation $ChangeSupInterval Global = $7201 Interval
...
execute if score $ChangeSupNo Global matches 7202 run scoreboard players operation $ChangeSupInterval Global = $7202 Interval
...
execute if score $ChangeSupNo Global matches 7203 run scoreboard players operation $ChangeSupInterval Global = $7203 Interval
...
execute if score $ChangeSupNo Global matches 7204 run scoreboard players operation $ChangeSupInterval Global = $7204 Interval
...
execute if score $ChangeSupNo Global matches 7205 run scoreboard players operation $ChangeSupInterval Global = $7205 Interval
...
execute if score $ChangeSupNo Global matches 7206 run scoreboard players operation $ChangeSupInterval Global = $7206 Interval
...
execute if score $ChangeSupNo Global matches 7207 run scoreboard players operation $ChangeSupInterval Global = $7207 Interval
...
execute if score $ChangeSupNo Global matches 7208 run scoreboard players operation $ChangeSupInterval Global = $7208 Interval
...
execute if score $ChangeSupNo Global matches 7209 run scoreboard players operation $ChangeSupInterval Global = $7209 Interval
