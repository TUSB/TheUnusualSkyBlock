...
execute if score $ChangeModeNo Global matches 7101 run scoreboard players operation $ChangeModeInterval Global = $7101 Interval
...
execute if score $ChangeModeNo Global matches 7102 run scoreboard players operation $ChangeModeInterval Global = $7102 Interval
...
execute if score $ChangeModeNo Global matches 7103 run scoreboard players operation $ChangeModeInterval Global = $7103 Interval
...
execute if score $ChangeModeNo Global matches 7104 run scoreboard players operation $ChangeModeInterval Global = $7104 Interval
...
execute if score $ChangeModeNo Global matches 7105 run scoreboard players operation $ChangeModeInterval Global = $7105 Interval
