...
execute if score $ChangeModeNo Global matches 6102 run scoreboard players operation $ChangeModeInterval Global = $6102 Interval
...
execute if score $ChangeModeNo Global matches 6103 run scoreboard players operation $ChangeModeInterval Global = $6103 Interval
...
execute if score $ChangeModeNo Global matches 6104 run scoreboard players operation $ChangeModeInterval Global = $6104 Interval
...
execute if score $ChangeModeNo Global matches 6105 run scoreboard players operation $ChangeModeInterval Global = $6105 Interval
...
execute if score $ChangeModeNo Global matches 6106 run scoreboard players operation $ChangeModeInterval Global = $6106 Interval
...
execute if score $ChangeModeNo Global matches 6107 run scoreboard players operation $ChangeModeInterval Global = $6107 Interval
...
execute if score $ChangeModeNo Global matches 6108 run scoreboard players operation $ChangeModeInterval Global = $6108 Interval
...
execute if score $ChangeModeNo Global matches 6109 run scoreboard players operation $ChangeModeInterval Global = $6109 Interval
...
execute if score $ChangeModeNo Global matches 6110 run scoreboard players operation $ChangeModeInterval Global = $6110 Interval
...
execute if score $ChangeModeNo Global matches 6111 run scoreboard players operation $ChangeModeInterval Global = $6111 Interval
