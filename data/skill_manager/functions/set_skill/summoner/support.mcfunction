...
execute if score $ChangeSupNo Global matches 6201 run scoreboard players operation $ChangeSupInterval Global = $6201 Interval
...
execute if score $ChangeSupNo Global matches 6202 run scoreboard players operation $ChangeSupInterval Global = $6202 Interval
...
execute if score $ChangeSupNo Global matches 6203 run scoreboard players operation $ChangeSupInterval Global = $6203 Interval
...
execute if score $ChangeSupNo Global matches 6204 run scoreboard players operation $ChangeSupInterval Global = $6204 Interval
...
execute if score $ChangeSupNo Global matches 6205 run scoreboard players operation $ChangeSupInterval Global = $6205 Interval
...
execute if score $ChangeSupNo Global matches 6206 run scoreboard players operation $ChangeSupInterval Global = $6206 Interval
...
execute if score $ChangeSupNo Global matches 6207 run scoreboard players operation $ChangeSupInterval Global = $6207 Interval
...
execute if score $ChangeSupNo Global matches 6208 run scoreboard players operation $ChangeSupInterval Global = $6208 Interval
...
execute if score $ChangeSupNo Global matches 6209 run scoreboard players operation $ChangeSupInterval Global = $6209 Interval
