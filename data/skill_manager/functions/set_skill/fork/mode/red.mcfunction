...
scoreboard players operation $TargetSkillJob Global /= $100 Const
function skill_manager:get_level
###共通スコアに代入
scoreboard players operation $ChangeModeNo Global = @s ChangeModeRed
scoreboard players set $ChangeModeCost Global 0
###スキル値算出
execute unless score $ChangeModeNo Global matches 1..999 run function skill_manager:set_skill/error
execute if score $ChangeModeNo Global matches 111..119 run function skill_manager:set_skill/knight/mode
execute if score $ChangeModeNo Global matches 211..219 run function skill_manager:set_skill/ninja/mode
execute if score $ChangeModeNo Global matches 311..319 run function skill_manager:set_skill/hunter/mode
execute if score $ChangeModeNo Global matches 411..419 run function skill_manager:set_skill/white_mage/mode
execute if score $ChangeModeNo Global matches 511..519 run function skill_manager:set_skill/black_mage/mode
execute if score $ChangeModeNo Global matches 611..619 run function skill_manager:set_skill/summoner/mode
execute if score $ChangeModeNo Global matches 711..719 run function skill_manager:set_skill/puppet_master/mode
###スキル未設定化
execute unless score $ChangeModeNo Global matches 1000..9999 run scoreboard players set $ChangeModeCost Global 0
execute unless score $ChangeModeNo Global matches 1000..9999 run scoreboard players set $ChangeModeNo Global 100
###スキル変更不可時
