...
execute if score $ChangeSupNo Global matches 1201 run scoreboard players operation $ChangeSupInterval Global = $1201 Interval
...
execute if score $ChangeSupNo Global matches 1202 run scoreboard players operation $ChangeSupInterval Global = $1202 Interval
...
execute if score $ChangeSupNo Global matches 1203 run scoreboard players operation $ChangeSupInterval Global = $1203 Interval
...
execute if score $ChangeSupNo Global matches 1204 run scoreboard players operation $ChangeSupInterval Global = $1204 Interval
...
execute if score $ChangeSupNo Global matches 1205 run scoreboard players operation $ChangeSupInterval Global = $1205 Interval
