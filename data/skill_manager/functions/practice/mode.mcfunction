...
### 黒魔導士＜ワイルドカード＞
execute if score @s ActiveSkill matches 51061..51069 run function skill_manager:black_mage/wild_card/roll/act
execute if score @s ActiveSkill matches 51071..51079 run function skill_manager:black_mage/wild_card/cast/act
