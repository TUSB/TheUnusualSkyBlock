...
###---演出---Start
particle minecraft:dust 1 1 0 2.2 ~ ~10 ~ 0.15 5 0.15 0 100 force
particle minecraft:end_rod ~ ~10 ~ 0.15 5 0.15 0 15 force
particle minecraft:item minecraft:horn_coral_block ~ ~ ~ 0 0 0 0.4 100 force
