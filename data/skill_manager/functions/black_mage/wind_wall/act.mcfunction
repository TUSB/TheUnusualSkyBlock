...
execute if score @s SneakTime matches 1.. if score @s SupportSkill matches 52091 run scoreboard players set @a[distance=..15] WindWall 1200
execute if score @s SneakTime matches 1.. if score @s SupportSkill matches 52092 run scoreboard players set @s[distance=..15] WindWall 11200
