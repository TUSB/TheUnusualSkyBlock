...
execute if score @s ModeSkill matches 51043 run scoreboard players set $Damage Global 64000
...
###---演出---Start
execute as @e[tag=Initializing] positioned as @s run particle minecraft:block minecraft:granite ~ ~1.2 ~ 0.8 0.8 0.8 1 50 force @a[tag=ShowParticles]
execute as @e[tag=Initializing] positioned as @s run particle minecraft:explosion ~ ~ ~ 0.1 0.1 0.1 1 2 force @a[tag=ShowParticles]
execute as @e[tag=Initializing] positioned as @s run particle minecraft:angry_villager ~ ~ ~ 0.6 0.6 0.6 1 5 force @a[tag=ShowParticles]
execute as @e[tag=Initializing] positioned as @s run particle minecraft:dragon_breath ~ ~0.1 ~ 0 0 0 0.08 15 force @a[tag=ShowParticles]
