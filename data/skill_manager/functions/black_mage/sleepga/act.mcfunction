...
execute positioned as @e[tag=SleepgaTarget,limit=1,sort=nearest] run particle minecraft:cloud ~ ~ ~ 1.5 1.5 1.5 0.3 100 force
execute unless entity @e[tag=SleepgaTarget,limit=1] run particle minecraft:cloud ~ ~ ~ 1.5 1.5 1.5 0.3 100 force
###---演出---End
