...
###槍召喚
execute positioned ^ ^ ^-2 run summon minecraft:trident ~ ~301.52 ~ {Invulnerable:true,Silent:true,DealtDamage:true,Tags:[IceStorm,Initializing]}
execute as @e[tag=Initializing,limit=1] positioned ^ ^ ^-2 run tp @s ~ ~1.52 ~
###モーション取得
