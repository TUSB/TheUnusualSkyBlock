...
###---演出---Start
particle minecraft:block minecraft:white_wool ~ ~ ~ 0.2 0.2 0.2 0 7 force @a[tag=ShowParticles]
particle minecraft:item minecraft:blue_ice ~ ~ ~ 0.2 0.2 0.2 0.15 7 force @a[tag=ShowParticles]
particle dust 0.3 0.7 100000000 2 ~ ~ ~ 0 0 0 1 1 force @a[tag=ShowParticles]
