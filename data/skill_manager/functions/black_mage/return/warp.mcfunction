...
#初期設定
execute unless score @s HomeX matches -2147483648.. run scoreboard players set @s HomeX -58
execute unless score @s HomeY matches -2147483648.. run scoreboard players set @s HomeY 18
execute unless score @s HomeZ matches -2147483648.. run scoreboard players set @s HomeZ 19
#Pos代入
