...
###ダメージ/吸収レート
execute if score @s ModeSkill matches 52081 run scoreboard players set $AbsorbRate Global 50
execute if score @s ModeSkill matches 52082 run scoreboard players set $AbsorbRate Global 30
execute if score @s ModeSkill matches 52083 run scoreboard players set $AbsorbRate Global 20
###サブルーチンコール
