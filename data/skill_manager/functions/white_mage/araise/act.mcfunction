...
execute rotated ~ 0 run summon minecraft:area_effect_cloud ~ ~ ~ {Particle:mobSpell,ReapplicationDelay:40,Radius:1f,RadiusPerTick:0.05f,Duration:50,Color:16774912}
