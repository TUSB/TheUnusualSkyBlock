...
execute positioned as @s run summon minecraft:area_effect_cloud ~ ~ ~ {Particle:"minecraft:mobSpell",ReapplicationDelay:40,Radius:1f,RadiusPerTick:0.04f,Duration:100,Color:16774912}
