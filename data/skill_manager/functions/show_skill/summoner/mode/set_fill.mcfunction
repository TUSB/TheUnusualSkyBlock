...
execute as @s[scores={ModeSkillBlue=61011,SetFillSize=1..3}] run scoreboard players operation @s FillSize = @s SetFillSize
execute as @s[scores={ModeSkillBlue=61012,SetFillSize=1..4}] run scoreboard players operation @s FillSize = @s SetFillSize
execute as @s[scores={ModeSkillBlue=61013,SetFillSize=1..5}] run scoreboard players operation @s FillSize = @s SetFillSize
###表示用計算
...
execute as @s[scores={ModeSkillBlue=61011,SetFillSize=1..3}] run tellraw @s [{"text":"サイズを変更しました。","color":"green","bold":true},{"text":"➡","color":"white"},{"score":{"name":"$FillSize","objective":"Global"},"color":"white"},{"text":"x","color":"white"},{"score":{"name":"$FillSize","objective":"Global"},"color":"white"}]
execute as @s[scores={ModeSkillBlue=61012,SetFillSize=1..4}] run tellraw @s [{"text":"サイズを変更しました。","color":"green","bold":true},{"text":"➡","color":"white"},{"score":{"name":"$FillSize","objective":"Global"},"color":"white"},{"text":"x","color":"white"},{"score":{"name":"$FillSize","objective":"Global"},"color":"white"}]
execute as @s[scores={ModeSkillBlue=61013,SetFillSize=1..5}] run tellraw @s [{"text":"サイズを変更しました。","color":"green","bold":true},{"text":"➡","color":"white"},{"score":{"name":"$FillSize","objective":"Global"},"color":"white"},{"text":"x","color":"white"},{"score":{"name":"$FillSize","objective":"Global"},"color":"white"}]
###再クリック時にエラーがでないように
