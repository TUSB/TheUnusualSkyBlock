...
tp @s ^ ^ ^1
execute positioned ~-0.5 ~-0.5 ~-0.5 as @a[gamemode=!creative,gamemode=!spectator,dx=0,dy=0,dz=0,tag=!Applied] at @s run function skill_manager:enemy/icing_ray/damage_apply
...
execute if score $LoopCount Global matches 0.. at @s run function skill_manager:enemy/icing_ray/loop
