...
execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[2].Amount 10000
...
execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[3].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
execute if score $Random Global < $Threshold Global run function skill_manager:enemy/skill/2

execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[4].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
execute if score $Random Global < $Threshold Global run function skill_manager:enemy/skill/3

execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[5].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
execute if score $Random Global < $Threshold Global run function skill_manager:enemy/skill/4

execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[6].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
execute if score $Random Global < $Threshold Global run function skill_manager:enemy/skill/5

execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[7].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
execute if score $Random Global < $Threshold Global run function skill_manager:enemy/skill/6

execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[8].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
execute if score $Random Global < $Threshold Global run function skill_manager:enemy/skill/7

execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[9].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
execute if score $Random Global < $Threshold Global run function skill_manager:enemy/skill/8

execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[10].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
execute if score $Random Global < $Threshold Global run function skill_manager:enemy/skill/9

execute store result score $Probability Global run data get entity @s Attributes[1].Modifiers[11].Amount 10000
execute if score $Threshold Global matches 0.. run scoreboard players operation $Threshold Global += $Probability Global
