...
execute if entity @s[tag=Haste] run function skill_manager:enemy/haste/level
...
execute if entity @s[tag=SelfDamage] run function skill_manager:enemy/self_damage
