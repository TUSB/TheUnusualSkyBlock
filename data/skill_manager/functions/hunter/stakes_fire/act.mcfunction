...
execute if score @s ModeSkill matches 999911 if score $Random Global matches 32768.. run scoreboard players set $Magnify Global 10
execute if score @s ModeSkill matches 999912 if score $Random Global matches 21845.. run scoreboard players set $Magnify Global 15
execute if score @s ModeSkill matches 99991 if score $Random Global matches 16384.. run scoreboard players set $Magnify Global 20
execute if score @s ModeSkill matches 999914 if score $Random Global matches 13107.. run scoreboard players set $Magnify Global 25
