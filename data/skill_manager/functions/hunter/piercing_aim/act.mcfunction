...
particle minecraft:happy_villager ~ ~0.5 ~ 1.5 0 1.5 1 20 force @a[tag=ShowParticles]
particle minecraft:item minecraft:conduit ~ ~0.5 ~ 1.5 0 1.5 0.1 20 force @a[tag=ShowParticles]
###---演出---End
