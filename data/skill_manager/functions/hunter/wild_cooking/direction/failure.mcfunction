...
execute rotated ~ 0 run particle minecraft:smoke ^ ^1 ^1.2 0.2 0.1 0.2 0.05 30 force @a[tag=ShowParticles]
execute rotated ~ 0 run particle minecraft:explosion ^ ^1 ^1.7 0 0 0 0 0 force @a[tag=ShowParticles]
###---演出---End
