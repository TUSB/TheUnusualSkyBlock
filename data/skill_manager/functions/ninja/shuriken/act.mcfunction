...
###ダメージ保存
execute if score @s ModeSkill matches 21011 run scoreboard players set $Damage Global 20000
execute if score @s ModeSkill matches 21012 run scoreboard players set $Damage Global 70000
execute if score @s ModeSkill matches 21013 run scoreboard players set $Damage Global 120000
execute if score @s ModeSkill matches 21014 run scoreboard players set $Damage Global 350000
execute if score @s ModeSkill matches 21015 run scoreboard players set $Damage Global 700000
