...
execute if score @s SupportSkill matches 22071 positioned as @e[distance=..20,type=item,nbt={Invulnerable:false}] run particle minecraft:portal ~ ~ ~ 0 0 0 0.2 50 force
execute if score @s SupportSkill matches 22072 positioned as @e[distance=..30,type=item,nbt={Invulnerable:false}] run particle minecraft:portal ~ ~ ~ 0 0 0 0.2 50 force
