...
execute if score @s Issen matches 20.. at @s as @e[distance=..2.5,tag=Mob] run particle minecraft:item minecraft:nether_wart ~ ~1 ~ 0.3 0.5 0.3 0.2 50 force
execute if score @s Issen matches 20.. at @s as @e[distance=..2.5,tag=Mob] run particle minecraft:item minecraft:redstone_block ~ ~1 ~ 0.1 0.1 0.1 0.2 15 force
