...
give @a[distance=..7] minecraft:splash_potion{tutorial_item:true,CustomPotionColor:2063390,CustomPotionEffects:[{Duration:40,Id:14,Amplifier:10b}],display:{ Name:'[{"translate":"ペイル","color":"red","bold":true}]'}}
