...
give @s minecraft:splash_potion{tutorial_item:true,CustomPotionColor:12522773,CustomPotionEffects:[{Duration:160,Id:14,Amplifier:3b}],display:{ Name:'[{"translate":"火だるま","color":"red","bold":true}," ",{"text":"(8s)"}]'}}
