...
give @a[distance=..7] minecraft:splash_potion{tutorial_item:true,CustomPotionColor:5233912,CustomPotionEffects:[{Duration:40,Id:14,Amplifier:4b}],display:{ Name:'[{"translate":"凍結","color":"red","bold":true}]'}}
