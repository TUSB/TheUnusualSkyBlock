...
give @a[distance=..7] minecraft:splash_potion{tutorial_item:true,CustomPotionColor:8722713,CustomPotionEffects:[{Duration:40,Id:14,Amplifier:9b}],display:{ Name:'[{"translate":"トント","color":"red","bold":true}]'}}
