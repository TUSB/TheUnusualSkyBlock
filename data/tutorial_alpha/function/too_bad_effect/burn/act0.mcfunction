#> tutorial_alpha:too_bad_effect/burn/act0

tellraw @s ["",{"translate":"[チュートリアル：%1$s]","bold":true,"with":[{"translate":"特殊デバフ：%1$s","with":[{"interpret":true,"storage":"effect:","nbt":"BadEffectsName.Burn"}]}]},"\n",{"translate":"%1$sのデバフ。\n毎秒%2$sを受けます。\n時間経過で解除され、通常の炎上と同じく%3$sことで解除できます。","color":"white","with":[{"translate":"炎属性","color":"red"},{"translate":"火属性のダメージ","color":"red"},{"translate":"水に入る","color":"blue"}]}]
