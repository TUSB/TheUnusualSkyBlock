...
summon minecraft:item_display ~ ~500 ~ {Tags:[Tutorial.job.Level],item:{id:"nether_star",count:1},transformation:{translation:[0.f,1.5f,0f],left_rotation:{axis:[0f,0f,0f],angle:1.571f},right_rotation:[0f,0f,0f,1f],scale:[2f,2f,2f]}}
