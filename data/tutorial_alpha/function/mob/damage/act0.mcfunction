#> tutorial_alpha:mob/damage/act0
...
summon armor_stand ~ ~ ~-1 {Tags:[Spawn],DeathTime:19s,Silent:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:stick",count:1,components:{custom_model_data:1,"minecraft:custom_data":{SpawnEntities:[[{Tags:[Global,Neutrality,Blow,00Woolscaffold,SpawnParticles],Level:1}]]}}}]}
