...
execute if score @s SneakTrigger matches 40 run scoreboard players set _ Calc 3
execute if score @s SneakTrigger matches 40 run scoreboard players operation _ _ /= _ Calc
