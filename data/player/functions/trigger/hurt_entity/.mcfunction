...
#モブの位置をマーク
execute at @e[tag=Mob,nbt=!{AbsorptionAmount:1000000f}] run function calc:geometry/tp_00002
...
execute if entity @s[advancements={player:trigger/hurt_entity={hit_skill_snowball=true}}] run function player:trigger/hurt_entity/hit_skill_snowball
...
execute at 0-0-0-0-2 as @e[tag=Mob,nbt=!{AbsorptionAmount:1000000f},distance=0] run function enemy:update_absorption_amount
