...
tellraw @s ""
tellraw @s [{"translate":"TUSB神社","color":"#ffffff"}," : ",{"storage":"area:","nbt":"capture.flying_island{046:0}.046","font":"ender_eye","color":"gray"},{"storage":"area:","nbt":"capture.flying_island{046:1}.046","font":"ender_eye"}]
tellraw @s [{"translate":"飛空島道場","color":"#ffffff"}," : ",{"storage":"area:","nbt":"capture.flying_island{047:0}.047","font":"ender_eye","color":"gray"},{"storage":"area:","nbt":"capture.flying_island{047:1}.047","font":"ender_eye"}]
