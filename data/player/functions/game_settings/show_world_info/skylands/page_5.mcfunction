...
tellraw @s ""
tellraw @s [{"translate":"エンドポータル島","color":"#ff5353"}," : ",{"storage":"area:","nbt":"capture.skylands{045:0}.045","font":"ender_eye","color":"gray"},{"storage":"area:","nbt":"capture.skylands{045:1}.045","font":"ender_eye","color": "white"}]
