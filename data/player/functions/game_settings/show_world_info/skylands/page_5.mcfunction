...
tellraw @s [{"translate":"混沌群島","color":"#ffffff"}," : ",{"storage":"area:","nbt":"capture.skylands{046:0}.046","font":"ender_eye","color":"gray"},{"storage":"area:","nbt":"capture.skylands{046:1}.046","font":"ender_eye","color": "white"}]
tellraw @s ""
tellraw @s ""
tellraw @s ""
tellraw @s ""
