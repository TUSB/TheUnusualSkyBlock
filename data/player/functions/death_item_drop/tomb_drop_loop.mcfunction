...
data modify entity @e[type=item,distance=..1,tag=!Initialized,sort=nearest,limit=1] Item.tag.DeathInventory set from storage item: Item[0].tag.DeathInventory
data modify entity @e[type=item,distance=..1,tag=!Initialized,sort=nearest,limit=1] Item.tag.DeathUUID set from storage item: Item[0].tag.DeathUUID
data modify entity @e[type=item,distance=..1,tag=!Initialized,sort=nearest,limit=1] Item.tag.display.Name set from storage item: Item[0].tag.display.Name
tag @e[type=item,distance=..1,tag=!Initialized,sort=nearest,limit=1] add Initialized
