...
execute store result score $_ RotateAngle run data get entity 0-0-0-0-20 Rotation[0] 100
execute store result score $_ TiltAngle run data get entity 0-0-0-0-20 Rotation[1] 100
### 変更基準の向きを取得
execute store result entity 0-0-0-0-20 Rotation[0] float 0.01 run scoreboard players operation $_ RotateAngle += @s RotateAngle
...
execute store result score $_ X run data get entity 0-0-0-0-20 Pos[0] 1
execute store result score $_ Y run data get entity 0-0-0-0-20 Pos[1] 1
execute store result score $_ Z run data get entity 0-0-0-0-20 Pos[2] 1
execute store result score $__ X run data get entity @s Motion[0] 100
execute store result score $__ Y run data get entity @s Motion[1] 100
execute store result score $__ Z run data get entity @s Motion[2] 100
execute store result entity @s Motion[0] double 0.01 run scoreboard players operation $_ X += $__ X
execute store result entity @s Motion[1] double 0.01 run scoreboard players operation $_ Y += $__ Y
execute store result entity @s Motion[2] double 0.01 run scoreboard players operation $_ Z += $__ Z
