...
### アクションバー表示
execute if score @s SkillInterval > $0 Const if score $MilliSecond Global matches ..099 run data merge entity 0-0-0-0-0 {CustomName:"[{\"text\":\"スキル制限中：\",\"color\":\"red\",\"bold\":true},[{\"score\":{\"name\":\"$Second\",\"objective\":\"Global\"},\"color\":\"gold\"},\".0\",{\"score\":{\"name\":\"$MilliSecond\",\"objective\":\"Global\"}}],\"秒\"]"}
