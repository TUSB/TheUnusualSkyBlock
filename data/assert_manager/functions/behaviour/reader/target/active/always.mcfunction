...
execute as 0-0-0-0-0 unless entity @s[tag=ActiveTrigger.Always] run me function assert_manager:behaviour/reader/target/active/always 1
...
summon husk ~ ~ ~ {Team:Assert,UUIDMost:0l,UUIDLeast:0l,Tags:[Enemy],Passengers:[{id:item_frame,Tags:[Parameter],Item:{id:stone,Count:1b,tag:{TargetSettings:{ActiveTrigger:Always}}}}]}
