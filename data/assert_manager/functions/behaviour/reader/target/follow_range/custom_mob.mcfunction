...
execute as 0-0-0-0-0 unless score @s FollowRange matches 32768 run say function assert_manager:behaviour/reader/target/follow_range/custom_mob 1
execute as 0-0-0-0-0 unless entity @s[nbt={Attributes:[{Name:"generic.followRange",Base:327.68d}]}] run say function assert_manager:behaviour/reader/target/follow_range/custom_mob 2
