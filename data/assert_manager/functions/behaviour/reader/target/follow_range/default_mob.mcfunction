...
execute as 0-0-0-0-0 unless entity @s[nbt={Attributes:[{Name:"generic.followRange",Base:35.00d}]}] run say function assert_manager:behaviour/reader/target/follow_range/default_mob 2
