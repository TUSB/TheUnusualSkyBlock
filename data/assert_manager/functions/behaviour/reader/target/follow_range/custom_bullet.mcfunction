...
execute as 0-0-0-0-0 unless score @s FollowRange matches 32768 run me function assert_manager:behaviour/reader/target/follow_range/custom_bullet 1
execute as 0-0-0-0-0 unless entity @s[nbt={Attributes:[{Name:"generic.followRange",Base:327.68d}]}] run me function assert_manager:behaviour/reader/target/follow_range/custom_bullet 2
