...
execute as 0-0-0-0-0 unless score @s RepeaterDelay matches 0 run me function assert_manager:behaviour/reader/moves/repeater/delay/default 1
execute as 0-0-0-0-0 unless score @s RepeaterToStart matches 0 run me function assert_manager:behaviour/reader/moves/repeater/delay/default 2
