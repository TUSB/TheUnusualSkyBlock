...
execute unless entity 0-0-0-0-0 run me function assert_manager:behaviour/reader/moves/repeater/recycle/default 1t
execute unless entity 0-0-0-0-0 run schedule function assert_manager:behaviour/reader/moves/repeater/recycle/default 1t
...
execute as 0-0-0-0-0 unless entity @s[tag=!MoveRecycle] run me function assert_manager:behaviour/reader/moves/repeater/recycle/default 1
