...
execute unless entity 0-0-0-0-0 run me function assert_manager:behaviour/reader/moves/on_close/forward/default 1t
execute unless entity 0-0-0-0-0 run schedule function assert_manager:behaviour/reader/moves/on_close/forward/default 1t
...
execute as 0-0-0-0-0 unless score @s OnCloseForwardBy matches -1 run me function assert_manager:behaviour/reader/moves/on_close/forward/default 1
