...
execute as 0-0-0-0-0 unless score @s LeftwardSpeedMax matches 100000 run me function assert_manager:behaviour/reader/moves/leftward/speed_max/default 1
