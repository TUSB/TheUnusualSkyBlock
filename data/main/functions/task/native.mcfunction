...
###ディア
# execute if entity @s[tag=Dia] run function skill:act/white_mage/dia/tick
###フラワーギフト
...
###ぽむぽむ花火処理
# execute if entity @s[tag=PomPom,nbt={inGround:true}] run function skill:act/summoner/pompom/block
###ウィークペイント
