...
execute if entity @s[scores={Job=1,Level=50..}] run tellraw @s [""," JOB:",{"text":"剣士","color":"green"}," ","LV:",{"score":{"name":"$CurrentLevel","objective":"Global"},"color":"green"}," ","CP:",{"score":{"name":"$CurrentCP","objective":"Global"},"color":"green"}," ","EXP:",{"score":{"name":"@s","objective":"Exp"},"color":"green"},"/",{"score":{"name":"@s","objective":"RequiredExp"},"color":"green"}]
...
execute if entity @s[scores={Job=2,Level=50..}] run tellraw @s [""," JOB:",{"text":"忍者","color":"green"}," ","LV:",{"score":{"name":"$CurrentLevel","objective":"Global"},"color":"green"}," ","CP:",{"score":{"name":"$CurrentCP","objective":"Global"},"color":"green"}," ","EXP:",{"score":{"name":"@s","objective":"Exp"},"color":"green"},"/",{"score":{"name":"@s","objective":"RequiredExp"},"color":"green"}]
...
execute if entity @s[scores={Job=3,Level=50..}] run tellraw @s [""," JOB:",{"text":"狩人","color":"green"}," ","LV:",{"score":{"name":"$CurrentLevel","objective":"Global"},"color":"green"}," ","CP:",{"score":{"name":"$CurrentCP","objective":"Global"},"color":"green"}," ","EXP:",{"score":{"name":"@s","objective":"Exp"},"color":"green"},"/",{"score":{"name":"@s","objective":"RequiredExp"},"color":"green"}]
...
execute if entity @s[scores={Job=4,Level=50..}] run tellraw @s [""," JOB:",{"text":"白魔導士","color":"green"}," ","LV:",{"score":{"name":"$CurrentLevel","objective":"Global"},"color":"green"}," ","CP:",{"score":{"name":"$CurrentCP","objective":"Global"},"color":"green"}," ","EXP:",{"score":{"name":"@s","objective":"Exp"},"color":"green"},"/",{"score":{"name":"@s","objective":"RequiredExp"},"color":"green"}]
...
execute if entity @s[scores={Job=5,Level=50..}] run tellraw @s [""," JOB:",{"text":"黒魔導士","color":"green"}," ","LV:",{"score":{"name":"$CurrentLevel","objective":"Global"},"color":"green"}," ","CP:",{"score":{"name":"$CurrentCP","objective":"Global"},"color":"green"}," ","EXP:",{"score":{"name":"@s","objective":"Exp"},"color":"green"},"/",{"score":{"name":"@s","objective":"RequiredExp"},"color":"green"}]
...
execute if entity @s[scores={Job=6,Level=50..}] run tellraw @s [""," JOB:",{"text":"召喚士","color":"green"}," ","LV:",{"score":{"name":"$CurrentLevel","objective":"Global"},"color":"green"}," ","CP:",{"score":{"name":"$CurrentCP","objective":"Global"},"color":"green"}," ","EXP:",{"score":{"name":"@s","objective":"Exp"},"color":"green"},"/",{"score":{"name":"@s","objective":"RequiredExp"},"color":"green"}]
...
execute if entity @s[scores={Job=7,Level=50..}] run tellraw @s [""," JOB:",{"text":"絡繰士","color":"green"}," ","LV:",{"score":{"name":"$CurrentLevel","objective":"Global"},"color":"green"}," ","CP:",{"score":{"name":"$CurrentCP","objective":"Global"},"color":"green"}," ","EXP:",{"score":{"name":"@s","objective":"Exp"},"color":"green"},"/",{"score":{"name":"@s","objective":"RequiredExp"},"color":"green"}]
