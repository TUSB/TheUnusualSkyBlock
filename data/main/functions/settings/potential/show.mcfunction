...
### スコア表示バグ用
title @s subtitle [{"text":"                                                                                                                                                                                                                                                                                                            ","color":"black"},{"score":{"name":"$MPCostRate","objective":"Global"}},{"score":{"name":"$IntervalRate","objective":"Global"}},{"score":{"name":"$AuraRate","objective":"Global"}},{"score":{"name":"$ResistMin","objective":"Global"}},{"score":{"name":"$CritProbability","objective":"Global"}},{"score":{"name":"$SubLevel","objective":"Global"}}]
