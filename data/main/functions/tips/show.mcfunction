...
### BitFlagsを反転させて入れないといけない 8桁 11111111 = 255
scoreboard players set $BitFlags Global 255
...
execute if score $Digit Global matches 8 run tellraw @s ["",{"translate":"[TIPS] レベル50になりましたか？ レベル50でレベルアップすると、\n%1$s(CP)が貯められます。このポイントを使うと、\n色んなステータスを伸ばすことができます。\n%1$sは最大で50まで貯められます。","with":[{"text":"キャパシティポイント","color":"green"}],"bold":true},{"text":"➡このTIPSを表示しない","clickEvent":{"action":"run_command","value":"/trigger TipsSupTrigger set 8"}}]
