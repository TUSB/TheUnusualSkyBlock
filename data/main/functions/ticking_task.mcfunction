...
execute if entity @s[tag=AroundPlayer,tag=Yamagata] facing entity @p[gamemode=!spectator,scores={TimeSinceDeath=1..}] feet if entity @s[y_rotation=-90..0] rotated ~ ~-65 positioned ^ ^ ^1 run function calc_manager:get/angle1
execute if entity @s[tag=AroundPlayer,tag=Yamagata] facing entity @p[gamemode=!spectator,scores={TimeSinceDeath=1..}] feet if entity @s[y_rotation=1..90] rotated ~ ~65 positioned ^ ^ ^1 run function calc_manager:get/angle1
