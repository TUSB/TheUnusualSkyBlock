...
###---演出---Start
particle minecraft:dust 1 0 1 2 ~ ~2.1 ~ 0 0 0 1 1 force @a[tag=ShowParticles]
execute if score @s PupRecordLevel matches ..299 as @a[distance=..24,tag=ActiveMaster,limit=1] at @s anchored eyes run particle minecraft:witch ^ ^ ^0.5 0.1 0.3 0.1 0 5 force @a[tag=ShowParticles]
...
execute if score @s PupRecordLevel matches 300.. as @a[distance=..24] at @s anchored eyes run particle minecraft:witch ^ ^ ^0.5 0.1 0.3 0.1 0 5 force @a[tag=ShowParticles]
