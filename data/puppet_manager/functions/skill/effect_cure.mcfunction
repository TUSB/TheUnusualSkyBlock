...
execute if score @s PupRecordLevel matches ..299 as @a[distance=..24,tag=ActiveMaster,limit=1] at @s anchored eyes run particle minecraft:happy_villager ^ ^ ^0.5 0.2 0.2 0.2 0 5 force
...
execute if score @s PupRecordLevel matches 300.. as @a[distance=..24] at @s anchored eyes run particle minecraft:happy_villager ^ ^ ^0.5 0.2 0.2 0.2 0 5 force
