...
###レコードの種類とスロットを検索し
###スロット番号９－１７の場合、対応するレコードの種類のエンティティに１００を加算
###未出のレコードだった場合、そのスロット位置を保存
...
###レコードレベルが全て100未満の場合、機動力が最大値であるとみなす
...
##最大モードが機動力系の場合、その他で最大のものから、行動基準を算出する
