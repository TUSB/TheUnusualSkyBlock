...
##移動速度２
execute if score $Speed PuppetScore matches 100..199 if score $Acrobat PuppetScore matches 1.. store result entity @s Motion[1] double 0.00002 run scoreboard players get $DestinationY PuppetScore
##移動速度３
execute if score $Speed PuppetScore matches 200.. if score $Acrobat PuppetScore matches 1.. store result entity @s Motion[1] double 0.00002 run scoreboard players get $DestinationY PuppetScore
