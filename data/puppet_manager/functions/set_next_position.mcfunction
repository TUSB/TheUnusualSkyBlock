...
###移動用エンティティ召喚
summon minecraft:villager ~ ~ ~ {IsBaby:true,Attributes:[{"Name":"generic.knockbackResistance",Base:1d},{"Name":"generic.followRange",Base:0d},{"Name":"generic.maxHealth",Base:0.1d}],Health:0.1f,DeathLootTable:"minecraft:empty",ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticles:false}],Team:NoCollision,Tags:[Initialized,PuppetNext,Initializing,CooldownRequired],PortalCooldown:1,DeathTime:19s,Silent:true}
###IDリンク
