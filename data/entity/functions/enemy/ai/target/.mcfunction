...
execute if data storage mob_data: AI.Turn[0].Target{Look:"player"} facing entity @p[gamemode=!creative,gamemode=!spectator] feet run function entity:enemy/ai/target/player
