...
execute if data storage mob_data: AI.Turn[0].Exit{Half:"flont"} positioned ^ ^ ^1000 if entity @e[tag=Target,distance=..1000] run data modify storage mob_data: AI.Turn[0].Exit merge value {call_Exit:1b}
