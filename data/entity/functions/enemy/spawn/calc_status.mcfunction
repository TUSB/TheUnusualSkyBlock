...
execute store result storage tusb_mob: SpawnData.Attributes[{Name:"minecraft:generic.follow_range"}].Base int 1 run data get storage tusb_mob: "固有ステータス"."最大感知範囲"
execute store result storage tusb_mob: SpawnData.Attributes[{Name:"minecraft:generic.movement_speed"}].Base int 1 run data get storage tusb_mob: "固有ステータス"."基本移動力"
execute store result storage tusb_mob: SpawnData.Attributes[{Name:"minecraft:generic.knockback_resistance"}].Base int 1 run data get storage tusb_mob: "固有ステータス"."ノックバック耐性"
execute store result storage tusb_mob: SpawnData.Attributes[{Name:"minecraft:generic.attack_knockback"}].Base int 1 run data get storage tusb_mob: "固有ステータス"."ノックバック力"
