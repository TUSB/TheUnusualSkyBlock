...
execute store result score @s HP store result score @s HPMax run function entity:enemy/spawn/apply_status/apply_level
### 最大MPを計算する
data modify storage tusb_mob: _ set from storage tusb_mob: "遅延ステータス"."最大MP"
execute store result score @s MP store result score @s MPMax run function entity:enemy/spawn/apply_status/apply_level
### 物理攻撃力を計算する
data modify storage tusb_mob: _ set from storage tusb_mob: "遅延ステータス"."物理攻撃力"
execute store result score @s Attack run function entity:enemy/spawn/apply_status/apply_level
### 物理防御力を計算する
data modify storage tusb_mob: _ set from storage tusb_mob: "遅延ステータス"."物理防御力"
execute store result score @s Defense run function entity:enemy/spawn/apply_status/apply_level
### 魔法攻撃力を計算する
data modify storage tusb_mob: _ set from storage tusb_mob: "遅延ステータス"."魔法攻撃力"
execute store result score @s SpecialAttack run function entity:enemy/spawn/apply_status/apply_level
### 魔法防御力を計算する
data modify storage tusb_mob: _ set from storage tusb_mob: "遅延ステータス"."魔法防御力"
execute store result score @s SpecialDefense run function entity:enemy/spawn/apply_status/apply_level
