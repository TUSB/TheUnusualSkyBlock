execute if entity @s[advancements={enemy:projectile_damage={fireball=false,small_fireball=false,shulker_bullet=false}}] run data modify storage score_damage: Argument set value {DamageType:[Global,Projectile]}
