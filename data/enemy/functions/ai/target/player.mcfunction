...
execute store success score 0-0-0-0-2 _ at @a[gamemode=!creative,gamemode=!spectator,distance=..0.5,sort=nearest,limit=1] run function calc:geometry/tp_00002
