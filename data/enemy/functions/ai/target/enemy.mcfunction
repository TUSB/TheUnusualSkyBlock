...
execute unless entity @e[tag=Mob,distance=..0.5] unless data storage mob_data: AI.Turn[0].Target{Radius_check:0} positioned ^ ^ ^0.5 run function enemy:ai/target/player
