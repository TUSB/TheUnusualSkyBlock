...
execute if score @s _ matches 1 store result entity @s Rotation[1] float 0.01 run scoreboard players operation _ Calc += _ _
execute if score @s _ matches 0 store result entity @s Rotation[1] float 0.01 run scoreboard players operation _ Calc -= _ _
