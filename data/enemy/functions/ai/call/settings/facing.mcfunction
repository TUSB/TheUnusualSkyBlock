...
execute if data storage mob_data: Settings.Target if score 000000000-0000-0000-0000-000000000002 _ matches 1 facing entity 0-0-0-0-2 feet run tp 0-0-0-0-1 ^ ^ ^ ~ ~
