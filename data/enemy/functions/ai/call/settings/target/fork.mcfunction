...
execute if data storage mob_data: Target{Look:"Enemy"} facing entity @e[tag=Mob,tag=!NonTarget,sort=nearest,limit=1] feet run function enemy:ai/call/settings/target/enemy
