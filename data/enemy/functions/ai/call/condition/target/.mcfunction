...
execute if score 00000000-0000-0000-0000-000000000001 _ matches 1 if data storage mob_data: Condition.Half facing entity 0-0-0-0-1 feet positioned ^ ^ ^0.003 rotated as @s run function enemy:ai/call/condition/target/half
