...
##下にいるかを確認
execute if predicate entity:vehicle if predicate enemy:not_trigger_call_passenger if data storage mob_data: AI.Passenger{Type:"down",Check:1b} run function enemy:ai/call/trigger/passenger/trigger
