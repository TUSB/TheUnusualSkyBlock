...
execute if score _ Calc matches 1 in area:control_area positioned 0.0 0.0 0.0 run function enemy:ai/move/move_front_loop
execute unless score _ Calc matches 1 store result score _ _ run data get storage mob_data: AI.Turn[0].Move.Front 80
execute unless score _ Calc matches 1 facing ^ ^ ^-1 in area:control_area positioned 0.0 0.0 0.0 run function enemy:ai/move/move_front_loop
