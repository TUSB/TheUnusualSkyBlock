...
execute if entity @s[scores={SnowballTime=0..}] if entity @e[tag=CallOnAttackProjectile,distance=..3,limit=1,sort=nearest] at @s run function enemy:ai/call/trigger/attack/projectile
