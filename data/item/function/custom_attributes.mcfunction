...
# アイテム更新
item modify entity @s weapon.mainhand [{"function":"set_attributes","replace":false,"conditions":[{"condition":"inverted","term":{"condition":"entity_properties","entity":"this","predicate":{"equipment":{"mainhand":{"predicates":{"minecraft:attribute_modifiers":{"modifiers":{"contains":[{"attribute":"minecraft:attack_damage","id":"tusb:custom"}]}}}}}}}}],"modifiers":[{"attribute":"minecraft:attack_damage","id":"tusb:default","amount":{"type":"storage","storage":"item:","path":"AttributeModifiers.attack_damage"},"operation":"add_value","slot":"mainhand"}]},{"function":"set_attributes","replace":false,"conditions":[{"condition":"inverted","term":{"condition":"entity_properties","entity":"this","predicate":{"equipment":{"mainhand":{"predicates":{"minecraft:attribute_modifiers":{"modifiers":{"contains":[{"attribute":"minecraft:attack_speed","id":"tusb:custom"}]}}}}}}}}],"modifiers":[{"attribute":"minecraft:attack_speed","id":"tusb:default","amount":{"type":"storage","storage":"item:","path":"AttributeModifiers.attack_speed"},"operation":"add_value","slot":"mainhand"}]},{"function":"set_custom_data","tag":"{CustomAttributes:1b}"}]
# 演出
