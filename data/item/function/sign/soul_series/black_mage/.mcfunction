#> item:sign/soul_series/black_mage/
...
execute unless data entity @s SelectedItem.components."minecraft:custom_data".ApplyedSoul run function item:sign/soul_series/black_mage/apply
