#> item:sign/soul_series/black_mage/apply
##
...
data modify storage item: Item.components."minecraft:custom_data".ApplyedSoul set value "黒魔導士"
data modify storage item: Item.components."minecraft:lore" insert 0 value '{"translate":"魂 : %1$s","color":"white","italic":false,"with":[{"translate":"黒魔導士","color":"white","italic":false}]}'
