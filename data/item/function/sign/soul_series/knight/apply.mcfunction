...
data modify storage item: Item.components."minecraft:custom_data".ApplyedSoul set value "剣士"
data modify storage item: Item.components."minecraft:lore" insert 0 value '{"translate":"魂 : %1$s","color":"white","italic":false,"with":[{"translate":"剣士","color":"white","italic":false}]}'
...
## 演出
function makeup:item/sign/soul_series/knight
