#> item:sign/soul_series/hunter/apply
##
...
data modify storage item: Item.components."minecraft:custom_data".ApplyedSoul set value "狩人"
data modify storage item: Item.components."minecraft:lore" insert 0 value '{"translate":"魂 : %1$s","color":"white","italic":false,"with":[{"translate":"狩人","color":"white","italic":false}]}'
