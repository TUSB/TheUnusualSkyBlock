#> item:sign/soul_series/summoner/
...
execute unless data entity @s SelectedItem.components."minecraft:custom_data".ApplyedSoul run function item:sign/soul_series/summoner/apply
