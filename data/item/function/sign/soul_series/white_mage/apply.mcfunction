#> item:sign/soul_series/white_mage/apply
##
...
data modify storage item: Item.components."minecraft:custom_data".ApplyedSoul set value "白魔導士"
data modify storage item: Item.components."minecraft:lore" insert 0 value '{"translate":"魂 : %1$s","color":"white","italic":false,"with":[{"translate":"白魔導士","color":"white","italic":false}]}'
