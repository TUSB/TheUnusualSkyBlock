#> item:sign/soul_series/white_mage/
...
execute unless data entity @s SelectedItem.components."minecraft:custom_data".ApplyedSoul run function item:sign/soul_series/white_mage/apply
