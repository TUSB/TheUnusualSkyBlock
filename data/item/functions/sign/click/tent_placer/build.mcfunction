...
execute if score _ _ matches 0 run function makeup:item/sign/tent_placer_failed
...
execute if score _ _ matches 1 run function makeup:item/sign/tent_placer_success
