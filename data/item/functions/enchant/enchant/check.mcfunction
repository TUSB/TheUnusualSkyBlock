...
#エンチャント台を戻す
data modify storage item: Items append value {Slot:13b,id:"minecraft:enchanting_table",Count:1b,tag:{display:{Name:'{"translate":"エンチャント","color":"green","italic":false}',Lore:['{"translate":"↑ エンチャントするアイテム","color":"white","italic":false}','{"translate":"↓ 魔石","color":"white","italic":false}']},NoHold:1b}}
#エンティティに戻す
