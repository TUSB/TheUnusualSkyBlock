...
execute if predicate settings:item/enchant/item/shield run data modify storage item: Enchant.AttributeModifiers set value [{AttributeName:"generic.attack_speed",Name:"エンチャント",Operation:1,UUID:[I;11,0,100,53],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"エンチャント",Operation:1,UUID:[I;12,0,100,53],Slot:"offhand"}]
#Amountを取得、代入
