...
execute if predicate settings:item/enchant/item/shield run data modify storage item: Enchant.AttributeModifiers append value {AttributeName:"generic.armor",Name:"エンチャント",Operation:1,UUID:[I;11,0,2,52],Slot:"mainhand"}
execute if predicate settings:item/enchant/item/shield run data modify storage item: Enchant.AttributeModifiers append value {AttributeName:"generic.armor",Name:"エンチャント",Operation:1,UUID:[I;12,0,2,52],Slot:"offhand"}
#Amountを取得、代入
