...
execute if predicate settings:item/enchant/item/shield run data modify storage item: Enchant.AttributeModifiers set value [{AttributeName:"generic.armor",Name:"エンチャント",Operation:1,UUID:[I;11,0,100,52],Slot:"mainhand"},{AttributeName:"generic.armor",Name:"エンチャント",Operation:1,UUID:[I;12,0,100,52],Slot:"offhand"}]
#Amountを取得、代入
