...
execute if predicate settings:item/enchant/item/shield run data modify storage item: Enchant.AttributeModifiers set value [{AttributeName:"generic.movement_speed",Name:"エンチャント",Operation:1,UUID:[I;11,0,100,50],Slot:"mainhand"},{AttributeName:"generic.movement_speed",Name:"エンチャント",Operation:1,UUID:[I;12,0,100,50],Slot:"offhand"}]
#Amountを取得、代入
