...
data modify storage item: Enchant.AttributeModifiers append value {AttributeName:"generic.attack_damage",Name:"エンチャント",Operation:0,UUID:[I;11,0,2,2],Slot:"mainhand"}
#Amountを取得、代入
