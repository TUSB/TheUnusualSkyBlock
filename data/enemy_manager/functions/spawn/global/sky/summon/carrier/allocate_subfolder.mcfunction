...
execute if entity @s[tag=EruptionCarrier] run function enemy_manager:summon/global/sky/summon/carrier/eruption_carrier_35
...
execute if entity @s[tag=FlagSoldierCarrier] run function enemy_manager:summon/global/sky/summon/carrier/flag_soldier_carrier_68
execute if entity @s[tag=GenocidebombCarrier] run function enemy_manager:summon/global/sky/summon/carrier/genocidebomb_carrier_35
execute if entity @s[tag=GenocidebombIgnoredCarrier] run function enemy_manager:summon/global/sky/summon/carrier/genocidebomb_ignored_carrier_65
execute if entity @s[tag=GreatfloodCarrier] run function enemy_manager:summon/global/sky/summon/carrier/greatflood_carrier_30
execute if entity @s[tag=MonsterEggCarrier] run function enemy_manager:summon/global/sky/summon/carrier/monster_egg_carrier_60
execute if entity @s[tag=ThunderCarrier] run function enemy_manager:summon/global/sky/summon/carrier/thunder_carrier_35
execute if entity @s[tag=TorimochiCarrier] run function enemy_manager:summon/global/sky/summon/carrier/torimochi_carrier_37
