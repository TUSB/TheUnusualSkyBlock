...
execute if entity @s[tag=AcidBreath] run function enemy_manager:summon/event/acid_breath_60
execute if entity @s[tag=AcidbreathHold] run function enemy_manager:summon/event/acidbreath_hold_75
...
execute if entity @s[tag=BlazingBullet] run function enemy_manager:summon/event/blazing_bullet__30
execute if entity @s[tag=BlazingBulletStart] run function enemy_manager:summon/event/blazing_bullet_start_30
...
execute if entity @s[tag=IcingRay] run function enemy_manager:summon/event/icing_ray_40
...
execute if entity @s[tag=TrickyPotion] run function enemy_manager:summon/event/tricky_potion_15
