...
execute anchored eyes run summon minecraft:area_effect_cloud ^ ^ ^ {Tags:["CallOnFin","Event","Laser","CooldownRequired","FaceToPlayer"],Duration:600,Radius:0f,Particle:"minecraft:block minecraft:air",PortalCooldown:10s}
