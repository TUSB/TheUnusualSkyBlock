...
execute if entity @a[distance=..32,gamemode=!creative,gamemode=!spectator] if entity @s[nbt={OnGround:1b}] run playsound minecraft:entity.wither.break_block master @a[distance=..32] ~ ~ ~ 1 0.3 0.3
