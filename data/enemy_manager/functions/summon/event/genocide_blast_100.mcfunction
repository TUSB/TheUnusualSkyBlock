...
particle minecraft:flame ~ ~0.5 ~ 0.5 0.5 0.5 0.4 400 force @a[tag=ShowParticles] 
particle minecraft:portal ~ ~0.5 ~ 0 0 0 5 400 force @a[tag=ShowParticles] 
particle minecraft:dust -100000000 0 -10 3 ~ ~0.5 ~ 1.7 1.7 1.7 0.7 120 force @a[tag=ShowParticles] 
particle minecraft:dust -1 -100 100000000 4 ~ ~0.5 ~ 3.5 3.5 3.5 1 100 force @a[tag=ShowParticles] 
particle minecraft:dust 1 -100000000 100000000 2 ~ ~0.5 ~ 1.2 1.2 1.2 0.5 120 force @a[tag=ShowParticles]
