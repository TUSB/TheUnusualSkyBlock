...
effect give @a[gamemode=!creative,distance=..6] minecraft:instant_damage 1 4 true 
...
particle minecraft:dust 100000000 10000000 -10000000 4 ~ ~0.5 ~ 3.5 3.5 3.5 1 100 force @a[tag=ShowParticles] 
