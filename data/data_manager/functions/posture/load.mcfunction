...
execute at 1-0-0-0-1 run scoreboard players set @e[distance=0,tag=DataHolder,tag=Copy,limit=1] GlobalCSTimer -1000
...
### 向き
# execute at 1-0-0-0-1 run data modify entity 1-0-1-0-0 Rotation set from entity @e[distance=0,tag=DataHolder,limit=1] Item.tag.EntityData.Rotation
