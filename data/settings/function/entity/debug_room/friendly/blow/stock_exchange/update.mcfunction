...
execute unless score _ Calc matches 0 run function settings:entity/debug_room/friendly/blow/stock_exchange/add_stock
...
function settings:entity/debug_room/friendly/blow/stock_exchange/exchange_fluctuation
