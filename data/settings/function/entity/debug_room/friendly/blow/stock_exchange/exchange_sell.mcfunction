...
execute in area:control_area run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"取引番号："},{"storage":"mob_data:","nbt":"StockVillager.Recipe.buy.tag.Stock.ID"}," ",{"translate":"残り取引："},{"storage":"mob_data:","nbt":"StockVillager.Recipe.xp"}," ",{"translate":"買値："},{"storage":"mob_data:","nbt":"StockVillager.StockInfo[-1].BuyCount"}," "]'
execute in area:control_area if score # _ matches ..-004 run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇩⇩","color":"blue"}]'
execute in area:control_area if score # _ matches -3..-1 run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇩ ","color":"blue"}]'
...
execute in area:control_area if score # _ matches 01..03 run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇧ ","color":"red"}]'
execute in area:control_area if score # _ matches 0004.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇧⇧","color":"red"}]'
...
execute in area:control_area run tellraw @a {"nbt":"front_text.messages[0]","block":"2 3 2","interpret":true}
