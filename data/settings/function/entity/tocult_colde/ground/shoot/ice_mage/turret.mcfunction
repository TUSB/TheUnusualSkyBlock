...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:blue_ice",count:1,components:{"minecraft:enchantment_glint_override":true}}]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"function",Tags:[TocultColde,Ground,Shoot,IceMage,TurretSummonDirection]}],Tick:[{Name:"function",Tags:[TocultColde,Ground,Shoot,IceMage,TurretAppearance]}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:15d,IgnoreBlocks:true}}],Name:"change_turn",Set:2}]}]},{Index:2,Target:{Look:"Player",Radius:64d},Move:{Front:-0.25d},Rotate:[-1f,-1f],Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Inverse:true,Target:{Look:"Player",Radius:15d,IgnoreBlocks:true}}],Name:"change_turn",Set:1}]}]}]}
