### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",Silent:1b,CustomName:'{"translate":"アイスメイジ","color":"#FFFFFF"}',DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnTick,HasLootTable,AnalyseLog]}
data modify storage tusb_mob: "即時ステータス"."見た目" set value {HandItems:[{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_model_data":66}},{}],ArmorItems:[{},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:dyed_color":37590}},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":37590}},{id:"minecraft:warped_fungus_on_a_stick",count:1,components:{"minecraft:unbreakable":{},"minecraft:custom_model_data":14}}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s蜘蛛の中ではちょっと強い。","with":[{"translate":"【能力：格闘・射撃・凍結】","color":"#00FF00"}]}]'
# AI
