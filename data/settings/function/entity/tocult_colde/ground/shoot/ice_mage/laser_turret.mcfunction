...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"function",Tags:[TocultColde,Ground,Shoot,IceMage,LaserTurretAppearance]}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:60,Max:180,Current:1},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true},Anchor:"Eyes"}],Condition:[{Name:"has_target",Global:true,Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}],Name:"laser",Laser:"FrozenLaser",Loop:25},{Name:"function",Tags:[TocultColde,Ground,Shoot,IceMage,LaserTurretSound]}]}],Exit:{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:5d,IgnoreBlocks:true}}]}},{Index:2,Target:{Look:"Player",Radius:64d,IgnoreBlocks:1b},Move:{Front:-0.25d},Rotate:[-1f,-1f],Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{}]}],Exit:{Condition:[{Name:"has_target",Inverse:true,Target:{Look:"Player",Radius:5d,IgnoreBlocks:true}}]}}]}
