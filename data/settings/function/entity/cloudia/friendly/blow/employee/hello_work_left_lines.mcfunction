...
# 位置指定
execute positioned -1765 113 -138 if entity @s[distance=..1] run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].CCHelper set from storage mob_data: CCHelper
