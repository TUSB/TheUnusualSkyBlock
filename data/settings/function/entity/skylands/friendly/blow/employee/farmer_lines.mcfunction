#Function
# 定期的に
data modify storage mob_data: CCHelper.Repeat.texts set value ["今日も良い土だねぇ"]
data modify storage mob_data: CCHelper.Repeat.y_offset set value 0.7f
...
# 目が合ったら
data modify storage mob_data: CCHelper.Insight.texts set value ["いやぁー土いじりが好きすぎて\\nこんな頭になっちゃたんだよね。\\nハハハⓅ8・Ⓟ8・Ⓟ8・。それで何か買っていく？"]
data modify storage mob_data: CCHelper.Insight.y_offset set value 0.7f
...
# 話し掛けたら
data modify storage mob_data: CCHelper.Interact.texts set value ["土いじりしよう！\\n課題を熟せば良い物取引してあげるよ。"]
data modify storage mob_data: CCHelper.Interact.y_offset set value 0.7f
