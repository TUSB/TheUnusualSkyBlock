...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"random_chance",Chance:0.75d}],Name:"function",Tags:[Skylands,Water,Shoot,CurseGuardian,Debuff1]}],Tick:[{Name:"function",Tags:[Skylands,Water,Shoot,CurseGuardian,Curse1]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:90,Max:150,Current:120},Loop:{Max:1,Current:1},Call:[{Name:"function",Tags:[Skylands,Water,Shoot,Shinkaimawari,IceDirection]},{Name:"function",Tags:[Skylands,Water,Shoot,CurseGuardian,Ice1],Player:{DamageType:[Global],DeathCause:'[{"translate":"%1$sは%2$sの呪いによって凍らせられてしまった。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},MP:{MP:50},Distance:{Max:0.1d}}]}]}]}
