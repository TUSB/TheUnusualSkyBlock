...
execute as @a[tag=NowTarget] at @s run particle dust{color:[0.0,1.0,100000000.0],scale:1.2} ~ ~2 ~ 0.1 1.5 0.1 0 50 force @a[distance=..32]
execute as @a[tag=NowTarget] at @s run particle dust{color:[0.0,1.0,100000000.0],scale:1} ~ ~1 ~ 0.35 0.8 0.35 0 50 force @a[distance=..32]
