...
execute at @s run particle dust{color:[0.0,1.0,100000000.0],scale:0.75} ~ ~1 ~ 0.4 0.75 0.4 0 30 force @a[distance=..32]
tellraw @s [{"translate":"%1$sから放たれたオーラは、水に触れる者を凍てつかせるだろう。","color":"dark_aqua","with":[{"translate":"深海廻","color":"#FF0000","bold":true}]}]
effect give @s invisibility 10 4 true
execute at @s run function ai:skill/damage/
