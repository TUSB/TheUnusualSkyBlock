...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Item:{id:"minecraft:nether_star"},Count:64,Chance:1d},{Item:{id:"minecraft:nether_star"},Count:64,Chance:1d},{Item:{id:"minecraft:nether_star"},Count:64,Chance:1d},{Item:{id:"minecraft:nether_star"},Count:64,Chance:1d},{Item:{id:"minecraft:nether_star"},Count:64,Chance:1d},{Loot:"#N/A",Count:3,Chance:1d}]
# AI
