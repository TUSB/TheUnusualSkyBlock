...
# 円
    ...
    particle end_rod ~-0.195 ~0.1 ~0.981 ~-195090368.0 ~0.1 ~980785280.0 0.00000000050 0 force @a[distance=..32]
# 雷
    particle dust{color:[0.0,-1.0,-1.0],scale:1.2} ~ ~2 ~ 1 3 1 0 150 force @a[distance=..32,tag=ShowParticles]
    particle dust{color:[0.0,-1.0,-1.0],scale:1.2} ~ ~4 ~ 0.25 6 0.25 0 150 force @a[distance=..32,tag=ShowParticles]
...
# ダメージ判定
    ...
    execute as @e[distance=..6,predicate=entity:friendly] run function ai:skill/laser/main/damage
