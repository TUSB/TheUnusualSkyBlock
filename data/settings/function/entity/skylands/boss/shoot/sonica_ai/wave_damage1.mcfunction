...
# 対象となるプレイヤー・Friendlyを特定
    ...
    execute as @e[distance=..16,predicate=entity:friendly,tag=NowTarget] if entity @s[type=player] run function settings:entity/skylands/boss/shoot/sonica_ai/wave_damage2
    execute as @e[distance=..16,predicate=entity:friendly,tag=NowTarget] unless entity @s[type=player] run function settings:entity/skylands/boss/shoot/sonica_ai/wave_damage3
