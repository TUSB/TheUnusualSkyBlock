#Function
particle dust{color:[100000000.0,0.5,0.0],scale:1.2} ~ ~2 ~ 1 3 1 0 150 force @a[distance=..32,tag=ShowParticles]
particle dust{color:[100000000.0,0.5,0.0],scale:1.2} ~ ~4 ~ 0.25 6 0.25 0 150 force @a[distance=..32,tag=ShowParticles]
