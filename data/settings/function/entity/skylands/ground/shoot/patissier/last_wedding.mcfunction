### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:armor_stand",CustomName:'{"translate":"ラスト・ウエディング","color":"#FF0000","bold":true}',Tags:[DelayedData,HasAI,CallOnInit,CallOnBlock,TickingRequired,SmartMotion,Break,AnalyseLog,"HideLevel"],Small:1b,Invisible:1b,Invulnerable:1b,PortalCooldown:700}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s強度...測定不能！ ※当たったらもれなく死にます。","with":[{"translate":"【能力：範囲攻撃・引寄無効】","color":"#00FF00"}]}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"smart_motion",TP:true,Start:true,Gravity:{Set:0d}}],Block:[{Name:"damage",Player:{DamageType:[Global],BypassArmor:true,BypassResistance:true,DeathCause:'[{"translate":"「ﾍﾞﾁｬﾘ」%1$sは%2$sの測定不能の強度によりストロベリージャムになった。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Distance:{Max:4d},Explosion:-1},{Name:"spawn",SpawnEntities:[[{Tags:[Skylands,Ground,Shoot,Patissier,HugeExplosion],Level:1}]]}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:80,Max:80,Current:80},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:2,Max:2,Current:2},Call:[{Name:"smart_motion",Gravity:{Add:5d}}]}]}]}
#Function
