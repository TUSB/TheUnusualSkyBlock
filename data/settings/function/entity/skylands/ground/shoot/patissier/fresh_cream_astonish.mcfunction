...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {FireworksItem:{id:"minecraft:warped_fungus_on_a_stick",Count:1,components:{"minecraft:custom_model_data":1008,Fireworks:{Explosions:[{Type:0,Flicker:1b,Trail:1b,Colors:[I;16777215]}]}}}}
### 遅延ステータス
data modify storage tusb_mob: "遅延ステータス"."ステータス"."物理攻撃力" set value 200
data modify storage tusb_mob: "遅延ステータス"."ステータス"."魔法攻撃力" set value 100
data modify storage tusb_mob: "遅延ステータス"."ステータス"."理外攻撃力" set value 0
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"step",Speed:1.0d}],Attack:[{Name:"damage",Player:{Damage:0d,DamageType:[Global,Blast]},Distance:{Max:2.0d},AEC:{effects:[{id:"minecraft:hunger",amplifier:30b,duration:250}]}},{Condition:[{Name:"random_chance",Chance:2.0d}],Name:"damage",Player:{Damage:0d,DamageType:[Global,Blast]},Distance:{Max:0.5d},AEC:{effects:[{id:"minecraft:invisibility",amplifier:6b,duration:5}]}}]}
#Function
