...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"random_chance",Chance:0.4d}],Name:"function",Tags:[Skylands,Ground,Shoot,PaleSpirit,Effect1]}],Tick:[{Name:"function",Tags:[Skylands,Ground,Shoot,PaleSpirit,Appearence]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:100,Max:160,Current:100},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:32d,MinRadius:3d,IgnoreBlocks:true}}],Settings:[{Name:"Anchor",Anchor:"Eyes"},{Name:"Direction",Direction:[0f,0f],DirectionRange:[360f,0f],Speed:0.1d,SpeedRange:1d}],Name:"spawn",Count:1,SpawnEntities:[[{Tags:[Skylands,Ground,Shoot,PaleSpirit,Bullet],Level:1}]]}],MP:5}],Exit:{Loop:{Max:1,Current:1}}}]}
