### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:shulker",CustomName:'{"translate":"レッドシュルカー","color":"#FFFFFF","bold":true}',AttachFace:0b,Color:14b,active_effects:[{id:"minecraft:slow_falling",amplifier:0b,duration:-1,show_particles:0b}],PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,CallOnAttack,TickingRequired,HasLootTable,AnalyseLog]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"random_chance",Chance:0.3d}],Name:"function",Tags:[Skylands,Ground,Shoot,RedShulker,Debuff]}]}
