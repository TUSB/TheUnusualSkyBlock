...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Name:"Damage",Player:{Damage:0d,DamageType:[Global]},Distance:{Max:2d},AEC:{Particle:{type:"dragon_breath"},Duration:100,Radius:1f,potion_contents:{custom_effects:[{id:"minecraft:mining_fatigue",amplifier:1b,duration:300},{id:"minecraft:slowness",amplifier:2b,duration:300},{id:"minecraft:poison",amplifier:2b,duration:100}]}}}]}
