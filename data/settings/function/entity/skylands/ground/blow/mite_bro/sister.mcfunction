### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:endermite",CustomName:'{"translate":"マイトちゃん","color":"#FFFFFF","bold":true}',Lifetime:0,PlayerSpawned:0b,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,TickingRequired,HasLootTable,AnalyseLog]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$sお兄ちゃん大好き！","with":[{"translate":"【能力：発狂】","color":"#00FF00"}]}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Passenger:{Type:"down",Check:false,Call:[{Name:"function",Tags:[Skylands,Ground,Blow,MiteBro,SisterAnger]},{Name:"change_ai",Passenger:{}}]}}
