...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Passenger:{Type:"down",Check:false,Call:[{Name:"function",Tags:[Skylands,Ground,Blow,Chillness,EffectClear]},{Name:"change_ai",Passenger:{}}]},TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:10,Current:10},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"random_chance",Chance:0.2d}],Name:"function",Tags:[Skylands,Ground,Blow,Chillness,Target1]}]}]}]}
