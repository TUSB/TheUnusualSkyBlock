...
execute positioned ~-0.5 ~1.375 ~-0.5 as @a[predicate=entity:player,scores={ProjectileTime=0..},dy=1] run function settings:entity/skylands/ground/blow/silver_sorcerer/spike_damage2
