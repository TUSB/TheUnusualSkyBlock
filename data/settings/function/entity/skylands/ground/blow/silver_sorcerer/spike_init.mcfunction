...
#ループ処理の開始
execute if block ~ ~ ~ #block:no_collision run function settings:entity/skylands/ground/blow/silver_sorcerer/spike_init_loop
#完全に失敗していたら、ゴミ箱行き
...
function settings:entity/skylands/ground/shoot/thunder_spirit/thunder_sound
