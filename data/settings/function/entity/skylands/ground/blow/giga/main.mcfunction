...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":941579,"minecraft:unbreakable":{}}},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:dyed_color":941579,"minecraft:unbreakable":{}}},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":941579,"minecraft:unbreakable":{}}},{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;1,0,25,0],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGEzNmYxOWMzMDVjY2RiMzZlNDdiMmRhZGNmNTllNmFkOGRkOTNjZGY0NzQ4Nzc1ZDVhNmVjNDFlZDk3ZiJ9fX0="}]}}}],HandDropChances:[-Infinityf,-Infinityf],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Name:"function",Tags:[Skylands,Ground,Function,Ryomen,Rage1]}],Attack:[{Name:"function",Tags:[Skylands,Ground,Blow,Giga,Debuff1]}],Tick:[{Name:"function",Tags:[Skylands,Ground,Function,Ryomen,RageTick]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1200,Max:1200,Current:1200},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:64d}}],Settings:[{Name:"Direction",Direction:[-180f,-20f],DirectionRange:[360f,20f],Speed:0d,SpeedRange:6d,Absolute:{Vertical:true}}],Name:"function",Tags:[Skylands,Ground,Function,Ryomen,Summoner]}],Once:2}]}]}
