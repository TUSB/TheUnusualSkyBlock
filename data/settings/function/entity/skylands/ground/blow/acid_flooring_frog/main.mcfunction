### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:frog",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,CallOnDamage,CallOnAttack,TickingRequired,DamageProjectile,EnemyProjectile,HasLootTable,AnalyseLog,"Unmoved"],CustomName:'{"translate":"サンハリカエル","color":"#FF0000","bold":true}',InLove:0,Age:9999,ForcedAge:9999,variant:"minecraft:temperate",PortalCooldown:3000,DeathLootTable:"empty"}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s床張り検定２級を所持している「全床を酸床にするケロ～激痛はサービスケロ」","with":[{"translate":"【能力：追撃・地形破壊・引寄無効】","color":"#00FF00"}]}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"function",Tags:[Global,Event,Function,CommonExe,SetMp0]}],Damage:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}},{Name:"Rotation",Direction:[-30f,-45f],DirectionRange:[60f,0f],Absolute:{Vertical:true}}],Name:"step",Speed:0.4d,SpeedRange:1.4d}],Attack:[{Condition:[{Name:"function",Tags:[Global,Event,Function,CommonExe,SurvivalJudge]},{Name:"check_nbt",NBT:{OnGround:true}},{Name:"check_block",Block:[Air]}],Name:"function",Tags:[Skylands,Ground,Blow,AcidFlooringFrog,ProcessFloor]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:30,Max:30,Current:3},Loop:{Max:1,Current:1,Range:3},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}},{Name:"Rotation",Direction:[-15f,-45f],DirectionRange:[30f,0f],Absolute:{Vertical:true}}],Name:"step",Speed:0.4d,SpeedRange:1.4d}]},{Interval:{Min:3,Max:3,Current:3},Loop:{Max:1,Current:1,Range:30},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}}]}]}]}]}
