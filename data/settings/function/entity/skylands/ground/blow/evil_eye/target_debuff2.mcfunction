...
# デバフの種類分岐
# 10秒未満
    execute if score # Calc matches ..19 run function settings:entity/skylands/ground/blow/evil_eye/debuff1
# 10秒以上30秒未満
    execute if score # Calc matches 20..59 run function settings:entity/skylands/ground/blow/evil_eye/debuff2
# 30秒以上60秒未満
    execute if score # Calc matches 60..119 run function settings:entity/skylands/ground/blow/evil_eye/debuff3
# 60秒以上120秒未満
    execute if score # Calc matches 120..239 run function settings:entity/skylands/ground/blow/evil_eye/debuff4
# 120秒以上のものには死を
    execute if score # Calc matches 240.. run function settings:entity/skylands/ground/blow/evil_eye/debuff5
# 成功フラグ
