### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"メーガ","color":"#FFFFFF"}',active_effects:[{id:"minecraft:fire_resistance",amplifier:0b,duration:-1,show_particles:0b}],Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDamage,CallOnAttack,CallOnTick,TickingRequired,HasLootTable,AnalyseLog,"Ryomen"],PortalCooldown:3000}
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":4473924,"minecraft:unbreakable":{}}},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:dyed_color":4473924,"minecraft:unbreakable":{}}},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":4473924,"minecraft:unbreakable":{}}},{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;1,0,26,0],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmFlZjIzM2NkNmZkOTE4NzhkNTEzNzY2ZWRjMjNkZjMwODI3OGMwY2U4MDU5NzZlOTY5YzM5NDUxNjRkNmM4In19fQ=="}]}}}],HandDropChances:[-Infinityf,-Infinityf],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Name:"function",Tags:[Skylands,Ground,Function,Ryomen,Rage1]}],Attack:[{Name:"function",Tags:[Skylands,Ground,Blow,Mega,Debuff1]}],Tick:[{Name:"function",Tags:[Skylands,Ground,Function,Ryomen,RageTick]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1200,Max:1200,Current:1200},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:64d}}],Settings:[{Name:"Direction",Direction:[-180f,-20f],DirectionRange:[360f,20f],Speed:0d,SpeedRange:6d,Absolute:{Vertical:true}}],Name:"function",Tags:[Skylands,Ground,Function,Ryomen,Summoner]}],Once:2}]}]}
