...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"function",Tags:[Global,Event,Function,CommonExe,SetMp0]}],Damage:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}},{Name:"Rotation",Direction:[-30f,-45f],DirectionRange:[60f,0f],Absolute:{Vertical:true}}],Name:"step",Speed:0.4d,SpeedRange:1.4d}],Attack:[{Condition:[{Name:"function",Tags:[Global,Event,Function,CommonExe,SurvivalJudge]},{Name:"check_nbt",NBT:{OnGround:true}},{Name:"check_block",Block:[Air]}],Name:"function",Tags:[Skylands,Ground,Blow,DeathFlooringFrog,ProcessFloor]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:30,Max:30,Current:3},Loop:{Max:2,Current:2,Range:3},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}},{Name:"Rotation",Direction:[-15f,-45f],DirectionRange:[30f,0f],Absolute:{Vertical:true}}],Name:"step",Speed:0.4d,SpeedRange:1.4d}]},{Interval:{Min:3,Max:3,Current:3},Loop:{Max:1,Current:1,Range:30},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}}]}]}]}]}
