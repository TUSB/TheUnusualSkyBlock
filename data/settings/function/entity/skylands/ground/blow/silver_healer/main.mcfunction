...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"function",Tags:[Skylands,Ground,Blow,SilverHealer,Particle]}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:200,Max:400,Current:300},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Global:true,Target:{Look:"Friendly",Radius:24d,IgnoreBlocks:true}}],Name:"delay_action",Tags:["Casting","Healing"]},{Name:"change_turn",Loop:1}]}]},{Index:2,Skill:[{Interval:{Min:30,Max:30,Current:30},Loop:{Max:1,Current:1},Call:[{Name:"function",Tags:[Skylands,Ground,Blow,SilverHealer,Heal1]}]}]}]}
