...
execute as @e[tag=Enemy,distance=..3] positioned ~-3 ~-1 ~-3 if entity @s[dx=5,dy=1,dz=5] if score @s HP < @s HPMax run function settings:entity/skylands/ground/blow/silver_healer/heal2
