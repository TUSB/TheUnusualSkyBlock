### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"アビスウォーカー","color":"#FF0000","bold":true}',Silent:1b,active_effects:[{id:"minecraft:fire_resistance",amplifier:1b,duration:-1,show_particles:0b},{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnAttack,TickingRequired,HasLootTable,AnalyseLog]}
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":12339199,"minecraft:unbreakable":{}}},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:dyed_color":12339199,"minecraft:unbreakable":{}}},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":12339199,"minecraft:unbreakable":{}}},{id:"minecraft:crying_obsidian",count:1}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf],HandItems:[{id:"minecraft:iron_sword",count:1,components:{"minecraft:unbreakable":{},"minecraft:custom_model_data":12}},{}],HandDropChances:[-Infinityf,-Infinityf]}
