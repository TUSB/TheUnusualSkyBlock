...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"function",Tags:[Global,Event,Function,CommonExe,TpWithXRotation]}],Passenger:{Type:"down",Check:false,Call:[{Name:"kill"}]},TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:250,Max:500,Current:100},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:24d,IgnoreBlocks:true}}],Settings:[{Name:"Direction",Direction:[-180f,0f],DirectionRange:[360f,0f],Speed:0d,SpeedRange:3d,Absolute:{Vertical:true}}],Name:"spawn",SpawnEntities:[[{Tags:[Skylands,Ground,Blow,SilverBomber,EarthBomb],Level:36}]]}]}]}]}
