...
execute if score @s _ > _ _ at @s positioned ~ ~-0.125 ~ run function settings:entity/skylands/sky/summon/ghast_carrier/condition
execute if score _ Calc matches 0 at @s run tp @s ~ ~-0.125 ~ ~ ~
scoreboard players set _ Calc 100
scoreboard players remove _ _ 400
execute if score @s _ < _ _ at @s positioned ~ ~5.125 ~ run function settings:entity/skylands/sky/summon/ghast_carrier/condition
