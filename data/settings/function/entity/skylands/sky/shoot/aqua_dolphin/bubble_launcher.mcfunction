...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}}],Name:"smart_motion",TP:true,Start:true,Speed:{Set:5d},Gravity:{Set:0d}},{Name:"delay_action",Tags:["Casting","BubbleLauncher01"]}],Tick:[{Name:"smart_motion",Speed:{Add:1d,Limit:100d}}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:80,Max:80,Current:80},Loop:{Max:1,Current:1},Call:[{Name:"delay_action",Tags:["Casting","BubbleLauncher02"]}],Once:1},{Interval:{Min:80,Max:80,Current:80},Loop:{Max:1,Current:1},Call:[{Name:"delay_action",Tags:["Casting","BubbleLauncher03"]}],Once:1}]}]}
#Function
