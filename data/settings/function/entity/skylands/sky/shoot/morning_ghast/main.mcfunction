...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Condition:[{Name:"function",Tags:[Global,Event,Function,CommonExe,IsDaytime],Inverse:true}],Name:"kill"},{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:64d}}],Settings:[{Name:"Direction",Direction:[0f,-90f],Speed:16d,Absolute:{Vertical:true}}],Name:"teleport"}],Damage:[{Settings:[{Name:"Direction",Direction:[0f,-90f],Speed:3d,Absolute:{Vertical:true}}],Name:"teleport"}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:40,Max:120,Current:60},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:3,Max:3,Current:3},Loop:{Max:16,Current:16},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:64d}}],Name:"function",Tags:[Skylands,Sky,Shoot,MorningGhast,Sound]},{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:64d},Anchor:"Eyes"},{Name:"Direction",Speed:3d}],Name:"spawn",SpawnEntities:[[{Tags:[Skylands,Sky,Shoot,MorningGhast,Bullet],Level:5}]]},{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:64d},Anchor:"Eyes"},{Name:"Direction",Direction:[-180f,0f],DirectionRange:[360f,0f],Speed:1d,SpeedRange:4d}],Name:"smart_motion",OnBlock:"Bounce",Start:true,TP:true,Speed:{Set:2d}}],MP:3},{Interval:{Min:40,Max:40,Current:40},Loop:{Max:1,Current:1},Call:[{Name:"smart_motion",Start:true,Speed:{Set:0d},Gravity:{Set:0d}},{Name:"smart_motion",Stop:true}]}],Exit:{Loop:{Max:6,Current:6}}}]}
