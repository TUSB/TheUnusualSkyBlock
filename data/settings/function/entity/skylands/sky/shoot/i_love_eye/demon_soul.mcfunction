...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {Item:{id:"minecraft:firework_star",count:1,components:{"minecraft:custom_model_data":151,"minecraft:firework_explosion":{shape:"small_ball",colors:[I;9389102]}}}}
### 遅延ステータス
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s魂とったるけん！","with":[{"translate":"【能力：格闘・移動・コール】","color":"#00FF00"}]}]'
# AI
