...
# レベルを設定
    ...
    data modify storage mob_data: Call.SpawnEntities set value [[{Tags:[Global,Sky,Shoot,ElectroEye,Main,SpawnParticles],Level:40}],[{Tags:[Global,Sky,Shoot,ElectroEye,BulletMarker],Level:40}]]
