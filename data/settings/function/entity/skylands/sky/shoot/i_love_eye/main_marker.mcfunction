...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Direction",Direction:[0f,-90f],Speed:16d,Absolute:{Vertical:true}}],Condition:[{Name:"check_block",Block:[Air]}],Name:"spawn",SpawnEntities:[[{Tags:[Skylands,Sky,Summon,GhastCarrier,Main],Level:90}],[{Tags:[Skylands,Sky,Shoot,ILoveEye,Main],Level:90}]]},{Name:"kill"}]}
