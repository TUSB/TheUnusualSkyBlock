...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Passenger:{Type:"down",Check:false,Call:[{Settings:[{Name:"Direction",Direction:[-180f,0f],DirectionRange:[360f,0f],Speed:0d,SpeedRange:5d,Absolute:{Vertical:true}}],Name:"Function",Tags:[Skylands,Sky,Shoot,ILoveEye,PoisonSoulSummon]},{Settings:[{Name:"Direction",Direction:[-180f,0f],DirectionRange:[360f,0f],Speed:0d,SpeedRange:5d,Absolute:{Vertical:true}}],Name:"Function",Tags:[Skylands,Sky,Shoot,ILoveEye,PoisonSoulSummon]},{Name:"Kill"}]}}
