...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s非常に強力な怨念を纏ったファントム。自身に受けた呪いを他の者にも与えようとする。","with":[{"translate":"【能力：射的・爆撃】","color":"#00FF00"}]}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"random_chance",Chance:0.1d}],Name:"function",Tags:[Skylands,Ground,Blow,BlackGrudge,Debuff1]}],Tick:[{Name:"merge_nbt",NBT:{Fire:0}}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:160,Max:200,Current:100},Loop:{Max:1,Current:1},Call:[{Name:"change_turn",Set:2}]}]},{Index:2,Skill:[{Interval:{Min:20,Max:20,Current:20},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}],Name:"spawn",IsChild:true,SpawnEntities:[[{Tags:[Skylands,Sky,Shoot,BlackGrudge3,Flame],Level:44}]]}]}],Exit:{Loop:{Max:3,Current:3}}}]}
