...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"random_chance",Chance:0.15d}],Name:"function",Tags:[Skylands,Sky,Shoot,Tippy,Poppy]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:100,Max:100,Current:100},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:16d,IgnoreBlocks:true}},{Name:"random_chance",Chance:0.12d}],Name:"function",Tags:[Skylands,Sky,Shoot,Tippy,Summon1]}]}]}]}
