...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}],Name:"smart_motion",TP:true,Speed:{Set:50d,Range:10d},Gravity:{Set:40d}},{Name:"function",Tags:[Desert,Ground,Shoot,FireMage,FireBallSummonDirection]}],Attack:[{Condition:[{Name:"random_chance",Chance:0.65d}],Name:"function",Tags:[Desert,Ground,Shoot,FireMage,Flame]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"function",Tags:[Desert,Ground,Shoot,FireMage,FireBallAppearance]}]}]}]}
