...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Rotation",Direction:[0f,90f]}],Name:"step",Speed:1d}],Attack:[{Condition:[{Name:"random_chance",Chance:0.95d}],Name:"function",Tags:[Desert,Ground,Shoot,FireMage,Flame]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"function",Tags:[Desert,Ground,Shoot,FireMage,FlameRainAppearance]}]}]}]}
