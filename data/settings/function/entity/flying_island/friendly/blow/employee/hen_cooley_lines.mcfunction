#Function
# 定期的に
data modify storage mob_data: CCHelper.Repeat.texts set value ["しばらく帰ってなかったがやはりここは落ち着くのぅー。"]
...
data modify storage mob_data: CCHelper.Repeat.text_format set value '{"text":"","color":"#FFFFFF"}'
data modify storage mob_data: Tags append value CCHelperRepeat

# 目が合ったら
data modify storage mob_data: CCHelper.Insight.texts set value ["おまえか、ワシの§5ヘソクリ§rを盗んだのは。","いや、良い。こんなわかりやすい場所に隠していたワシもワシじゃ。\\nそれよりホレ、せっかくここまで来たんじゃ。\\nなんか買っていきなさい。"]
...
data modify storage mob_data: CCHelper.Insight.text_format set value '{"text":"","color":"#FFFFFF"}'
data modify storage mob_data: Tags append value CCHelperInsight

# 話し掛けたら
data modify storage mob_data: CCHelper.Interact.texts set value ["すまんの。この程度のものしか売ってなくて。\\nいや、ここを見つけられたおまえさんなら\\nこんなのでも使いこなせるじゃろ・・・？\\n"]
...
data modify storage mob_data: CCHelper.Interact.text_format set value '{"text":"","color":"#FFFFFF"}'
