...
execute unless score _ Calc matches 0 run function settings:entity/flying_island/friendly/blow/stock_exchange_vip/add_stock
...
function settings:entity/flying_island/friendly/blow/stock_exchange_vip/exchange_fluctuation
