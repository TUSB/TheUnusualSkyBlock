...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:stick",count:1,components:{"minecraft:custom_model_data":1,"minecraft:unbreakable":{}}}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
