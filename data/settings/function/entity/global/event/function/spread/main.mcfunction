...
# オーバーフロー対策
    execute unless score _ _ matches -46340..46340 run function settings:entity/global/event/function/spread/overflow
...
# Sin,Cosの習得
    function settings:entity/global/event/function/spread/sincos
# ランダム処理の開始
    data modify storage mob_data: Call.SpreadLoop set value 6
    function settings:entity/global/event/function/spread/loop
