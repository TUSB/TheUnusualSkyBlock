...
# ランダム処理により半径を取得
    ...
    execute unless score _ Calc matches ..0 run function settings:entity/global/event/function/spread/radius
...
# ベクトルX,Yより相対座標X,Y,Zを計算
    function settings:entity/global/event/function/spread/loop_calc1
# 座標X,Y,Zを計算
    function settings:entity/global/event/function/spread/loop_calc2
# CheckBlock判定
    execute if data storage mob_data: Call.CheckBlock run function settings:entity/global/event/function/spread/checkblock
