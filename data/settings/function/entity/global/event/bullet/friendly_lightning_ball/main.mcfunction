...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {Item:{id:"minecraft:firework_star",count:1,components:{"minecraft:custom_model_data":43,"minecraft:firework_explosion":{shape:"small_ball",colors:[I;16777215]}}}}
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"At",Target:{Look:"Enemy",Radius:48d,IgnoreBlocks:true},},{Name:"Direction",Direction:[0d,-90d],Absolute:{Vertical:true},Speed:5d}],Name:"Teleport"},{Settings:[{Name:"Rotation",Direction:[0f,90f],Absolute:{Vertical:true}}],Name:"Step",Speed:2d}],ProjectileDamage:{magic:80}}
