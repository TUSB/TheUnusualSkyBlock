...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Passenger:{Type:"down",Check:false,Call:[{Settings:[{Name:"Direction",Speed:1.275d,Direction:[0f,90f],Absolute:{Vertical:true}},{Name:"Facing",Target:{Look:"Player",Radius:24,IgnoreBlocks:true}}],Condition:[{Name:"has_target",Target:{Look:"Friendly",Radius:24,IgnoreBlocks:true}}],Name:"spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,Combat,Creeper]}],[{Tags:[Global,Other,Summon,Combat,CallCreeper]}]]},{Name:"kill"}]}}
