### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",CustomName:'{"translate":"採掘戦隊マインクラフターホワイト","color":"#FF0000","bold":true}',active_effects:[{id:"minecraft:invisibility",amplifier:127b,duration:-1,show_particles:false}],PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CallOnAttack,TickingRequired,HasLootTable,AnalyseLog]}
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf],HandDropChances:[-Infinityf,-Infinityf],HandItems:[{id:"minecraft:bow",count:1},{id:"tipped_arrow",count:1,components:{"minecraft:potion_contents":{custom_color:16777215}}}],ArmorItems:[{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":16777215}},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:dyed_color":16777215}},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":16777215}},{id:"minecraft:leather_helmet",count:1,components:{"minecraft:dyed_color":16777215}}]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s真面目な面をしているが、実は何も考えていないのである。","with":[{"translate":"【能力：追撃・置換・混乱】","color":"#00FF00"}]}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"mp",MP:25,Percent:true}]},{Condition:[{Name:"random_chance",Chance:0.25d}],Name:"damage",Player:{DamageType:[Global,Fire,Blast,Projectile,Fall]},Distance:{Max:1d},AEC:{Particle:{type:"dust",color:[1.000,1.000,1.000],scale:3},Color:16777215,Duration:40,Radius:1f,potion_contents:{custom_effects:[{id:"minecraft:invisibility",amplifier:6b,duration:10}]}}},{Condition:[{Name:"min_mp",MP:30,Percent:true,Inverse:true}],Name:"function",Tags:[Global,Ground,Shoot,MineCrafter,Change]},{Condition:[{Name:"min_mp",MP:30,Percent:true,Inverse:true}],Name:"kill"}]}
