...
execute if score _ Random matches 5 at @s run data modify entity @e[tag=Spawn,distance=0,limit=1] ArmorItems[3].tag.SpawnEntities[0][0].Tags set value [Global,Ground,Shoot,MineCrafter,MineCrafterPale]
