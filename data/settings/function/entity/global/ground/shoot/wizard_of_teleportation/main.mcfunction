...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:warped_fungus_on_a_stick",count:1,components:{"minecraft:custom_model_data":1}}],VillagerData:{profession:"minecraft:cleric",type:"minecraft:snow"}}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s得意のテレポート魔術で生贄の儀式の贄を探そうとしている。","with":[{"translate":"【能力：ワープ・射的】","color":"#00FF00"}]}]'
# AI
