...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"smart_motion",TP:true,Start:true,Speed:{Set:30d},Gravity:{Set:0d}},{Name:"function",Tags:[Global,Ground,Shoot,CommonParticle,Cannon]}]}
#Function
