...
execute as @e[type=!player,predicate=entity:friendly,tag=!Enemy,distance=1..64,sort=nearest,limit=1] run function settings:entity/global/ground/shoot/menicles/wind_with_smell_friendly
# 村人
...
execute as @e[type=villager,tag=WanderingVillager,distance=1..64,sort=nearest,limit=1] run function settings:entity/global/ground/shoot/menicles/wind_with_smell_villager
# ゾンビ村人
...
execute as @e[type=zombie_villager,tag=Enemy,distance=1..64,sort=nearest,limit=1] run function settings:entity/global/ground/shoot/menicles/wind_with_smell_zombie_villager
