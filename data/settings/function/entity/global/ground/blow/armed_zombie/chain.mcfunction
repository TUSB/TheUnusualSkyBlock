...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {HandItems:[{id:"minecraft:stone_sword",count:1,components:{"minecraft:unbreakable":{}}},{}],HandDropChances:[-1e+300F,0.085F],ArmorItems:[{id:"minecraft:chainmail_boots",count:1,components:{"minecraft:unbreakable":{}}},{id:"minecraft:chainmail_leggings",count:1,components:{"minecraft:unbreakable":{}}},{id:"minecraft:chainmail_chestplate",count:1,components:{"minecraft:unbreakable":{}}},{id:"minecraft:chainmail_helmet",count:1,components:{"minecraft:unbreakable":{}}}],ArmorDropChances:[-1e+300F,-1e+300F,-1e+300F,-1e+300F]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s負けると分かっていても避けられない戦いがある！","with":[{"translate":"【能力：なし】","color":"#00FF00"}]}]'
