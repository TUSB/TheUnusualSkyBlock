...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Settings:[{Name:"At",Target:{Look:"Friendly",Radius:8}},{Name:"Direction",Direction:[-180f,0f],Speed:2d}],Name:"teleport"},{Name:"merge_nbt",NBT:{ExplosionRadius:5b,Fuse:0s,ignited:true}}]}
