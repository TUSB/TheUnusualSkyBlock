...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Anchor",Anchor:"Eyes"},{Name:"Rotation",Direction:[0f,-90f],Absolute:{Vertical:true}},{Name:"Rotation",Direction:[-120f,-120f],DirectionRange:[240f,240f]},{Name:"Direction",Speed:2d}],Name:"step",Speed:0.5d,SpeedRange:1.0d}],Tick:[{Name:"function",Tags:[Global,Ground,Blow,Volcareeper,ParticleAndSound2]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:4},Call:[{Condition:[{Name:"random_chance",Chance:0.2d},{Name:"has_target",Target:{Look:"Friendly",Radius:1d,IgnoreBlocks:true}}],Name:"damage",Player:{Damage:1d,DamageType:[Fire,Blast],BypassArmor:true,DeathCause:'[{"translate":"不運にも%1$sは%2$sに当たり消し飛んだ。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Distance:{Max:1d},Explosion:-1,AEC:{Particle:{type:"lava"},potion_contents:{custom_effects:[{id:"minecraft:invisibility",amplifier:9b,duration:40,show_particles:false}]}}}]}]}]}
#Function
