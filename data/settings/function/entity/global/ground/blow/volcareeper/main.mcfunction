...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"function",Tags:[Global,Event,Function,CommonExe,SetMp0]}],Death:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:32d,IgnoreBlocks:true}}],Name:"spawn",Count:15,CountRange:15,SpawnEntities:[[{Tags:[Global,Ground,Blow,Volcareeper,VolcanicBlast],Level:1}]]}],Time:[{Name:"change_ai",Death:[{}]}],Damage:[{Name:"kill"}],Tick:[{Name:"function",Tags:[Global,Ground,Blow,Volcareeper,ParticleAndSound1]}]}
