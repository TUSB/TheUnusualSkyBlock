...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Death:[{Name:"function",Tags:[Global,Event,Function,FakeEndstone,Destroyed]},{Name:"spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,Combat,Endermite],Level:1}]],Count:2,CountRange:3}],Time:[{Name:"change_ai",Death:[{}]}]}
