...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:oak_button",count:1}],HandItems:[{id:"minecraft:iron_axe",count:1},{}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf],HandDropChances:[-Infinityf,-Infinityf]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/drop_item/tier1/common",Count:1,Chance:0.3d},{Item:{id:"minecraft:oak_planks"},Count:1,CountRange:4,Chance:0.24d}]
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$sこの筋肉は飾りではない。","with":[{"translate":"【能力：なし】","color":"#00FF00"}]}]'
# AI
