...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {HandItems:[{id:"minecraft:diamond_axe",count:1,components:{"minecraft:attribute_modifiers":{}}},{id:"minecraft:totem_of_undying",count:1}],HandDropChances:[-1E300f,-1E300f]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s不死のトーテムで安心。","with":[{"translate":"【能力：復活】","color":"#00FF00"}]}]'
# AI
