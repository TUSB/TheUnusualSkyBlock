...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Death:[{Name:"spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,Combat,SlimeMedium],Level:1}]],Count:1}],Time:[{Name:"change_ai",Death:[{}]}],Attack:[{Name:"damage",Player:{Damage:0d},Distance:{Max:0d},AEC:{effects:[{id:"minecraft:slowness",amplifier:1b,duration:30,show_particles:false}]}}]}
