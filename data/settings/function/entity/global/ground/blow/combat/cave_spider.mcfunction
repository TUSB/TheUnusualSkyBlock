...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Name:"damage",Player:{Damage:0d},Distance:{Max:0d},AEC:{effects:[{id:"minecraft:invisibility",amplifier:8b,duration:5,show_particles:false}]},Condition:[{Name:"random_chance",Chance:0.04d}]}]}
