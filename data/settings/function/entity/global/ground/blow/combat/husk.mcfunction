...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Name:"function",Tags:[Global,Event,Function,RecordTarget]},{Name:"change_turn",Set:2}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{}]}]},{Index:2,Skill:[{Interval:{Min:15,Max:20,Current:30},Loop:{Max:3,Current:3},Call:[{Name:"function",Tags:[Global,Event,Function,Combat,DrainMp]},{Name:"heal",Range:1d,Multiplier:1.5d}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"function",Tags:[Global,Event,Function,ForgetTarget]}]}],Exit:{Loop:{Max:2,Current:2}}}]}
