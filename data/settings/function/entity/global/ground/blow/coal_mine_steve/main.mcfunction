...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {HandItems:[{id:"minecraft:iron_pickaxe",Count:1},{}],ArmorItems:[{},{},{},{id:"minecraft:player_head",count:1}],HandDropChances:[-Infinityf,-Infinityf],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Position:Source,Settings:[{Name:"As",Target:{Look:"Self"}},{Name:"At",Target:{Look:"Self"}},{Name:"Anchor",Anchor:"Eyes"}],Condition:[{Name:"mp",MP:5}],Name:"change_status",Defense:{Add:600,Limit:6000},SpecialDefense:{Add:600,Limit:6000}},{Condition:[{Name:"min_mp",MP:5}],Name:"function",Tags:[Global,Ground,Blow,CoalMineSteve,ParticleAndSound]}]}
