...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{id:"minecraft:leather_boots",components:{"minecraft:dyed_color":14737632},Count:1},{id:"minecraft:leather_leggings",components:{"minecraft:dyed_color":14737632},Count:1},{id:"minecraft:leather_chestplate",components:{"minecraft:dyed_color":14737632},Count:1},{id:"minecraft:iron_block",Count:1}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
