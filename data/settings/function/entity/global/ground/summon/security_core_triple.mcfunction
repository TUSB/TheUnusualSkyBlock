### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,Enemy,DelayedData,CallOnTimeOut,TickingRequired,"HideLevel","Unmoved"],CustomName:'{"translate":"Grumm","color":"#000000"}',IsBaby:true,Silent:true,active_effects:[{id:"minecraft:invisibility",amplifier:127b,duration:-1,show_particles:false},{id:"minecraft:weakness",amplifier:127b,duration:-1,show_particles:false},{id:"minecraft:slow_falling",amplifier:127b,duration:-1,show_particles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Time:[{Condition:[{Name:"has_target",Global:true,Target:{Look:"Player",Radius:24d,IgnoreBlocks:false}}],Name:"spawn",SpawnEntities:[[{Tags:[Global,Ground,Shoot,SecurityPoleTriple,Body],Level:1}],[{Tags:[Global,Ground,Shoot,SecurityPoleTriple,Main],Level:70}]],Count:1}]}
