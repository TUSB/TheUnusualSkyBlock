...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:firework_star",count:1,components:{"minecraft:firework_explosion":{shape:"small_ball",colors:[I;6684641]},"minecraft:custom_model_data":1007}}]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"function",Tags:[Global,Event,Function,CommonExe,BlockAlign]}],Death:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:32d,IgnoreBlocks:true}}],Name:"spawn",SpawnEntities:[[{Tags:[Global,Ground,Summon,DecoyTeleportPot,Aec],Level:1}]]}],Time:[{Name:"change_ai",Death:[{}]}],Damage:[{Condition:[{Name:"check_block",Inverse:true,Block:[Water,Lava,Air]}],Name:"function",Tags:[Global,Event,Function,CommonExe,UpAlign1]},{Name:"function",Tags:[Global,Event,Function,DamageSound,VaseBreak]},{Name:"merge_nbt",NBT:{NoAI:false,OnGround:false,ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Type:0b,Colors:[I;6684641]},CustomModelData:1009}}]}},{Name:"change_turn",Set:3}],TurnCount:4,Turn:[{Index:1,Skill:[{Interval:{Min:2,Max:2,Current:2},Call:[{Condition:[{Name:"check_nbt",Global:true,NBT:{OnGround:true}}],Name:"function",Tags:[Global,Event,Function,CommonExe,BlockAlign]},{Name:"merge_nbt",NBT:{NoAI:true}},{Name:"change_turn",Set:2}]}]},{Index:2,Skill:[{Interval:{Min:1000,Max:1000,Current:1000},Call:[{}]}]},{Index:3,Skill:[{Interval:{Min:2,Max:2,Current:2},Call:[{Condition:[{Name:"check_nbt",Global:true,NBT:{OnGround:true}}],Name:"function",Tags:[Global,Event,Function,CommonExe,BlockAlign]},{Name:"merge_nbt",NBT:{NoAI:true}},{Name:"change_turn",Set:4}]}]},{Index:4,Skill:[{Interval:{Min:2,Max:2,Current:2},Call:[{Condition:[{Name:"min_hp",HP:61,Percent:true}],Name:"merge_nbt",NBT:{ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Type:0b,Colors:[I;6684641]},CustomModelData:1007}}]}},{Condition:[{Name:"min_hp",Inverse:true,HP:60,Percent:true},{Name:"min_hp",HP:31,Percent:true}],Name:"merge_nbt",NBT:{ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Type:0b,Colors:[I;6684641]},CustomModelData:1008}}]}},{Condition:[{Name:"min_hp",Inverse:true,HP:30,Percent:true}],Name:"merge_nbt",NBT:{ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Type:0b,Colors:[I;6684641]},CustomModelData:1009}}]}}]}],Exit:{Loop:{Max:1,Current:1}}}]}
