### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:sheep",Tags:[Mob,Enemy,DelayedData,HasAI,TickingRequired,HasLootTable,AnalyseLog,"NoLootTableAdd"],CustomName:'{"translate":"金羊裘","color":"#FFFFFF","bold":true}',Color:4b,CustomNameVisible:true,active_effects:[{id:"minecraft:jump_boost",amplifier:9b,duration:-1,show_particles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
