...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:3,Turn:[{Index:1,Skill:[{Interval:{Min:2,Max:8,Current:2},Loop:{Max:3,Current:3,Range:6},Call:[{Name:"function",Tags:[Skylands,Ground,Blow,BioFish,SplashParticleSound]},{Name:"damage",Mob:{Hit:true,Physical:5,Ice:10},Distance:{Max:3.0d}}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"random_chance",Chance:0.5d}],Name:"change_turn",Set:2}]}]},{Index:2,Skill:[{Interval:{Min:2,Max:4,Current:2},Loop:{Max:1,Current:1,Range:3},Call:[{Name:"function",Tags:[Skylands,Ground,Blow,BioFish,SplashParticleSound]},{Name:"damage",Mob:{Hit:true,Physical:10,Ice:30},Distance:{Max:3.0d}},{Name:"function",Tags:[Global,Friendly,Blow,BioFish,SplashChange]}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"random_chance",Chance:0.15d}],Name:"change_turn",Set:3}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"change_turn",Set:1}]}]},{Index:3,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"kill"}]}]}],ProjectileDamage:{magic:120}}
