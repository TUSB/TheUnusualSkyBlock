...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Rotation",Direction:[-180f,-180f],DirectionRange:[360f,360f]}],Name:"Step",Speed:0.7d,SpeedRange:1d}],Damage:[{Settings:[{Name:"Rotation",Direction:[-180f,-180f],DirectionRange:[360f,360f]}],Name:"Step",Speed:0.5d,SpeedRange:0.8d}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:50,Max:80,Current:20},Call:[{Settings:[{Name:"Facing",Target:{Look:"Enemy",Radius:48d,IgnoreBlocks:true},Anchor:"Eyes"},{Name:"Rotation",Direction:[-4f,-4f],DirectionRange:[8f,8f]}],Name:"Step",Speed:0.7d,SpeedRange:1d}],MP:4}]}],ProjectileDamage:{physical:20,magic:20}}
