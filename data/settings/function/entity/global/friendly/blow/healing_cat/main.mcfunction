...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:2,Turn:[{Index:1,Once:1,Skill:[{Interval:{Min:20,Max:20,Current:20},Loop:{Max:1,Current:1},Call:[{Name:"merge_nbt",NBT:{Sitting:false}},{Name:"delay_action",Tags:["Casting","CircleHearts"]}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:30,Max:30,Current:30},Call:[{Name:"function",Tags:[Global,Friendly,Blow,HealingCat,ParticleAndSound]},{Name:"damage",Player:{Damage:0d,DamageType:[Global]},Distance:{Max:6d},AEC:{effects:[{id:"minecraft:instant_health",amplifier:2b,duration:100}]}},{Name:"damage",Mob:{Hit:true,Light:60},Distance:{Max:6d}},{Name:"function",Tags:[Global,Friendly,Blow,HealingCat,ParticleAndSound]},{Name:"delay_action",Tags:["Casting","CircleHearts"]}],MP:10}]}],ProjectileDamage:{magic:15}}
#Function
# Sample_01--Circle
