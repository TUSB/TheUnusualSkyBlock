...
# 目が合ったら
data modify storage mob_data: CCHelper.Insight.texts set value ["おまえは話が長いってよく言われるんだよね。Ⓟ15それでも聞いていくかい？"]
...
# 位置指定
execute in area:skylands positioned -71 12 -618 if entity @s[distance=..1] run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].CCHelper set from storage mob_data: CCHelper
