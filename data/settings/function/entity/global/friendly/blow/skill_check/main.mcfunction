...
data modify storage tusb_mob: "遅延ステータス"."ステータス"."理外防御力" set value -5
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Item:{id:"minecraft:stick"},Count:1,CountRange:3,Chance:1d}]
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$sさぁ計測してやるぞ、かかってくるがいい。","with":[{"translate":"【能力：ダメージ測定】","color":"#00FF00"}]}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"smart_motion",Gravity:{Set:100d}},{Settings:[{Name:"Rotation",Target:{Look:"Player",Radius:24d,IgnoreBlocks:true},Flip:true}],Name:"function",Tags:[Global,Event,Function,CommonExe,TpWithRotation]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:200,Max:200,Current:200},Loop:{Max:1,Current:1},Call:[{Name:"function",Tags:[Global,Friendly,Blow,ScarecrowDoll,Skill]}]}]}]}
