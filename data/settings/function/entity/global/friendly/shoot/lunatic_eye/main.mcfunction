...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;1,0,4,0],properties:[{name:"textures",value:""}]}}}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"function",Tags:[Global,Sky,Shoot,LunaticEye,Tick]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:400,Max:600,Current:10},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}],Name:"function",Tags:[Global,Sky,Shoot,LunaticEye,BackTp]}]}]}],ProjectileDamage:{magic:40}}
