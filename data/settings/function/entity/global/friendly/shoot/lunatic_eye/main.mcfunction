...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"Function",Tags:[Global,Sky,Shoot,LunaticEye,Tick]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:400,Max:600,Current:10},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}],Name:"Function",Tags:[Global,Sky,Shoot,LunaticEye,BackTp]}]}]}],ProjectileDamage:{magic:40}}
