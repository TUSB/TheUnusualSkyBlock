...
# 判定
# MPの値によって判定角度を変更
    execute if score @s MP matches 1 run function settings:entity/global/friendly/shoot/flare_pixely/slash_1
    execute if score @s MP matches 2 run function settings:entity/global/friendly/shoot/flare_pixely/slash_2
    execute if score @s MP matches 3 run function settings:entity/global/friendly/shoot/flare_pixely/slash_3
    execute if score @s MP matches 4 run function settings:entity/global/friendly/shoot/flare_pixely/slash_4
    execute if score @s MP matches 5 run function settings:entity/global/friendly/shoot/flare_pixely/slash_5
# ダメージ適用
    ...
    scoreboard players operation _ ElementFire = @e[distance=..48,scores={OhMyDatID=0},sort=nearest,limit=1] ElementFire
    scoreboard players add _ ElementFire 100
    execute store result storage skill: Damage.Fire int 0.015 run scoreboard players operation _ Level *= _ ElementFire
    scoreboard players operation _ Level = @s Level
