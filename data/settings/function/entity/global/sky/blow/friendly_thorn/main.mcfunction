...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:firework_star",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:unbreaking":0}},"minecraft:firework_explosion":{shape:"small_ball",colors:[I;15005951]},"minecraft:custom_model_data":123}}]}
