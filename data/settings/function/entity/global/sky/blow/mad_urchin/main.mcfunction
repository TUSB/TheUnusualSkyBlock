...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:firework_star",count:1,components:{"minecraft:firework_explosion":{shape:"small_ball",colors:[I;2302755]},"minecraft:custom_model_data":123}}]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Rotation",Direction:[0f,-90f],Absolute:{Horizontal:true,Vertical:true}}],Name:"smart_motion",TP:true,Start:true,Speed:{Set:40d},Gravity:{Set:200d}},{Name:"spawn",SpawnEntities:[[{Tags:[Global,Sky,Blow,MadUrchin,ParticleAndSound],Level:1}]]}],Damage:[{Name:"smart_motion",Speed:{Add:200d}},{Name:"function",Tags:[Global,Event,Function,DamageSound,Machine]}],Block:[{Name:"function",Tags:[Global,Event,Function,DamageSound,Machine]},{Condition:[{Name:"min_mp",Inverse:true,Logic:"OR",MP:1},{Name:"has_target",Inverse:true,Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"check_block",Block:[Lava]}],Name:"kill"},{Condition:[{Name:"random_chance",Chance:0.1d},{Name:"has_target",Target:{Look:"Friendly",Radius:24d,IgnoreBlocks:true}},{Name:"has_target",Inverse:true,Target:{Look:"Friendly",Radius:24d}}],Settings:[{Name:"At",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"Direction",Direction:[-180f,-90f],DirectionRange:[360f,180f],Absolute:{Horizontal:true,Vertical:true},Speed:3d,SpeedRange:6d}],Name:"teleport"},{Name:"smart_motion",Speed:{Add:40d,Limit:200d}}],Tick:[{Name:"function",Tags:[Global,Event,Function,CommonExe,RandomPoseHead]},{Condition:[{Name:"has_target",Inverse:true,Target:{Look:"Friendly",Radius:28d,IgnoreBlocks:true}}],Settings:[{Name:"At",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"Direction",Direction:[-180f,-90f],DirectionRange:[360f,180f],Absolute:{Horizontal:true,Vertical:true},Speed:8d,SpeedRange:16d}],Name:"teleport"},{Condition:[{Name:"has_target",Inverse:true,Target:{Look:"Friendly",Radius:24d,IgnoreBlocks:true}}],Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:48d}},{Name:"Rotation",Direction:[-20f,-20f],DirectionRange:[40f,40f]}],Name:"smart_motion",TP:true,Speed:{Set:200d}},{Condition:[{Name:"check_block",Inverse:true,Block:[Air]}],Settings:[{Name:"At",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"Direction",Direction:[-180f,-90f],DirectionRange:[360f,180f],Absolute:{Horizontal:true,Vertical:true},Speed:8d,SpeedRange:16d}],Name:"teleport"}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:60,Max:60,Current:60},Loop:{Max:1,Current:1},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:16,Current:16},Call:[{Settings:[{Name:"Rotation",Direction:[-180f,-90f],DirectionRange:[360f,180f],Absolute:{Horizontal:true,Vertical:true}}],Name:"smart_motion",TP:true,Speed:{Set:0d}}]},{Interval:{Min:1,Max:5,Current:1},Loop:{Max:1,Current:4,Range:16},Call:[{Settings:[{Name:"Rotation",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true},Direction:[-5f,-5f],DirectionRange:[10f,10f]}],Name:"smart_motion",TP:true,Speed:{Set:200d}}]},{Interval:{Min:60,Max:200,Current:60},Loop:{Max:1,Current:1},Call:[{Name:"smart_motion",TP:true,Speed:{Set:0d}}]}]}],ProjectileDamage:{physical:50,magic:50}}
#Function
# Icosphere
