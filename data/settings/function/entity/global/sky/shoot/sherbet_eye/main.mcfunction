...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;1,0,5,0],properties:[{name:"textures",value:""}]}}}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Name:"function",Tags:[Global,Sky,Shoot,SherbetEye,Attack1]}],Tick:[{Name:"function",Tags:[Global,Sky,Shoot,SherbetEye,Tick]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:100,Max:200,Current:10},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}],Settings:[{Name:"Direction",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true},Direction:[-180f,20f],DirectionRange:[360f,10f],Speed:-5d,SpeedRange:2d,Absolute:{Vertical:true}}],Name:"function",Tags:[Global,Sky,Shoot,AuroraEye,Tp]}]},{Interval:{Min:10,Max:60,Current:30},Loop:{Max:1,Current:1},Call:[{Name:"spawn",SpawnEntities:[[{Tags:[Global,Sky,Shoot,SherbetEye,Servant],Level:45}],[{Tags:[Global,Sky,Shoot,SherbetEye,ServantDirection],Level:45}]]}]}]}]}
