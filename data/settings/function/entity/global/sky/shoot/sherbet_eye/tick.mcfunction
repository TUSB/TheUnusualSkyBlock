#Function
# パーティクル
    particle falling_dust{block_state:{Name:"ice"}} ~ ~0.65 ~ 0.1 0.1 0.1 1 2 force @a[distance=..32,tag=ShowParticles]
    particle item{item:{id:"ice"}} ~ ~0.65 ~ 0.1 0.1 0.1 0.01 1 force @a[distance=..32,tag=ShowParticles]
    particle dust{color:[1.0,1.0,100000000.0],scale:1} ~ ~0.65 ~ 0.1 0.1 0.1 1 1 force @a[distance=..32,tag=ShowParticles]
# 乗り物に乗っている場合は殺す
    tag @s add This
