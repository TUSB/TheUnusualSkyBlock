#Function
particle item{item:{id:"ice"}} ~ ~ ~ 1.25 0.1 1.25 0.75 40 force @a[distance=..32,tag=ShowParticles]
particle end_rod ~ ~ ~ 1.25 0.1 1.25 0.75 40 force @a[distance=..32,tag=ShowParticles]
particle dust{color:[1.0,1.0,100000000.0],scale:1} ~ ~ ~ 1.25 0.25 1.25 1 100 force @a[distance=..32,tag=ShowParticles]
...
execute as @e[distance=..2.5,predicate=entity:friendly] if entity @s[type=player] run function settings:entity/global/sky/shoot/sherbet_eye/dry_end1
execute as @e[distance=..2.5,predicate=entity:friendly] unless entity @s[type=player] run function settings:entity/global/sky/shoot/sherbet_eye/dry_end2
