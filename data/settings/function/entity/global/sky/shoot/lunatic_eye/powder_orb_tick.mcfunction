#Function
# パーティクル
    particle item{item:{id:"purple_stained_glass"}} ~ ~1 ~ 0.5 0.5 0.5 0 2 force @a[distance=..16,tag=ShowParticles]
# ダメージ判定
    ...
    execute positioned ~-1.5 ~-1.5 ~-1.5 as @a[predicate=entity:player,dx=2,dy=2,dz=2] run function settings:entity/global/sky/shoot/lunatic_eye/powder_orb_effect
# なぜか徐々に近づいてくる……
