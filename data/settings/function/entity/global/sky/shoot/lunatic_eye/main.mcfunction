...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"function",Tags:[Global,Sky,Shoot,LunaticEye,Tick]},{Condition:[{Name:"min_hp",Inverse:true,HP:80,Percent:true}],Name:"function",Tags:[Global,Sky,Shoot,LunaticEye,ModeChange]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:200,Max:300,Current:10},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}],Name:"function",Tags:[Global,Sky,Shoot,LunaticEye,BackTp]}]}]}]}
