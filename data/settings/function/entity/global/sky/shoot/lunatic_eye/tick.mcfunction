#Function
# パーティクル
    particle falling_dust{block_state:{Name:"bubble_coral_block"}} ~ ~0.65 ~ 0.1 0.1 0.1 1 2 force @a[distance=..32,tag=ShowParticles]
    particle minecraft:witch ~ ~0.65 ~ 0.1 0.1 0.1 0.01 1 force @a[distance=..32,tag=ShowParticles]
    particle minecraft:dust{color:[1.0,0.0,100000000.0],scale:1} ~ ~0.65 ~ 0.1 0.1 0.1 1 1 force @a[distance=..32,tag=ShowParticles]
# 乗り物に乗っている場合は殺す
    tag @s add This
