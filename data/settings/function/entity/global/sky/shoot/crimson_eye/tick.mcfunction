#Function
# パーティクル
    particle minecraft:falling_dust{block_state:{Name:"redstone_block"}} ~ ~0.65 ~ 0.1 0.1 0.1 1 2 force @a[distance=..32,tag=ShowParticles]
    particle minecraft:dust{color:[100000000.0,0.5,0.0],scale:1} ~ ~0.65 ~ 0.1 0.1 0.1 1 1 force @a[distance=..32,tag=ShowParticles]
# 乗り物に乗っている場合は殺す
    tag @s add This
...
# HP判定
    ...
    execute unless entity @s[tag=HalfHP] run function settings:entity/global/sky/shoot/crimson_eye/hp_check
# Motion適用
