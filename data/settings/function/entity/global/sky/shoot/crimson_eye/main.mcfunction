...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;1,0,3,0],properties:[{name:"textures",value:""}]}}}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"random_chance",Chance:0.5d}],Name:"function",Tags:[Global,Sky,Shoot,CrimsonEye,Effect]}],Tick:[{Name:"function",Tags:[Global,Sky,Shoot,CrimsonEye,Tick]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:90,Max:150,Current:125},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:16d}}],Settings:[{Name:"Direction",Direction:[-180f,0f],DirectionRange:[360f,0f],Speed:0d,SpeedRange:3d}],Name:"spawn",SpawnEntities:[[{Tags:[Global,Sky,Shoot,CrimsonEye,BlazeMain],Level:30}],[{Tags:[Global,Sky,Shoot,CrimsonEye,BlazeEffect],Level:30}]]}]},{Interval:{Min:90,Max:150,Current:125},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:16d}}],Name:"spawn",Count:3,SpawnEntities:[[{Tags:[Global,Sky,Shoot,CrimsonEye,Blood],Level:30}],[{Tags:[Global,Sky,Shoot,CrimsonEye,BloodAuraMarker],Level:30}]]}]}]}]}
