#Function
# パーティクル
    particle falling_dust{block_state:{Name:"oxidized_copper"}} ~ ~0.65 ~ 0.1 0.1 0.1 1 1 force @a[distance=..32,tag=ShowParticles]
    particle falling_dust{block_state:{Name:"beacon"}} ~ ~0.65 ~ 0.1 0.1 0.1 1 1 force @a[distance=..32,tag=ShowParticles]
    particle dust_color_transition{from_color:[0.000,1.000,0.9],to_color:[1.2,0.0,0.35],scale:1} ~ ~0.65 ~ 0.3 0.3 0.3 0 3 force @a[distance=..32,tag=ShowParticles]
# 乗り物に乗っている場合は殺す
    tag @s add This
