...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:44d,IgnoreBlocks:true}}],Name:"step",Speed:0.4d},{Name:"function",Tags:[Global,Sky,Shoot,LostSoulWhite,NormalState]}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:100d,IgnoreBlocks:true},Half:"up"}],Name:"step",Direction:[0f,-90f],DirectionRange:[0f,25f],Speed:0.8d},{Name:"function",Tags:[Global,Sky,Shoot,LostSoulWhite,NormalState]}]}],Exit:{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:10d,IgnoreBlocks:true}}]}},{Index:2,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"step",Speed:-0.3d,Settings:[{Name:"Facing",Target:{Look:"Player",Radius:44d,IgnoreBlocks:true}}]},{Name:"function",Tags:[Global,Sky,Shoot,LostSoulWhite,ContactState]}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"has_target",Target:{Look:"Player",Radius:44d,IgnoreBlocks:true},Half:"up"}],Name:"step",Direction:[0f,-90f],DirectionRange:[0f,25f],Speed:0.8d},{Name:"function",Tags:[Global,Sky,Shoot,LostSoulWhite,ContactState]}],MP:5}],Exit:{Condition:[{Name:"has_target",Inverse:true,Target:{Look:"Player",Radius:10d,IgnoreBlocks:true}}]}}]}
