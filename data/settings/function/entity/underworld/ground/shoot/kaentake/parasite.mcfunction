...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"scute",count:1,components:{"minecraft:custom_model_data":14}}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
