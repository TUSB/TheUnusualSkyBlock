### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:vindicator",CustomName:'{"translate":"青紫キノコに寄生された村人","color":"#FFFFFF","bold":true}',Silent:true,PatrolLeader:false,Patrolling:false,CanJoinRaid:false,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,TickingRequired,HasLootTable]}
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"scute",count:1,components:{"minecraft:custom_model_data":8}}],ArmorDropChances:[-Infinityf,-Infinityf,-Infinityf,-Infinityf]}
