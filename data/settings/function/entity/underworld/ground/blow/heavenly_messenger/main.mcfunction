...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]}],Death:[{Name:"Function",Tags:[Global,Event,Function,DamageSound,Amorphous]}],Damage:[{Name:"Function",Tags:[Global,Event,Function,DamageSound,Amorphous]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:10,Current:10},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"CheckBlock",Block:["Water"],Logic:"OR"},{Name:"MinMP",MP:60,Inverse:1b}],Name:"Kill"},{Condition:[{Name:"HasTarget",Target:{Look:"Enemy",Radius:5}}],Name:"Function",Tags:["Underworld","Ground","Blow","HeavenlyMessenger","Parasite"]},{Condition:[{Name:"HasTarget",Target:{Look:"Friendly",Radius:5d}}],Name:"Damage",Player:{BypassArmor:1b,BypassResistance:1b},Distance:{Min:0.1d,Max:2d},AEC:{Particle:{type:"dust",color:[0.8470588235294118,0.9607843137254902,1.0],scale:1.0},Duration:10,Radius:0.5f,potion_contents:{custom_effects:[{id:"minecraft:invisibility",amplifier:4b,duration:5,show_particles:0b}]}}},{Name:"Function",Tags:["Global","Event","Function","CommonExe","BlockAlign"]},{Name:"SmartMotion",Stop:1b}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"Rotation",Direction:[-180f,-180f],DirectionRange:[360f,360f]}],Condition:[{Name:"Function",Tags:[Underworld,Ground,Blow,HeavenlyMessenger,Spread]}],Name:"SmartMotion",TP:true,Start:true,Rotation:{Horizontal:15f},Speed:{Set:100d,Range:50d},Gravity:{Set:500d}}]}]}]}
