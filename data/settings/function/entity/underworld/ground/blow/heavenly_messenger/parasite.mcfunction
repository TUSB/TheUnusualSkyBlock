...
execute as @e[tag=Enemy,distance=0.1..5,tag=!Amanotukai_LootAdd,tag=!NoLootTableAdd] run function ai:skill/function/loot_add
...
execute if entity @e[tag=Enemy,distance=0.1..5,tag=!Amanotukai_LootAdd,tag=!NoLootTableAdd] run scoreboard players remove @s MP 60
