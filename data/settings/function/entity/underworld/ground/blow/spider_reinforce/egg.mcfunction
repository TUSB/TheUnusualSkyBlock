...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:end_stone",count:1}]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Time:[{Condition:[{Name:"random_chance",Chance:0.65d}],Name:"spawn",SpawnEntities:[[{Tags:[Underworld,Ground,Blow,SpiderReinforce,Main],Level:1}]]}]}
#Function
particle minecraft:block{block_state:{Name:"end_stone"}} ~ ~0.5 ~ 0.3 0 0.3 0 1 force @a[distance=..64]
particle minecraft:dust{color:[1.0,0.0,0.0],scale:1} ~ ~4 ~ 0.2 0.1 0.2 20 10 force @a[distance=..64]
