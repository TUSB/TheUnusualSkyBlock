### 深淵様データ
# TODO: tag=Mobは他でつけたい
data modify storage tusb_mob: "固有ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'"深淵様"',Tags:[Mob]}

# 固有ステータス
data modify storage tusb_mob: "固有ステータス"."見た目" set value {HandItems:[{id:"minecraft:diamond_pickaxe",Count:1b},{}]}
data modify storage tusb_mob: "固有ステータス"."炎属性値" set value 120
data modify storage tusb_mob: "固有ステータス"."氷属性値" set value 120
data modify storage tusb_mob: "固有ステータス"."雷属性値" set value 120
data modify storage tusb_mob: "固有ステータス"."光属性値" set value 80
data modify storage tusb_mob: "固有ステータス"."闇属性値" set value 180
data modify storage tusb_mob: "固有ステータス"."最大感知範囲" set value 48
data modify storage tusb_mob: "固有ステータス"."基本移動力" set value 0.2
data modify storage tusb_mob: "固有ステータス"."ノックバック耐性" set value 100
data modify storage tusb_mob: "固有ステータス"."ノックバック力" set value 5
# 基礎ポイント
