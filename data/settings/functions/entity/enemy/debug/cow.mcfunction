### 深淵様データ
# TODO: tag=Mobは他でつけたい
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:cow",CustomName:'"深淵様"',Tags:[Mob]}
...
# 基礎ポイント
data modify storage tusb_mob: "遅延ステータス"."最大HP"."基礎ポイント" set value 300
