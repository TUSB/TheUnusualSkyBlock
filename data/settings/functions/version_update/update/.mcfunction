...
execute in area:skylands run data modify block -169 49 774 Text2 set value '{"text":"v13.%3$s.%4$s.α","with":[{"storage":"v13alpha:","nbt":"Version.Major"},{"storage":"v13alpha:","nbt":"Version.Minor"}]}'
