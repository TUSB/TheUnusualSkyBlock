### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombified_piglin",CustomName:'{"translate":"キラキマーハ","color":"#FF8000","bold":true}',Silent:1b,IsBaby:true,AngerTime:20000000,ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:0b},{Id:28,Amplifier:127b,Duration:-1,ShowParticles:0b}],PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,CallOnTick,TickingRequired,SmartMotion,Bounce,DamageProjectile,EnemyProjectile,FriendlyProjectile,HasLootTable,AnalyseLog]}
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{CustomModelData:4003,Explosion:{Type:0b,Colors:[I;16777215]}}}],ArmorDropChances:[-1E40f,-1E40f,-1E40f,-1E40f]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"割れ物注意！ 補償による返品交換は7回までとなっております！"}]'
# AI
