#Function
# 定期的に
data modify storage mob_data: CCHelper.Repeat.texts set value ["これぞ、至高！！"]
data modify storage mob_data: CCHelper.Repeat.y_offset set value 0.9f
...
# 目が合ったら
data modify storage mob_data: CCHelper.Insight.texts set value ["ポテト・パクパク・モグモグ・・・。\\nポテト・パクパク・モグモグ・・・。\\nポテト・パクパク・モグモグ・・・。"]
data modify storage mob_data: CCHelper.Insight.y_offset set value 0.9f
...
# 話し掛けたら
data modify storage mob_data: CCHelper.Interact.texts set value ["あなたにイモの祝福を。"]
data modify storage mob_data: CCHelper.Interact.y_offset set value 0.9f
