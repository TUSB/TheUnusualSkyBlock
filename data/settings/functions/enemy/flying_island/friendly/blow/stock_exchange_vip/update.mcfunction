...
execute unless score _ Calc matches 0 run function settings:enemy/flying_island/friendly/blow/stock_exchange_vip/add_stock
...
function settings:enemy/flying_island/friendly/blow/stock_exchange_vip/exchange_fluctuation
