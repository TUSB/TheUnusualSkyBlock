...
data modify storage mob_data: CCHelper.Repeat.y_offset set value 1.8f
...
# 目が合ったら
data modify storage mob_data: CCHelper.Insight.texts set value ["こちら、少し特殊な食べれる株を取引きしております。\\n・Ⓟ6・Ⓟ6・Ⓟ6是非チャレンジしてくださいね。"]
...
# 話し掛けたら
data modify storage mob_data: CCHelper.Interact.texts set value ["そう来なくちゃね！ さぁやろうか。"]
