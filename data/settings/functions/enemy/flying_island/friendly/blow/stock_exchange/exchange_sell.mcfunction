...
scoreboard players remove _ Random 7
...
# 取引状況を表示する
execute in area:control_area unless score _ Calc matches 0 run data modify block 2 3 2 front_text.messages[0] set value '[{"text":"","bold":true,"color":"aqua"}]'
execute in area:control_area if score _ Calc matches 0 run data modify block 2 3 2 front_text.messages[0] set value '[{"text":"","bold":true,"color":"aqua","strikethrough":true}]'
execute in area:control_area run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"取引番号："},{"storage":"mob_data:","nbt":"StockVillager.Recipe.buy.tag.Stock.ID"}," / ",{"translate":"残り取引："},[{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:15}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:14}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:13}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:12}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:11}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:10}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:9}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:8}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:7}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:6}.xp","color":"aqua"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:5}.xp","color":"yellow"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:4}.xp","color":"yellow"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:3}.xp","color":"yellow"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:2}.xp","color":"yellow"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:1}.xp","color":"red"},{"storage":"mob_data:","nbt":"StockVillager.Recipe{xp:0}.xp","color":"red"}],"/15"," / ",{"translate":"買値："},{"storage":"mob_data:","nbt":"StockVillager.StockInfo[-1].BuyCount"}," / ",{"translate":"売値："},{"score":{"name":"_","objective":"_"}}," / "]'
execute in area:control_area if score # _ matches ..-003 run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇩⇩","color":"blue"}]'
execute in area:control_area if score # _ matches -2..-1 run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇩ ","color":"blue"}]'
execute in area:control_area if score # _ matches 00..00 run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇨ ","color":"yellow"}]'
execute in area:control_area if score # _ matches 01..02 run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇧ ","color":"red"}]'
execute in area:control_area if score # _ matches 0003.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"translate":"傾向："},{"text":"⇧⇧","color":"red"}]'
execute in area:control_area run data modify storage mob_data: StockVillager.InfoLore append from block 2 3 2 front_text.messages[0]

execute unless data storage mob_data: StockVillager.Recipe{xp:0} in area:control_area unless score _ Calc matches 0 run tellraw @a[nbt={Inventory:[{tag:{Stock:{}}}]}] {"nbt":"front_text.messages[0]","block":"2 3 2","interpret":true}
