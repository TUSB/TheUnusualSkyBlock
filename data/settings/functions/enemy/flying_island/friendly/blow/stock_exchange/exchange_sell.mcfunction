...
execute in area:control_area unless score _ Calc matches 0 as @a if data entity @s Inventory[{tag:{Stock:{}}}] run tellraw @s {"nbt":"Text1","block":"2 3 2","interpret":true}
