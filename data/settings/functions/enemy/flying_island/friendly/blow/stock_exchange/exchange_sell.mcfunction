...
execute in area:control_area if score # _ matches ..-003 run data modify block 2 3 2 Text1 set value '[{"block":"2 3 2","nbt":"Text1","interpret":true},{"translate":"傾向："},{"text":"⇩⇩","color":"blue"}]'
execute in area:control_area if score # _ matches -2..-1 run data modify block 2 3 2 Text1 set value '[{"block":"2 3 2","nbt":"Text1","interpret":true},{"translate":"傾向："},{"text":"⇩ ","color":"blue"}]'
...
execute in area:control_area if score # _ matches 01..02 run data modify block 2 3 2 Text1 set value '[{"block":"2 3 2","nbt":"Text1","interpret":true},{"translate":"傾向："},{"text":"⇧ ","color":"red"}]'
