...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$sソラカブは寝かせすぎると腐るよ。ちゃんと売れる時に売ろうね！","with":[{"translate":"【能力：取引変更・無敵】","color":"#00FF00"}]}]'
# AI
