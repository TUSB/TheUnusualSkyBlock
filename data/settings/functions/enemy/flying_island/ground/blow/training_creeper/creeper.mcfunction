### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:creeper",Tags:[Mob,Enemy,DelayedData,TickingRequired,HasLootTable,AnalyseLog,NoLootTableAdd,NonBurst],CustomName:'{"translate":"訓練用クリーパー","color":"#FFFFFF","bold":true}',Fuse:10s,ExplosionRadius:0f,PortalCooldown:1500}
