...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/drop_item/tier7/common",Count:1,Chance:0.35d},{Item:{id:"minecraft:nether_star"},Count:48,Chance:1d}]
