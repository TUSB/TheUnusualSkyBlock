...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"SmartMotion",Gravity:{Set:300d}}],Block:[{Name:"Function",Tags:[GulliversLand,Ground,Blow,GiantDon,EarthQuake]},{Condition:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,SmartMotionZerospeed]}],Name:"SmartMotion",Stop:true}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:60,Max:120,Current:60},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:48d}},{Name:"Rotation",Direction:[0f,-60f],DirectionRange:[0f,15f]},{Name:"Direction",Speed:1d}],Name:"SmartMotion",TP:true,Start:true,Speed:{Set:70d,Range:10d}}]}]}]}
