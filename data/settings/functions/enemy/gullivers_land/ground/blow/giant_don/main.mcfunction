...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"SmartMotion",Gravity:{Set:300d}},{Name:"Function",Tags:[Global,Event,Function,CommonExe,SetMp0]}],Block:[{Name:"Function",Tags:[GulliversLand,Ground,Blow,GiantDon,EarthQuake]},{Condition:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,SmartMotionZerospeed]}],Name:"Damage",Player:{DamageType:[Global],DeathCause:'[{"translate":"「ﾌﾟﾁｯ」%1$sは%2$sの踏みつけによって床のシミになった。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Distance:{Max:3.5d}},{Condition:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,SmartMotionZerospeed]}],Name:"SmartMotion",Stop:true}],TurnCount:3,Turn:[{Index:1,Skill:[{Interval:{Min:40,Max:80,Current:40},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:48d,IgnoreBlocks:true}}],Name:"ChangeTurn",Set:2},{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:24d,IgnoreBlocks:true}},{Name:"RandomChance",Chance:0.35d}],Name:"ChangeTurn",Set:3}]}]},{Index:2,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Set:1},{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:48d}},{Name:"Rotation",Direction:[0f,-60f],DirectionRange:[0f,15f]},{Name:"Direction",Speed:1d}],Name:"SmartMotion",TP:true,Start:true,Speed:{Set:55d,Range:35d}}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:3,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"At",Target:{Look:"Friendly",Radius:24d,IgnoreBlocks:true}}],Name:"Parabolic",MotionTick:40,MotionGravity:0.08d}]}],Exit:{Loop:{Max:1,Current:1}}}]}
