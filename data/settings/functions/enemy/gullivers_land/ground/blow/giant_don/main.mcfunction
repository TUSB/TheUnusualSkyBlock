### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:giant",CustomName:'[{"translate":"t","color":"#440066","obfuscated":true},{"translate":"u","color":"#53007D","obfuscated":true},{"translate":"s","color":"#68009C","obfuscated":true},{"translate":"b","color":"#8300C4","obfuscated":true},{"translate":"巨人のドン","color":"#AA00FF","bold":true,"obfuscated":false},{"translate":"b","color":"#8300C4","obfuscated":true},{"translate":"s","color":"#68009C","obfuscated":true},{"translate":"u","color":"#53007D","obfuscated":true},{"translate":"t","color":"#440066","obfuscated":true}]',PortalCooldown:4500,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,CallOnBlock,TickingRequired,NativeTask,SmartMotion,Stick,DamageProjectile,EnemyProjectile]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス"."最大MP" set value -29
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"SmartMotion",Gravity:{Set:300d}}],Block:[{Name:"Function",Tags:[GulliversLand,Ground,Blow,GiantDon,EarthQuake]},{Condition:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,SmartMotionZerospeed]}],Name:"SmartMotion",Stop:true}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:40,Max:100,Current:60},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:48d}},{Name:"Rotation",Direction:[0f,-60f],DirectionRange:[0f,15f]},{Name:"Direction",Speed:1d}],Name:"SmartMotion",TP:true,Start:true,Speed:{Set:55d,Range:35d}}]}]}]}
