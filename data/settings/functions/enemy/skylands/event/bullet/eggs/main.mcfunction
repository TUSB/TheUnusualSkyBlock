...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true},Anchor:"Eyes"}],Name:"Step",Speed:1.2d,SpeedRange:0.4d}],Attack:[{Name:"Function",Tags:[Skylands,Event,Bullet,Eggs,Debuff]}]}
#Function
