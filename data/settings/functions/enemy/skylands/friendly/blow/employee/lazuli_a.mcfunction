### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[LimitedTrades,AnalyseLog,UpdateOffers],CustomName:'{"translate":"《魔石》魔商・ラズリー","color":"#00FF00","bold":true}',AbsorptionAmount:9999999f,Invulnerable:true,DeathTime:19s,DeathLootTable:"empty",VillagerData:{level:99,profession:"cartographer",type:"snow"},DeathLootTableSeed:2147483647L}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"魔石に価値がなくなる日が来るかもしれない。"}]'
#Function
