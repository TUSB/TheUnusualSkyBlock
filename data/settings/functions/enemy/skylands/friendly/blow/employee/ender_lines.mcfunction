...
# 目が合ったら
data modify storage mob_data: CCHelper.Insight.texts set value ["じーーーーーー。\\n","(印板を買えと視線を送っている。印板はいいぞ。)"]
...
# 話し掛けたら
data modify storage mob_data: CCHelper.Interact.texts set value ["コッポ・・・。"]
