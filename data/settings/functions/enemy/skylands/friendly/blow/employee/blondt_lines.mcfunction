...
data modify storage mob_data: CCHelper.Repeat.y_offset set value 1.4f
...
# 目が合ったら
data modify storage mob_data: CCHelper.Insight.texts set value ["俺はしがないエリート防具屋。\\n唯一ぬにの§0盾は貧弱一般モブの攻撃を無効§rにできる。\\n盾は剣士以外にあり得ないが、\\n謙虚なジョブは見習って持つべきそうするべき。"]
data modify storage mob_data: CCHelper.Insight.y_offset set value 1.4f
...
# 話し掛けたら
data modify storage mob_data: CCHelper.Interact.texts set value ["盾を奢ってやろう。\\n9ギガントエメラルドでいいぞ。Ⓟ30\\n冗談だ。"]
data modify storage mob_data: CCHelper.Interact.y_offset set value 1.4f
