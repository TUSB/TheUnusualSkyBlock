#Function
# 定期的に
data modify storage mob_data: CCHelper.Repeat.texts set value ["・Ⓟ6・Ⓟ6・Ⓟ8フフフ。"]
data modify storage mob_data: CCHelper.Repeat.y_offset set value -1f
data modify storage mob_data: CCHelper.Repeat.background set value "#FF35005A"
...
data modify storage mob_data: CCHelper.Repeat.text_format set value '{"text":"","color":"#D00000"}'
data modify storage mob_data: Tags append value CCHelperRepeat

# 目が合ったら
data modify storage mob_data: CCHelper.Insight.texts set value ["うまく使いこなしてね。\\nじゃないとⓅ6・Ⓟ6・Ⓟ6・Ⓟ8フフフ。"]
...
# 話し掛けたら
data modify storage mob_data: CCHelper.Interact.texts set value ["いいよ、うまく使いこなしてごらん。"]
