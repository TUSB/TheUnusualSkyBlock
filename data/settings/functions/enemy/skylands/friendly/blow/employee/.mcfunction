...
execute if entity @s[tag=LazuliA] run function settings:enemy/skylands/friendly/blow/employee/lazuli_a
execute if entity @s[tag=LazuliB] run function settings:enemy/skylands/friendly/blow/employee/lazuli_b
