### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[AnalyseLog,UpdateOffers],CustomName:'{"translate":"《ゲスト》ビラマキ","color":"#00FF00","bold":true}',AbsorptionAmount:9999999f,Invulnerable:true,DeathTime:19s,Silent:true,ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:false}],NoAI:true,DeathLootTable:"empty",VillagerData:{level:99,profession:"nitwit",type:"plains"}}
