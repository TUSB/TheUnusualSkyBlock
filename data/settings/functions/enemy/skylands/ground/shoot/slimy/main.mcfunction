### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:slime",CustomName:'{"translate":"スライミー","color":"#FFFFFF","bold":true}',Size:1,ActiveEffects:[{Id:14,Amplifier:127b,Duration:2147483647,ShowParticles:0b},{Id:28,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnAttack,TickingRequired]}
