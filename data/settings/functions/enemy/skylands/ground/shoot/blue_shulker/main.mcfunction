### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:shulker",CustomName:'{"translate":"ブルーシュルカー","color":"#FFFFFF","bold":true}',AttachFace:0b,Color:11b,ActiveEffects:[{Id:28,Amplifier:0b,Duration:-1,ShowParticles:0b}],PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,CallOnAttack,TickingRequired,HasLootTable,AnalyseLog]}
