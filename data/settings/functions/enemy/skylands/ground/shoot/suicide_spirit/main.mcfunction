### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Silent:1b,CustomName:'{"translate":"自爆霊","color":"#FFFFFF","bold":true}',ActiveEffects:[{Id:12,Amplifier:1b,Duration:2147483647,ShowParticles:0b},{Id:14,Amplifier:127b,Duration:2147483647,ShowParticles:0b}],PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnTick,TickingRequired,HasLootTable]}
