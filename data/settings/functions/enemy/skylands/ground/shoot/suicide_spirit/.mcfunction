...
execute if entity @s[tag=Bomb1] run function settings:enemy/skylands/ground/shoot/suicide_spirit/bomb1
execute if entity @s[tag=Bomb2] run function settings:enemy/skylands/ground/shoot/suicide_spirit/bomb2
execute if entity @s[tag=Appearence] run function settings:enemy/skylands/ground/shoot/suicide_spirit/appearence
