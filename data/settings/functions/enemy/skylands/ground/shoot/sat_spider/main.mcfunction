...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:4,Turn:[{Index:1,Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:6d,IgnoreBlocks:true}}]}},{Index:2,Skill:[{Call:[{Name:"MergeNBT",NBT:{Attributes:[{Name:generic.movement_speed,Base:0.01}]}}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:3,Exit:{Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Player",Radius:6d,IgnoreBlocks:true}}]}},{Index:4,Skill:[{Call:[{Name:"MergeNBT",NBT:{Attributes:[{Name:generic.movement_speed,Base:0.35}]}}]}],Exit:{Loop:{Max:1,Current:1}}}]}
