...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/drop_item/tier3/common",Count:1,Chance:0.51d},{Loot:"item:item/warped_fungus_on_a_stick/block/cake",Count:1,Chance:0.1d}]
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"この筋肉は飾りではない。"}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Event,Function,Attributes,MovementSpeedRandom],MinSpeed:1,RangeSpeed:30}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:80,Max:100,Current:80},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:5,Current:5,Range:15},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:64d,IgnoreBlocks:true},Anchor:"Eyes"},{Name:"Direction",Speed:1d},{Name:"Rotation",Direction:[30f,30f],DirectionRange:[-60f,-60f]}],Name:"Spawn",SpawnEntities:[[{Tags:[Skylands,Ground,Shoot,Patissier,FreshCreamAstonish],Level:1}]]}],MP:2}],Exit:{Loop:{Max:1,Current:1}}}]}
