...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Condition:[{Name:"Function",Tags:[Global,Event,Function,Conditions,IsDaytime],Inverse:true}],Name:"Kill"},{Name:"Function",Tags:[Global,Event,Function,Common,BlockAlign]}],Damage:[{Element:[Fire,Ice,Lightning,Light,Dark],Settings:[{Name:"At",Target:{Look:"Player",Radius:64}},{Name:"Direction",Direction:[-180f,0f],Speed:2d}],Name:"Teleport"}],Block:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}},{Name:"Rotation",Direction:[0f,-45f]}],Name:"SmartMotion",TP:true,Speed:{Set:150d}}],TurnCount:3,Turn:[{Index:1,Skill:[{Interval:{Min:8,Max:8,Current:8},Call:[{Condition:[{Name:"HasTarget",Logic:"OR",Target:{Look:"Player",Radius:16d,IgnoreBlocks:true}},{Name:"MinHP",Inverse:true,HP:99,Percent:true}],Name:"ChangeTurn",Set:2}]}]},{Index:2,Skill:[{Interval:{Min:2,Max:2,Current:2},Call:[{Name:"ChangeStatus",ElementFire:{Set:100},ElementIce:{Set:100},ElementLightning:{Set:100},ElementLight:{Set:100},ElementDark:{Set:100}},{Name:"ChangeAI",Damage:[{}]},{Name:"SmartMotion",OnBlock:"Bounce",TP:true,Start:true,Speed:{Set:100d},Gravity:{Set:500d}}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:3,Skill:[{Interval:{Min:15,Max:30,Current:30},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"Function",Tags:[Global,Event,Function,Conditions,IsDaytime],Inverse:true}],Name:"Kill"},{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:64d}}],Name:"Step",Speed:0.0d}]},{Interval:{Min:2,Max:2,Current:2},Loop:{Max:5,Current:5},Call:[{Settings:[{Name:"Rotation",Target:{Look:"Self",Radius:1d,IgnoreBlocks:true}},{Name:"Anchor",Anchor:"Eyes"},{Name:"Direction",Speed:1d}],Name:"Spawn",SpawnEntities:[[{Tags:[Skylands,Ground,Shoot,SunEater,SolarRay],Level:1}]]}]}]}]}
