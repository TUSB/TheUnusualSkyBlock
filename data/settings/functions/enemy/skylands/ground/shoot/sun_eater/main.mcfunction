...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s日が昇っている時にしか現れないひまわりに擬態している肉食植物。得意技はソーラービーム。","with":[{"translate":"【能力：格闘・射的・混乱・昼現・物理無効】","color":"#00FF00"}]}]'
# AI
