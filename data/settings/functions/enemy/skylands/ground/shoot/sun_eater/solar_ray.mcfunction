...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"SmartMotion",TP:true,Speed:{Set:0}},{Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Friendly",Radius:32d}}],Name:"Kill"}],Attack:[{Name:"Damage",Player:{DeathCause:'[{"translate":"%1$sは%2$sのタックルによって転倒し全治100年の複雑骨折を負った。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName"}]}]'},Distance:{Max:2d},AEC:{Effects:[{Id:14b,Amplifier:6b,Duration:5,ShowParticles:false}]}},{Name:"Function",Tags:[Skylands,Ground,Shoot,SunEater,SolarRayParticleAndSound]}],Block:[{Name:"Damage",Player:{DeathCause:'[{"translate":"%1$sは%2$sのタックルによって転倒し全治100年の複雑骨折を負った。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Distance:{Max:2d},AEC:{Effects:[{Id:14b,Amplifier:6b,Duration:5,ShowParticles:false}]}},{Name:"Function",Tags:[Skylands,Ground,Shoot,SunEater,SolarRayParticleAndSound]}],TurnCount:1,Turn:[{Index:1,Once:1,Skill:[{Interval:{Min:6,Max:6,Current:6},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Type:0,Colors:[I;16777113]},CustomModelData:134}}],DisabledSlots:4144959}},{Name:"SmartMotion",TP:true,Speed:{Set:50}}]}],Exit:{Loop:{Max:1,Current:1}}}]}
#Function
