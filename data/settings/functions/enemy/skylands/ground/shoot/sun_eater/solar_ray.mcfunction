### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:armor_stand",CustomName:'{"translate":"ソーラーレイ"}',Tags:[DelayedData,HasAI,CallOnInit,CallOnAttack,CallOnBlock,CooldownRequired,NativeTask,SmartMotion,Bounce,DamageProjectile,EnemyProjectile,HideLevel],Small:1b,Invisible:1b,Invulnerable:1b,PortalCooldown:100}
