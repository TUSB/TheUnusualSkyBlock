### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:pufferfish",CustomName:'{"translate":"バイオ・フグ","color":"#FFFFFF"}',Air:32767s,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,CallOnDamage,TickingRequired,DamageProjectile,EnemyProjectile,HasLootTable,AnalyseLog]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/drop_item/tier1/common",Count:1,Chance:0.28d},{Item:{id:"minecraft:salmon"},Count:1,Chance:1d}]
