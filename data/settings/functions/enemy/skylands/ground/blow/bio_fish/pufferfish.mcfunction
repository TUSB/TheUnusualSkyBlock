### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:pufferfish",CustomName:'{"translate":"バイオ・フグ","color":"#FFFFFF"}',Air:32767s,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,TickingRequired,DamageProjectile,EnemyProjectile,HasLootTable]}
