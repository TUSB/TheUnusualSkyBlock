### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"羊の亡霊","color":"#FF0000","bold":true}',ActiveEffects:[{Id:14,Amplifier:0b,Duration:2147483647,ShowParticles:0b},{Id:28,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],Silent:1b,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,TickingRequired,HasLootTable]}
