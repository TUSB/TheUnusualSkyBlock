### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"羊の亡霊"}',ActiveEffects:[{Id:14b,Amplifier:0b,Duration:2147483647,ShowParticles:0b},{Id:28b,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],Silent:1b,Tags:[Mob,DelayedData,HasAI,HasLootTable]}
