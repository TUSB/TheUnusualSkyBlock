### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"羊の亡霊"}',ActiveEffects:[{Id:14b,Amplifier:0b,Duration:2147483647,ShowParticles:0b},{Id:28b,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],Silent:1b,Tags:[Mob,Enemy,DelayedData,HasAI,HasLootTable]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:10,Current:40},Call:[{Name:"Function",Tags:[Skylands,Ground,Blow,GhostSheep,Fill]}]}]}]}
