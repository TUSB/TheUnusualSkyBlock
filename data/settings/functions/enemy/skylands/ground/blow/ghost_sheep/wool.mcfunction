### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:area_effect_cloud",Duration:200,PortalCooldown:100,Tags:[DelayedData,HasAI,CallOnInit,CallOnTimeOut,CooldownRequired]}
