...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s床張り検定２級を所持している「全床を酸床にするケロ～激痛はサービスケロ」","with":[{"translate":"【能力：追撃・地形破壊】","color":"#00FF00"}]}]'
# AI
