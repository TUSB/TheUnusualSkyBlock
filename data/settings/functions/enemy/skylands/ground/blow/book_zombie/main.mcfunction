...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {HandItems:[{id:"minecraft:enchanted_book",Count:1b},{}],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:65493},Unbreakable:1b}},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:65493},Unbreakable:1b}},{id:"minecraft:bookshelf",Count:1b}],HandDropChances:[-1E40f,-1E40f],ArmorDropChances:[-1E40f,-1E40f,-1E40f,-1E40f]}
