execute if entity @s[tag=Main] run function settings:enemy/skylands/ground/blow/ender_boomer/main
execute if entity @s[tag=Tag] run function settings:enemy/skylands/ground/blow/ender_boomer/tag
execute if entity @s[tag=Turn] run function settings:enemy/skylands/ground/blow/ender_boomer/turn
