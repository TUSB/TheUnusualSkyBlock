### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:enderman",CustomName:'{"translate":"爆弾処理班","color":"#FFFFFF","bold":true}',carriedBlockState:{Name:"minecraft:tnt",Properties:{unstable:"true"}},PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,TickingRequired]}
