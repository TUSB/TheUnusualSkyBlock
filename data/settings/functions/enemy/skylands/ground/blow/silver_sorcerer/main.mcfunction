...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Condition:[{Name:"HasTarget",Target:{Look:"Friendly",Radius:16d,IgnoreBlocks:true}},{Name:"RandomChance",Chance:0.05d}],Name:"Spawn",Count:1,SpawnEntities:[[{Tags:[Skylands,Ground,Blow,SilverSorcerer,Main],Level:15}]]}],Tick:[{Name:"Function",Tags:[Skylands,Ground,Blow,SilverSorcerer,Particle]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:100,Max:200,Current:150},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"Direction",Target:{Look:"Player",Radius:12d,IgnoreBlocks:true},Direction:[-180f,0f],DirectionRange:[360f,0f],Speed:0d,SpeedRange:1d,Absolute:{Vertical:true}}],Name:"Spawn",Count:1,SpawnEntities:[[{Tags:[Skylands,Ground,Blow,SilverSorcerer,SpikeMain],Level:12}],[{Tags:[Skylands,Ground,Blow,SilverSorcerer,Spike1],Level:12}],[{Tags:[Skylands,Ground,Blow,SilverSorcerer,Spike2],Level:12},{Tags:[Skylands,Ground,Blow,SilverSorcerer,Spike3],Level:12},{Tags:[Skylands,Ground,Blow,SilverSorcerer,Spike4],Level:12},{Tags:[Skylands,Ground,Blow,SilverSorcerer,Spike5],Level:12}]]}]}]}]}
