...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"床張り検定１級を所持している「全床を即死床にするケロ～３秒間乗ってれば極楽にいけるサービス付きケロ」"}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,SetMp0]}],Damage:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}},{Name:"Rotation",Direction:[-30f,-45f],DirectionRange:[60f,0f],Absolute:{Vertical:true}}],Name:"Step",Speed:0.4d,SpeedRange:1.4d}],Attack:[{Condition:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,SurvivalJudge]},{Name:"CheckNBT",NBT:{OnGround:true}},{Name:"CheckBlock",Block:[Air]}],Name:"Function",Tags:[Skylands,Ground,Blow,DeathFlooringFrog,ProcessFloor]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:30,Max:90,Current:3},Loop:{Max:2,Current:2,Range:3},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:32d,IgnoreBlocks:true}},{Name:"Rotation",Direction:[-15f,-45f],DirectionRange:[30f,0f],Absolute:{Vertical:true}}],Name:"Step",Speed:0.4d,SpeedRange:1.4d}]}]}]}
