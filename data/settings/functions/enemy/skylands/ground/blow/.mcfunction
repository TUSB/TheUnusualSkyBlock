...
execute if entity @s[tag=RefinishDropFloorFrog] run function settings:enemy/skylands/ground/blow/refinish_drop_floor_frog/
execute if entity @s[tag=Giga] run function settings:enemy/skylands/ground/blow/giga/
execute if entity @s[tag=RefinishAcidFloorFrog] run function settings:enemy/skylands/ground/blow/refinish_acid_floor_frog/
...
execute if entity @s[tag=RefinishDeathFloorFrog] run function settings:enemy/skylands/ground/blow/refinish_death_floor_frog/
