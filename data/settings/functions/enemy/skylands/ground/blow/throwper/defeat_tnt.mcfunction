...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Direction:[0f,-60f],Speed:1.0d,SpeedRange:2.0d,Target:{Look:"player",Radius:32d,IgnoreBlocks:false}}],TurnCount:6,Turn:[{Index:1,Exit:{Time:80,TimeCount:80}},{Index:2,Skill:[{Interval:{Min:10,Max:10,Current:10},Call:[{Name:"MergeNBT",NBT:{ArmorItems:[{},{},{},{id:"firework_star",Count:1b,tag:{CustomModelData:2001,Explosion:{Type:0,Colors:[I;16738408]}}}]}}]},{Interval:{Min:10,Max:10,Current:10},Call:[{Name:"MergeNBT",NBT:{ArmorItems:[{},{},{},{id:"firework_star",Count:1b,tag:{CustomModelData:2001,Explosion:{Type:0,Colors:[I;0]}}}]}}]}],Exit:{Loop:{Max:6,Current:6}}},{Index:3,Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Summon,CountDown,Count3],Level:1}]]},{Name:"ChangeTurn",Set:2}],Once:1}]},{Index:4,Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Summon,CountDown,Count2],Level:1}]]},{Name:"ChangeTurn",Set:2}],Once:1}]},{Index:5,Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Summon,CountDown,Count1],Level:1}]]},{Name:"ChangeTurn",Set:2}],Once:1}]},{Index:6,Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Bullet,IedTnt],Level:1}]]},{Name:"Kill"}],Once:1}]}]}
