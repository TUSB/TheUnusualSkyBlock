...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:6,Turn:[{Index:1,Exit:{Time:60,TimeCount:60}},{Index:2,Skill:[{Interval:{Min:10,Max:10,Current:10},Call:[{Name:"MergeNBT",NBT:{ArmorItems:[{},{},{},{id:"firework_star",Count:1b,tag:{CustomModelData:2001,Explosion:{Type:0,Colors:[I;16738408]}}}]}}]},{Interval:{Min:10,Max:10,Current:10},Call:[{Name:"MergeNBT",NBT:{ArmorItems:[{},{},{},{id:"firework_star",Count:1b,tag:{CustomModelData:2001,Explosion:{Type:0,Colors:[I;0]}}}]}}]}],Exit:{Loop:{Max:6,Current:6}}},{Index:3,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Summon,CountDown,Count3],Level:1}]]},{Name:"ChangeTurn",Set:2}],Once:{Max:1}}]},{Index:4,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Summon,CountDown,Count2],Level:1}]]},{Name:"ChangeTurn",Set:2}],Once:{Max:1}}]},{Index:5,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Summon,CountDown,Count1],Level:1}]]},{Name:"ChangeTurn",Set:2}],Once:{Max:1}}]},{Index:6,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Bullet,IedTnt],Level:1}]]},{Name:"Kill"}],Once:{Max:1}}]}]}
