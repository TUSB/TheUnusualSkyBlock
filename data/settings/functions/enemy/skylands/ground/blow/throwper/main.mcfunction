### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:creeper",CustomName:'{"translate":"スローパー","color":"#FFFFFF"}',Fuse:120s,Tags:[Mob,Enemy,DelayedData,HasAI,HasLootTable]}
