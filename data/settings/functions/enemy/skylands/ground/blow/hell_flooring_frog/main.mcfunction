### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:frog",CustomName:'{"translate":"オトシハリカエル","color":"#FF0000","bold":true}',InLove:0,Age:9999,ForcedAge:9999,variant:"minecraft:warm",PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,CallOnDamage,CallOnAttack,TickingRequired,DamageProjectile,EnemyProjectile,HasLootTable,AnalyseLog]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s床張り検定特級を所持している「全床を落とし床にするケロ～奈落直行はサービスケロ」","with":[{"translate":"【能力：追撃・地形破壊】","color":"#00FF00"}]}]'
# AI
