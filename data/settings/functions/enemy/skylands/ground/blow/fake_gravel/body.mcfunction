### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:slime",Team:"Friendly",Silent:1b,CustomName:'{"translate":"砂利モドキ","color":"#FFFF00","bold":true}',ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:false}],Size:1,NoAI:0b,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,CallOnDeath,CallOnDamage,TickingRequired,DamageProjectile,FriendlyProjectile,HasLootTable,AnalyseLog]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Item:{id:"minecraft:gravel"},Count:1,CountRange:16,Chance:1d}]
