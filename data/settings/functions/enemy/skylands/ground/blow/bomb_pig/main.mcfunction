...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/magic_stone/tier1/mix",Count:1,Chance:1d},{Item:{id:"minecraft:cooked_porkchop"},Count:1,Chance:0.1d}]
# AI
