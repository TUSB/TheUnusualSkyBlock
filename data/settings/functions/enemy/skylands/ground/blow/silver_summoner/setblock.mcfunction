#Function
# サバイバルエリアかどうか
    execute if entity @s[predicate=settings:enemy/conditions/survival] run fill ~-0.5 ~-1 ~-0.5 ~0.5 ~-1 ~0.5 infested_chiseled_stone_bricks replace #settings:conditions/can_replace
