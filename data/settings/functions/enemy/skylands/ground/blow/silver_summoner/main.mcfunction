### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:silverfish",CustomName:'{"translate":"シルバーサモナー","color":"#FF0000","bold":true}',PersistenceRequired:1b,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnTick,CooldownRequired,AnalyseLog]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$sオラオラ、てめぇら仕事の時間だ！ 出てきやがれ！","with":[{"translate":"【能力：コール】","color":"#00FF00"}]}]'
# AI
