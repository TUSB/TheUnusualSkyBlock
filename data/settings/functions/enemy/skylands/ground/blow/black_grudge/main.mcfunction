### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:wither_skeleton",CustomName:'{"translate":"黒怨之徘徊者","color":"#FFFFFF","bold":true}',ActiveEffects:[{Id:12b,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnAttack,TickingRequired]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"RandomChance",Chance:0.2d}],Name:"Function",Tags:[Skylands,Ground,Blow,BlackGrudge,Debuff1]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:60,Max:100,Current:80},Loop:{Max:1,Current:1},Call:[{Name:"Function",Tags:[Skylands,Ground,Blow,BlackGrudge,Scream]},{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:3d,IgnoreBlocks:true}},{Name:"RandomChance",Chance:0.25d}],Settings:[{Name:"At",Target:{Look:"Player",Radius:3d,IgnoreBlocks:true}}],Name:"Function",Tags:[Skylands,Ground,Blow,BlackGrudge,Debuff2]},{Name:"Damage",Player:{Effectiveness:100,DeathCause:'[{"translate":"%1$sは%2$sの叫び声に震え上がり、心肺停止してしまった。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName"}]}]'},Distance:{Max:3.5d}}]}]}]}
