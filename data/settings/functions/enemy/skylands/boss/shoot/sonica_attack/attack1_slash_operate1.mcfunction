#Function
# 判定
    function settings:enemy/skylands/boss/shoot/sonica_attack/attack1_slash1
...
# 対象に防具貫通でダメージを与える
    ...
    execute store result storage score_damage: Argument.Damage int 1.5 run scoreboard players get @s Attack
