...
# 当たったプレイヤーにダメージを与える（確定麻痺）
    ...
    execute as @e[type=!player,predicate=entity:friendly,tag=Landing,distance=..32] run function function settings:enemy/skylands/boss/shoot/sonica_ai/wave_damage3
