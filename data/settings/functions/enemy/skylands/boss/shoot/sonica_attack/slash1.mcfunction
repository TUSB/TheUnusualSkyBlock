...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"Function",Tags:[Skylands,Boss,Shoot,SonicaAttack,Attack1SlashOperate1]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:30,Current:30},Call:[{Name:"Function",Tags:[Global,Friendly,Shoot,FlarePixely,SlashTp]}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"Kill"}]}]}]}
