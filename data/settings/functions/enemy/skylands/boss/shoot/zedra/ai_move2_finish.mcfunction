...
execute at @s run tp @e[tag=NowTarget] ~ ~ ~ ~ ~
...
execute at @s run summon armor_stand ~ ~0.9 ~ {Tags:[Spawn],DeathTime:19s,NoAI:1b,Silent:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1,SpawnEntities:[[{Tags:[Skylands,Boss,Shoot,ZedraAec,1Main],Level:1}]]}}]}
## AI.Turn[0].ExitにChangeTurnフラグを追加
data modify storage mob_data: AI.Turn[0].Exit.ChangeTurn set value 1b
## ターンの決定
data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].AdditionalAI.MoveSkill set value 2
