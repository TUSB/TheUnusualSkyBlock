...
execute if score _ _ matches 2 run summon armor_stand ~ ~ ~ {Tags:[Spawn],DeathTime:19s,NoAI:1b,Silent:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1,SpawnEntities:[[{Tags:[Skylands,Boss,Shoot,Zedra,Ai],Level:60}],[{Tags:[Skylands,Boss,Shoot,Zedra,ArmorHead],Level:1}],[{Tags:[Skylands,Boss,Shoot,Zedra,ArmorBody],Level:1}]]}}]}
