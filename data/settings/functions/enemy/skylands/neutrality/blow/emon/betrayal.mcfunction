...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/drop_item/all/villager",Count:1,Chance:0.35d},{Item:{id:"minecraft:beef"},Count:1,CountRange:8,Chance:1d},{Loot:"item:item/diamond_sword/a_end_of_end",Count:1,Chance:0.001d}]
