### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[Mob,DelayedData,HasAI,CallOnTimeOut,CallOnDamage,TickingRequired,DamageProjectile,FriendlyProjectile,HasLootTable,AnalyseLog,WanderingVillager],CustomName:'{"translate":"歴戦の行商人・エモン","color":"#00FF00","bold":true}',PortalCooldown:3000,DeathLootTable:"empty",VillagerData:{level:99,profession:"nitwit",type:"jungle"}}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"ほぉ～これはこれは、「良い肉」を持っているな。"}]'
# AI
