...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"Function",Tags:[Skylands,Sky,Shoot,ImpureSkull,Motion]}],Passenger:{Type:"down",Check:true,Call:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,SearchAndDestroy]}]},TurnCount:3,Turn:[{Index:1,Skill:[{Interval:{Min:120,Max:200,Current:150},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}],Name:"ChangeTurn",Random:true}]}]},{Index:2,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"Function",Tags:[Skylands,Sky,Shoot,ImpureSkull,DoomSummon1]},{Name:"ChangeTurn",Loop:2}]}]},{Index:3,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"Function",Tags:[Skylands,Sky,Shoot,ImpureSkull,BeamPre]},{Name:"ChangeAI",Tick:[]}]},{Interval:{Min:4,Max:4,Current:4},Loop:{Max:1,Current:1},Call:[{Name:"DelayAction",Tags:["Casting","DoomCast"]}]},{Interval:{Min:20,Max:20,Current:20},Loop:{Max:1,Current:1},Call:[{Name:"Function",Tags:[Skylands,Sky,Shoot,ImpureSkull,BeamFinish]},{Name:"ChangeAI",Tick:[{Name:"Function",Tags:[Skylands,Sky,Shoot,ImpureSkull,Motion]}]},{Settings:[{Name:"Direction",Direction:[0f,-90f],Speed:0.5d,Absolute:{Vertical:true}}],Name:"Spawn",SpawnEntities:[[{Tags:[Skylands,Sky,Shoot,ImpureSkull,Soul],Level:33}],[{Tags:[Skylands,Sky,Shoot,ImpureSkull,SoulDirection],Level:1}]]},{Name:"ChangeTurn",Loop:1}]}]}]}
