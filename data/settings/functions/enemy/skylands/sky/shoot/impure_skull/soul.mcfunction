...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"SmartMotion",OnBlock:"Bounce",TP:true,Start:true,Speed:{Set:30d,Range:5d},Gravity:{Set:0d}}],Attack:[{Name:"Function",Tags:[Skylands,Sky,Blow,WaterMelon,Debuff]},{Name:"Function",Tags:[Skylands,Sky,Blow,WaterMelon,Debuff]},{Name:"Kill"}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:5,Current:5},Call:[{Name:"SmartMotion",Gravity:{Add:40d}}],Once:1},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:10,Current:10},Call:[{Name:"SmartMotion",Gravity:{Add:-40d}}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:10,Current:10},Call:[{Name:"SmartMotion",Gravity:{Add:40d}}]}]}]}
