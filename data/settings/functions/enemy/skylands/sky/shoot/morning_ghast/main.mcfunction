...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Condition:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,IsDaytime],Inverse:true}],Name:"Kill"},{Settings:[{Name:"Direction",Direction:[0f,-90f],Speed:16d,Absolute:{Vertical:true}}],Name:"Teleport"}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:40,Max:200,Current:80},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Target:{Look:"Friendly",Radius:64d},Skill:[{Interval:{Min:3,Max:3,Current:3},Loop:{Max:16,Current:16},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:64d}}],Name:"Function",Tags:[Skylands,Sky,Shoot,MorningGhast,Sound]},{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:64d},Anchor:"Eyes"},{Name:"Direction",Speed:3d}],Name:"Spawn",SpawnEntities:[[{Tags:[Skylands,Sky,Shoot,MorningGhast,Bullet],Level:5}]]}],MP:3},{Interval:{Min:40,Max:40,Current:40},Loop:{Max:1,Current:1},Call:[{}]}],Exit:{Time:120,TimeCount:120}}]}
