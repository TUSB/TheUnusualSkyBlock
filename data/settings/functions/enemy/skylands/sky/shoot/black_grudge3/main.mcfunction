### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:phantom",CustomName:'{"translate":"黒怨之飛翔者","color":"#FF0000","bold":true}',Tags:[Mob,Enemy,DelayedData,HasAI,CallOnAttack,CallOnTick,CooldownRequired,HasLootTable,BlackGrudge_C],Size:4,PortalCooldown:3000,DeathLootTable:"empty"}
