### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:vex",CustomName:'{"translate":"てぃっぴー","color":"#FFFFFF","bold":true}',Silent:1b,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnAttack,TickingRequired,DamageProjectile,EnemyProjectile,TippyCount],ActiveEffects:[{Id:14,Amplifier:127b,Duration:2147483647,ShowParticles:0b}],PortalCooldown:3000}
