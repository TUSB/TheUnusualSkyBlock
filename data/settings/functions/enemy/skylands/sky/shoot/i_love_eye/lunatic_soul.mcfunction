...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s夢中にしてあげるー！","with":[{"translate":"【能力：格闘・移動・コール】","color":"#00FF00"}]}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Parabolic",MotionTick:120,MotionGravity:0.01d,Settings:[{Name:"At",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true}}]}],Tick:[{Name:"Function",Tags:[Skylands,Sky,Shoot,ILoveEye,LunaticSoulTick]}]}
#Function
