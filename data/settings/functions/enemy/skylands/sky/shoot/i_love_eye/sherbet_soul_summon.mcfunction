...
# レベルを設定
    ...
    data modify storage mob_data: Call.SpawnEntities set value [[{Tags:[Global,Sky,Shoot,SherbetEye,Main,SpawnParticles],Level:45}],[{Tags:[Global,Sky,Shoot,SherbetEye,DryMarker],Level:45},{Tags:[Global,Sky,Shoot,SherbetEye,TurretMarker],Level:45}]]
