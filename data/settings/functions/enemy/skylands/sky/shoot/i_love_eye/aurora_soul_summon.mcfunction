...
# レベルを設定
    ...
    data modify storage mob_data: Call.SpawnEntities set value [[{Tags:[Global,Sky,Shoot,AuroraEye,Main,SpawnParticles],Level:50}],[{Tags:[Global,Sky,Shoot,AuroraEye,ShardMarker],Level:50}]]
