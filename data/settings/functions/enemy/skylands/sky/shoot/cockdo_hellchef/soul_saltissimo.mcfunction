...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {Item:{id:"minecraft:firework_star",Count:1b,tag:{CustomModelData:10072,Explosion:{Type:0b,Colors:[I;116777215]}}}}
### 遅延ステータス
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:0.3d}],Attack:[{Name:"Damage",Player:{Damage:1d},Distance:{Max:1d},AEC:{Effects:[{Id:14b,Amplifier:10b,Duration:5}]}}],Tick:[{Name:"Function",Tags:[Skylands,Sky,Shoot,CockdoHellchef,ParticleAndSound]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:40,Max:40,Current:40},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true},Anchor:"Eyes"},{Name:"Rotation",Direction:[-3f,-3f],DirectionRange:[6f,6f]}],Name:"Step",Speed:1.0d}],Once:1}]}]}
#Function
