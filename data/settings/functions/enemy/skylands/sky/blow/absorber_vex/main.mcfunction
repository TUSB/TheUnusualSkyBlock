...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Name:"Function",Tags:[Skylands,Sky,Blow,AbsorberVex,Grow]}],Attack:[{Name:"Damage",Player:{},MP:{MP:15}}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:100,Max:160,Current:100},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Global:true,Target:{Look:"Player",Radius:8d}}],Name:"Damage",Player:{},MP:{MP:10},Distance:{Max:5d}},{Name:"Function",Tags:[Skylands,Sky,Blow,AbsorberVex,Particle]}]}]}]}
