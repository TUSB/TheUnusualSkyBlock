### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",IsBaby:1b,CustomName:'{"translate":"スイカの兵隊","color":"#FFFFFF","bold":true}',ActiveEffects:[{Id:28,Amplifier:1b,Duration:-1,ShowParticles:0b}],PersistenceRequired:1b,PortalCooldown:6000,Tags:[Mob,Enemy,DelayedData,CallOnAttack,TickingRequired]}
