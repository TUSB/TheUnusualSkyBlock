### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:vex",CustomName:'{"translate":"スイカの妖精","color":"#FFFFFF","bold":true}',PersistenceRequired:1b,PortalCooldown:6000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,CallOnAttack,CooldownRequired,HasLootTable]}
