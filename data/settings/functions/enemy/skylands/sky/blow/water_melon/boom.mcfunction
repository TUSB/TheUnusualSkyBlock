### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:item",CustomName:'{"translate":"きらめくスイカ","color":"#FFFFFF","bold":true}',PickupDelay:32767,Age:0,PortalCooldown:1200,Tags:[DelayedData,HasAI,CallOnAttack,CooldownRequired,DamageProjectile,EnemyProjectile]}
