### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:husk",CustomName:'{"translate":"終熄の誘手","color":"#FF0000"}',IsBaby:true,PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,TickingRequired,NativeTask,SmartMotion,Bounce,DamageProjectile,EnemyProjectile]}
