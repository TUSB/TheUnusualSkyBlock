### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:ghast",CustomName:'{"translate":"ガストキャリアー","color":"#FF0000","bold":true}',ExplosionPower:0b,PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnTick,TickingRequired]}
