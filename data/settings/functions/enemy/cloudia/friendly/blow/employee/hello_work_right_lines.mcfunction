...
data modify storage mob_data: CCHelper.Insight.y_offset set value 1.35f
...
# 話し掛けたら
data modify storage mob_data: CCHelper.Interact.texts set value ["この角、実は柔らかいんですよ。\\n触りたいですか？"]
data modify storage mob_data: CCHelper.Interact.y_offset set value 1.35f
...
# 位置指定
execute positioned -1765 113 -136 if entity @s[distance=..1] run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].CCHelper set from storage mob_data: CCHelper
