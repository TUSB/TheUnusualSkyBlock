...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Item:{id:"minecraft:nether_star"},Count:16,Chance:0.3d},{Loot:"item:group/magic_stone/tier1_7/mystery",Count:1,Chance:1d}]
# AI
