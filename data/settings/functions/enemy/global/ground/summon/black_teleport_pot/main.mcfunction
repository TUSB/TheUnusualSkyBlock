...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s倒すことで半径16ブロック内に存在する敵を32m以内にいる遠くのプレイヤーに送り付けるフィールドを展開する黒い壺。視界内に補足した状態で攻撃を加えると闘争を図る。","with":[{"translate":"【能力：ワープ・反撃・引寄】","color":"#00FF00"}]}]'
# AI
