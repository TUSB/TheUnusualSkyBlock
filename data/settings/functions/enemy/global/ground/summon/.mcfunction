...
execute if entity @s[tag=SecurityCorePrototype] run function settings:enemy/global/ground/summon/security_core_prototype
execute if entity @s[tag=DecoyTeleportPot] run function settings:enemy/global/ground/summon/decoy_teleport_pot/
execute if entity @s[tag=ElusiveVase] run function settings:enemy/global/ground/summon/elusive_vase/
