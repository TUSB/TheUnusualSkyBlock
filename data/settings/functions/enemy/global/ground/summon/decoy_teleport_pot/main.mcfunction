...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/vanilla_item/tier_all/ender_pearl",Count:1,Chance:1d},{Loot:"item:group/magic_stone/tier1_4/mystery",Count:1,Chance:1d}]
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s敵味方の区別なく吸い込む壺。倒すかまたは時間経過で吸引が行われ、吸い込む範囲は半径16ブロックとそれなりに広い。","with":[{"translate":"【能力：終撃・引寄】","color":"#00FF00"}]}]'
# AI
