...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{Name:"Function",Tags:[Global,Event,Function,Common,RandomRotation]},{Name:"Function",Tags:[Global,Ground,Summon,DecoyTeleportPot,Teleport1]}]}],Exit:{Time:80,TimeCount:80}},{Index:2,Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{Name:"Function",Tags:[Global,Event,Function,Common,RandomRotation]},{Name:"Function",Tags:[Global,Ground,Summon,DecoyTeleportPot,Teleport1]},{Name:"Function",Tags:[Global,Ground,Summon,DecoyTeleportPot,Teleport2]}]}]}]}
#Function
# サウンド
