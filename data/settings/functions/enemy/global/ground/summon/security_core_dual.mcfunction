### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,DelayedData,CallOnTimeOut,CooldownRequired,HideLevel],CustomName:'{"translate":"Grumm","color":"#000000"}',IsBaby:true,Silent:true,ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticles:false},{Id:18b,Amplifier:127b,Duration:2147483647,ShowParticles:false},{Id:28b,Amplifier:127b,Duration:2147483647,ShowParticles:false}],PortalCooldown:400,DeathLootTable:"empty"}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Time:[{Condition:[{Name:"HasTarget",Global:true,Target:{Look:"Player",Radius:24d,IgnoreBlocks:false}}],Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Shoot,SecurityPoleDual,Body],Level:1}],[{Tags:[Global,Ground,Shoot,SecurityPoleDual,Main],Level:50}]],Count:1}]}
