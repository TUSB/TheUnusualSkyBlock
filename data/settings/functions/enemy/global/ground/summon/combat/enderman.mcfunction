...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"目を合わさずとも襲っちゃうぞ。"}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:5,Turn:[{Index:1,Skill:[{Interval:{Min:300,Max:600,Current:180},Loop:{Max:1,Current:1},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Exit:{Condition:[{Name:"MP",MP:23}]}},{Index:3,Skill:[{Call:[{Name:"MergeNBT",NBT:{carriedBlockState:{Name:"minecraft:tnt"}}},{Name:"Function",Tags:[Global,Event,Function,AttackSound,Equiping]}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:4,Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Friendly",Radius:4,IgnoreBlocks:false}}]}},{Index:5,Skill:[{Interval:{Min:60,Max:60,Current:60},Loop:{Max:1,Current:1},Call:[{Name:"Function",Tags:[Global,Event,Function,FakeTnt,Placed]},{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,FakeTnt,Body],Level:1}],[{Tags:[Global,Ground,Blow,FakeTnt,Display],Level:1}]],Settings:[{Name:"Rotation",Direction:[0f,0f],Absolute:{Vertical:true}}]},{Name:"MergeNBT",NBT:{carriedBlockState:{Name:"minecraft:air"}}}]}],Exit:{Loop:{Max:1,Current:1}}}]}
