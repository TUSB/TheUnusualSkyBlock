...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/drop_item/tier2/common",Item:{id:"minecraft:ender_pearl"},Count:1,Chance:0.35d}]
