...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:1d}],Attack:[{Name:"Damage",Player:{DamageType:[Global],DeathCause:'[{"translate":"%1$sは%2$sの汁が眼に入り錯乱と激痛を伴って自然の脅威を思い知ることとなった。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Distance:{Max:1d},AEC:{Particle:"dust 1 0.87451 0.4 1",Color:16768870,Duration:10,Radius:0.5f,Effects:[{Id:14,Amplifier:6b,Duration:5,ShowParticles:false}]}}]}
#Function
