### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:snowball",Tags:[DelayedData,CallOnInit,CallOnAttack,TickingRequired,DamageProjectile,EnemyProjectile,Unknown],CustomName:'{"translate":"怒れる金りんご弾","color":"#FF0000","bold":true}',NoGravity:true,PortalCooldown:120}
