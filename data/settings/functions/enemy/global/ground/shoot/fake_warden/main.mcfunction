...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:item/carrot_on_a_stick/weapon/super_debaria",Count:1,Chance:0.3d},{Loot:"item:group/drop_item/tier7/common",Count:1,Chance:0.3d},{Loot:"item:item/carrot_on_a_stick/secret_exp_bug_memory_star",Count:1,Chance:1d}]
