...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {Item:{id:"minecraft:firework_star",Count:1b,tag:{CustomModelData:126,Explosion:{Type:0}}}}
### 遅延ステータス
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"SmartMotion",TP:true,Start:true,Speed:{Set:30d},Gravity:{Set:0d}},{Name:"Function",Tags:[Global,Ground,Shoot,Shotzo,ParticleAndSound]}]}
