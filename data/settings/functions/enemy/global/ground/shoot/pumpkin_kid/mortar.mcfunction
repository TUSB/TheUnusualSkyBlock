...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Direction:[0f,-60f],Speed:1.0d,SpeedRange:2.0d,Target:{Look:"player",Radius:32d},Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:32d}}]}],Time:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Summon,StardustBomb,Aec],Level:1}]],Target:{Look:"player",Radius:32.0d},Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:32}}]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:4,Max:4,Current:30},Loop:{Max:10,Current:10},Call:[{Name:"Step",Direction:[0f,0f],Speed:1.0d,Target:{Look:"player",Radius:64d},Condition:[{Name:"HasTarget",Half:"down",Target:{Look:"player",Radius:64}}]}],Once:10}]}]}
#Function
