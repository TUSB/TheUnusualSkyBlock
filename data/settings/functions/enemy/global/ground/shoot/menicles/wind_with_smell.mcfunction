...
# 味方Mob
execute as @e[type=!player,predicate=entity:friendly,tag=!Enemy,distance=..64,tag=FriendlyProjectile,sort=nearest,limit=1] at @s run particle angry_villager ~ ~1 ~ 0 0 0 1 3 normal
