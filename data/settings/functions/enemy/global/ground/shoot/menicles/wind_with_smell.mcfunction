...
# 味方Mob
execute at @e[type=!player,predicate=entity:friendly,tag=!Enemy,distance=..64,tag=FriendlyProjectile,sort=nearest,limit=1] run particle angry_villager ~ ~0.5 ~ 0 0 0 1 1 normal
...
# 村人
execute at @e[type=villager,tag=WanderingVillager,distance=..64,sort=nearest,limit=1] run particle angry_villager ~ ~0.5 ~ 0 0 0 1 1 normal
...
# ゾンビ村人
execute at @e[type=zombie_villager,tag=Enemy,distance=..64,sort=nearest,limit=1] run particle angry_villager ~ ~0.5 ~ 0 0 0 1 1 normal
