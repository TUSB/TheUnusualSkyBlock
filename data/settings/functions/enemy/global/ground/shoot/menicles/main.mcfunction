### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Team:"Friendly",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,CallOnDamage,CallOnTick,TickingRequired,DamageProjectile,EnemyProjectile,FriendlyProjectile,AnalyseLog,"Garlic1","Unmoved"],CustomName:'{"translate":"メニクル","color":"#FF8000"}',Silent:true,IsBaby:true,DeathTime:19s,ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s「Stimulacris(スティミュラクリス：鋭い刺激を放つ者)」という別称がある。%2$sにフローラルな激痛が伴う刺激臭を放ち、同個体は出現できない性質を持つ。","with":[{"translate":"【能力：移動・格闘・自爆・引寄無効・味方逃走・村人逃走】","color":"#00FF00"},{"translate":"半径64ブロック","color":"#FF0000"}]}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]},{Name:"Function",Tags:[Global,Ground,Shoot,Menicles,WindWithSmell]},{Name:"Function",Tags:[Global,Event,Function,CommonExe,SetMp0]}],Damage:[{Name:"MergeNBT",NBT:{NoAI:false}},{Condition:[{Name:"CheckBlock",Inverse:true,Block:[Water,Lava,Air]}],Name:"Function",Tags:[Global,Event,Function,CommonExe,UpAlign1]},{Name:"Function",Tags:[Global,Event,Function,DamageSound,Light]},{Condition:[{Name:"MinMP",MP:1,Percent:true}],Name:"ChangeTurn",Set:3}],Tick:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,ReverseLinkingRotation]}],TurnCount:3,Turn:[{Index:1,Skill:[{Interval:{Min:3,Max:3,Current:3},Call:[{Condition:[{Name:"CheckNBT",Global:true,NBT:{OnGround:true}}],Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]},{Name:"MergeNBT",NBT:{NoAI:true}},{Name:"ChangeTurn",Set:2}]}]},{Index:2,Target:{Look:"Fixed",Rotation:"LeftDown"},Rotate:[10f,0f],Skill:[{Interval:{Min:300,Max:600,Current:600},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HP",Inverse:true,HP:15}],Name:"Kill"}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:3,Target:{Look:"Fixed",Rotation:"RightDown"},Rotate:[36f,0f],Skill:[{Interval:{Min:5,Max:20,Current:5},Loop:{Max:5,Current:5,Range:15},Call:[{Condition:[{Name:"HP",HP:15}],Name:"Function",Tags:[Global,Ground,Shoot,Menicles,WindWithSmell]},{Condition:[{Name:"CheckNBT",Global:true,NBT:{OnGround:true}}],Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]},{Name:"MergeNBT",NBT:{NoAI:true}}]}],Exit:{Loop:{Max:1,Current:1}}}],ProjectileDamage:{Lightning:150,Light:200}}
#Function
