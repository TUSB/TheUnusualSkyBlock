### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:armor_stand",CustomName:'{"translate":"アトミック・ホウン","color":"#FF0000","bold":true}',Silent:1b,Invulnerable:1b,ShowArms:0b,Invisible:1b,NoBasePlate:1b,DisabledSlots:4144959,PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnTick,TickingRequired,AnalyseLog]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"地形破壊する弾を飛ばすのは没になりました。"}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"Function",Tags:[Global,Ground,Shoot,AtomicShotzo,Init]}],TurnCount:1,Turn:[{Index:1}]}
