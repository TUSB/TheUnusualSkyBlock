...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:3,Turn:[{Index:1,Rotate:[0f,0f],Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:20,IgnoreBlocks:false}}]}},{Index:2,Target:{Look:"Player",Radius:20d},Rotate:[0f,0f],Skill:[{Interval:{Min:100,Max:100,Current:1},Call:[{Name:"DelayAction",Tags:[Casting,Cast,Normal]}]}],Exit:{Time:60,TimeCount:60}},{Index:3,Target:{Look:"Player",Radius:20d},Rotate:[3f,360f],Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:100,Current:100},Call:[{Name:"Laser",Loop:40,Laser:"Test"}]},{Interval:{Min:0,Max:0,Current:0},Loop:{Max:20,Current:20},Call:[{Name:"Laser",Loop:40,Laser:"Test"}]}],Exit:{Time:100,TimeCount:100}}]}
