...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:3,Turn:[{Index:1,Rotate:[0f,0f],Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:20,IgnoreBlocks:false}}]}},{Index:2,Target:{Look:"Player",Radius:20d},Rotate:[0f,0f],Skill:[{Interval:{Min:100,Max:100,Current:100},Loop:{Max:1,Current:1},Call:[{Name:"DelayAction",Tags:[Casting,Charge,Normal]}]}],Exit:{Time:200,TimeCount:200}},{Index:3,Target:{Look:"Player",Radius:20d},Rotate:[3f,10f],Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:100,Current:100},Call:[{Name:"Laser",Loop:40,Laser:"SecurityLaser",Type:"Single"}]}],Exit:{Time:100,TimeCount:100}}]}
