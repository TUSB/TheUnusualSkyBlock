### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:stray",CustomName:'{"translate":"コンバットストレイ"}',PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,CallOnAttack,TickingRequired,HasLootTable,AnalyseLog]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Name:"Damage",Player:{Damage:0d},Distance:{Max:0d},AEC:{Effects:[{Id:14,Amplifier:4b,Duration:5,ShowParticles:false}]},Condition:[{Name:"RandomChance",Chance:0.1d}]}]}
