...
data modify storage tusb_mob: "遅延ステータス"."ステータス".DeathCause set value '[{"translate":"親切な%2$sが%1$sの体内に直接新鮮なカルシウムを接種させた。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'
# AI
