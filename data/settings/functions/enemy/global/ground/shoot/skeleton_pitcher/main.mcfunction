### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",CustomName:'{"translate":"スケルトンピッチャー","color":"#FFFFFF"}',PortalCooldown:2000,Tags:[Mob,Enemy,DelayedData,HasAI,CooldownRequired,HasLootTable]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/currency_and_magic_stone/tier1/mix",Chance:0.3d},{Item:{id:"minecraft:bone"},Count:6,Chance:1d}]
# AI
