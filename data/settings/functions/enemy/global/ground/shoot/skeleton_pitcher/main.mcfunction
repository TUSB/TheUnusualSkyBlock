...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:2,Max:60,Current:40},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:24d}}],Name:"MergeNBT",NBT:{HandItems:[{id:"minecraft:firework_star",Count:1b,tag:{CustomModelData:129,Explosion:{Type:0,Colors:[I;16777215]}}},{}]}}]},{Interval:{Min:25,Max:25,Current:25},Call:[{Condition:[{Name:"HasTarget",Global:true,Target:{Look:"Player",Radius:24d}}],Name:"MergeNBT",NBT:{HandItems:[]}},{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"Anchor",Anchor:"Eyes"},{Name:"Direction",Speed:1d}],Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Shoot,SkeletonPitcher,Bullet],Level:1}]]}]}]}]}
