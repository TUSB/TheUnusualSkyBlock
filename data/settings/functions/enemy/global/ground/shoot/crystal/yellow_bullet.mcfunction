...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:0.6d}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:5,Max:15,Current:5},Call:[{Condition:[{Name:"RandomChance",Chance:0.5d,Global:1b}],Name:"Function",Tags:[Global,Event,Function,MorionToRotation]},{Settings:[{Name:"Rotation",Target:{Look:"Self"}}],Name:"Step",Direction:[-15f,-15f],DirectionRange:[30f,30f],Speed:0.6d}]}]}]}
