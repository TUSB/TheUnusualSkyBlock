### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:snowball",CustomName:'{"translate":"イエロークリスタルバレッド","color":"#FF0000"}',NoGravity:1b,PortalCooldown:60,Tags:[DelayedData,HasAI,CallOnInit,TickingRequired,DamageProjectile,EnemyProjectile]}
