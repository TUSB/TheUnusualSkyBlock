### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Silent:1b,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,NativeTask,SmartMotion,Bounce]}
