...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"minecraft:flint",Count:1b,tag:{CustomModelData:3}}],ActiveEffects:[{Id:14,Amplifier:0b,Duration:-1,ShowParticles:0b}]}
