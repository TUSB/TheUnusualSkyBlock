### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,Enemy,DelayedData,HasAI,TickingRequired,HasLootTable,AnalyseLog,"Unmoved"],CustomName:'{"translate":"セキュリティポール・デュアル","color":"#FF0000","bold":true}',DeathTime:19s,NoAI:true,Silent:true,ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:false},{Id:18,Amplifier:127b,Duration:-1,ShowParticles:false},{Id:28,Amplifier:127b,Duration:-1,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:6,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:10,Current:10},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:30,IgnoreBlocks:false}}],Name:"ChangeTurn",Loop:1}]}]},{Index:2,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Set:6},{Name:"ChangeTurn",Set:3,Condition:[{Name:"MinMP",MP:17}]},{Name:"ChangeTurn",Set:5,Condition:[{Name:"MinMP",MP:31},{Name:"RandomChance",Chance:0.2d}]},{Name:"ChangeTurn",Set:3,Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:10,IgnoreBlocks:true}},{Name:"MinMP",MP:17}]}]}]},{Index:3,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"DelayAction",Tags:[Casting,Charge,Normal]}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:4,Target:{Look:"Friendly",Radius:20d,IgnoreBlocks:1b},Rotate:[3f,10f],Skill:[{Interval:{Min:80,Max:80,Current:80},Call:[{}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:40,Current:40},Call:[{Name:"Function",Tags:[Global,Event,Function,AttackSound,FiringLaser]},{Name:"Laser",Loop:40,Laser:"SecurityLaser",Type:"Dual"}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Set:1}],MP:17}]},{Index:5,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"DelayAction",Tags:[Casting,Cast,Normal]}]},{Interval:{Min:40,Max:40,Current:40},Loop:{Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Sky,Shoot,SecurityPoleDual,Child],Level:1}]],IsChild:true,Settings:[{Name:"Direction",Target:{Look:"Self"},DirectionRange:[0f,360f],Absolute:{Horizontal:true},Speed:2d,SpeedRange:2d}]}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Set:1}],MP:31}]},{Index:6,Target:{Look:"Fixed",Rotation:"RightDown"},Rotate:[0f,3f],Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{}]},{Interval:{Min:40,Max:40,Current:40},Loop:{Max:1,Current:1},Call:[{Name:"Function",Tags:[Global,Event,Function,SecurityPole,RunoutEnergy]}]},{Interval:{Min:60,Max:60,Current:60},Loop:{Max:1,Current:1},Call:[{Name:"Kill"}]}]}]}
