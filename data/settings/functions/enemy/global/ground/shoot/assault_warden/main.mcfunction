...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s君は目覚めさせてしまった……。そう眠りを妨げてしまったのだ、その軽やかな足音で……。","color":"#FF0000","with":[{"translate":"【能力：不明】","color":"#00FF00"}]}]'
# AI
