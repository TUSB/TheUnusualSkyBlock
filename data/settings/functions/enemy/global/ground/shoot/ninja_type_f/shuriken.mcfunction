### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:snowball",CustomName:'{"translate":"カトン・スリケン","color":"#FF0000"}',NoGravity:true,Tags:[DelayedData,CallOnInit,DamageProjectile,EnemyProjectile]}
