### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:horse",CustomNameVisible:true,CustomName:'{"translate":"魔術師の従者の騎乗馬","color":"#FFFFFF"}',Variant:4,Tame:1b,PortalCooldown:2000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CooldownRequired]}
