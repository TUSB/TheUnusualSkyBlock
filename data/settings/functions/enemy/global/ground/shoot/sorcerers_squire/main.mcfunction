### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:drowned",CustomNameVisible:true,CustomName:'{"translate":"魔術師の従者","color":"#FFFFFF"}',Silent:true,ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2000000}],DeathLootTable:"empty",Tags:[Mob,DelayedData,HasLootTable]}
