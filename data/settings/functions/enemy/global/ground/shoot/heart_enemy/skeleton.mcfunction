### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",CustomName:'{"translate":"ハートスケルトン"}',PortalCooldown:2000,Tags:[Mob,Enemy,DelayedData,CallOnDeath,CooldownRequired,HasLootTable]}
