### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:armor_stand",Silent:1b,Invulnerable:1b,Small:1b,NoGravity:1b,Marker:1b,Invisible:1b,PortalCooldown:70,DeathLootTable:"empty",Tags:[DelayedData,HasAI,CallOnInit,CooldownRequired]}
