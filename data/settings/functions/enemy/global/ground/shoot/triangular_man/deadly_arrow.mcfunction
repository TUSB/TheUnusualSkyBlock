...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Direction:[0f,-6f],Speed:1.8d,Target:{Look:"Player",Radius:24d,IgnoreBlocks:true}}],Death:[{Name:"Damage",Explosion:3}]}
