...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:24d,IgnoreBlocks:true}}],Name:"Step",Direction:[0f,-6f],Speed:1.8d}],Death:[{Name:"Damage",Player:{DamageType:[Blast],DeathCause:'[{"translate":"%1$sは三角様の%2$sによって爆散した。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName"}]}]'},Distance:{Max:2d},Explosion:-1}]}
