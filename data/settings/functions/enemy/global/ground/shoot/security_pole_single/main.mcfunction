...
data modify storage tusb_mob: "遅延ステータス"."ステータス"."物理攻撃力" set value 105
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:4,Turn:[{Index:1,Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:20,IgnoreBlocks:false}}]}},{Index:2,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"DelayAction",Tags:[Casting,Charge,Normal]}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:3,Target:{Look:"Player",Radius:20d,IgnoreBlocks:1b},Rotate:[3f,10f],Skill:[{Interval:{Min:100,Max:100,Current:100},Loop:{Max:1,Current:1},Call:[{}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:100,Current:100},Call:[{Name:"Function",Tags:[Global,Event,Function,AttackSound,FiringLaser]},{Name:"Laser",Loop:40,Laser:"SecurityLaser",Type:"Single"}]},{Interval:{Min:20,Max:20,Current:20},Loop:{Max:1,Current:1},Call:[{}],MP:17}],Exit:{Loop:{Max:3,Current:3}}},{Index:4,Target:{Look:"Fixed",Rotation:"RightDown"},Rotate:[0f,3f],Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{}]},{Interval:{Min:40,Max:40,Current:40},Loop:{Max:1,Current:1},Call:[{Name:"Function",Tags:[Global,Event,Function,SecurityPole,RunoutEnergy]}]},{Interval:{Min:60,Max:60,Current:60},Loop:{Max:1,Current:1},Call:[{Name:"Kill"}]}],Exit:{Condition:[{Name:"MinMP",MP:17}]}}]}
