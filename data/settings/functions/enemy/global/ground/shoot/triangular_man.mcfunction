...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Execute:"Random",Name:"Step",Direction:[-90f,0f],DirectionRange:[-180f,15f],Speed:0.2d,SpeedRange:1.2d,Target:{Look:"player",Radius:16},Condition:{Name:"HasTarget",Target:{Look:"player",Radius:12}}},{Name:"ChangeTurn",Random:true}],Turn:[{Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoAI:false,NoGravity:false}}]}],Exit:{Time:60}},{Skill:[{Interval:{Min:7,Max:7,Current:7},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoAI:true}}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:50,Current:50},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Shoot,EnemyBullet,ArrowRain],Level:1}]]}]},{Interval:{Min:7,Max:7,Current:1},Loop:{Max:3,Current:3},Call:[{Name:"ChangeTurn",Loop:3}]}],Exit:{Time:60}},{Skill:[{Interval:{Min:7,Max:7,Current:7},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoAI:true}}]},{Interval:{Min:7,Max:7,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Loop:2}]}],Exit:{Time:60}},{Skill:[{Interval:{Min:7,Max:7,Current:7},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoAI:true}}]},{Interval:{Min:3,Max:3,Current:1},Loop:{Max:3,Current:3},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Shoot,EnemyBullet,DeadlyArrow],Level:1}]]}]},{Interval:{Min:7,Max:7,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Loop:1}]}],Exit:{Time:60}}]}
