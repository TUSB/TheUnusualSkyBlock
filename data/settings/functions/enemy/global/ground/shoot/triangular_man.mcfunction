...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Execute:"Random",Name:"Step",Direction:[-90f,0f],DirectionRange:[-180f,15f],Speed:0.2d,SpeedRange:1.2d,Target:{Look:"player",Radius:16},Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:12}}]},{Name:"ChangeTurn",Random:true}],Turn:[{Skill:[{Interval:{Min:100,Max:100,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoAI:false}}]}],Exit:{Time:200,TimeCount:200}},{Skill:[{Interval:{Min:7,Max:7,Current:7},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoAI:true}}]},{Interval:{Min:2,Max:2,Current:2},Loop:{Max:50,Current:50},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Shoot,EnemyBullet,ArrowRain],Level:1}]],Target:{Look:"player",Radius:16.0d,IgnoreBlocks:true},Speed:0.2d,Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:16}}]}]},{Interval:{Min:7,Max:7,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Loop:3}]}],Exit:{Time:200,TimeCount:200}},{Skill:[{Interval:{Min:7,Max:7,Current:7},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoAI:true}}]},{Interval:{Min:7,Max:7,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Loop:1}]}],Exit:{Time:200,TimeCount:200}},{Skill:[{Interval:{Min:7,Max:7,Current:7},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoAI:true}}]},{Interval:{Min:20,Max:20,Current:1},Loop:{Max:3,Current:3},Call:[{Name:"Spawn",Direction:[0f,-90f],Absolute:{Vertical:true},Speed:1.52d,SpawnEntities:[[{Tags:[Global,Event,Shoot,EnemyBullet,DeadlyArrow],Level:1}]],Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:16.0d,IgnoreBlocks:true}}]}]},{Interval:{Min:7,Max:7,Current:1},Loop:{Max:1,Current:1},Call:[{}]}],Exit:{Time:200,TimeCount:200}}]}
