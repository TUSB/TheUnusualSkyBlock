### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:endermite",CustomName:'{"translate":"ファイアークロウ","color":"#FF0000","bold":true}',Silent:1b,ActiveEffects:[{Id:12,Amplifier:1b,Duration:-1,ShowParticles:0b},{Id:14,Amplifier:127b,Duration:-1,ShowParticles:0b}],PlayerSpawned:0b,PortalCooldown:200,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CooldownRequired,DamageProjectile,EnemyProjectile]}
