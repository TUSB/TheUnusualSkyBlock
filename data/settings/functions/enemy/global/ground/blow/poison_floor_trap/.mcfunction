...
execute if entity @s[tag=Stabbing1] run function settings:enemy/global/ground/blow/poison_floor_trap/stabbing1
execute if entity @s[tag=OperatingNoise] run function settings:enemy/global/ground/blow/poison_floor_trap/operating_noise
