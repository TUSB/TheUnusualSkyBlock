...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"取扱注意！ 負傷が爆発のスイッチだ！ 残った矢に触れると彼方に消し飛ぶぞ！！"}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,SetMp0]}],Death:[{Name:"Spawn",Count:15,CountRange:15,SpawnEntities:[[{Tags:[Global,Ground,Blow,Volcareeper,VolcanicBlast],Level:1}]]}],Time:[{Name:"ChangeAI",Death:[{}]}],Damage:[{Name:"Kill"}],Tick:[{Condition:[{Name:"CheckNBT",NBT:{HasVisualFire:false}}],Name:"Kill"},{Name:"Function",Tags:[Global,Ground,Blow,Volcareeper,ParticleAndSound1]}]}
