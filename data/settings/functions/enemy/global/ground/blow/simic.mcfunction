...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Blink",Count:5,Chance:1d,TriggerOn:[Physical]}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:40,Max:120,Current:30},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:2,Max:4,Current:2},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:16d}}],Settings:[{Name:"Facing",Target:{Look:"Player",Radius:24d,IgnoreBlocks:true}},{Name:"Rotation",Flip:true}],Name:"Step",Speed:1d,SpeedRange:0.5d}]},{Interval:{Min:10,Max:15,Current:10},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:16d}}],Settings:[{Name:"Facing",Target:{Look:"Player",Radius:24d,IgnoreBlocks:true}},{Name:"Rotation",Direction:[-10f,-35f],DirectionRange:[20f,5f]}],Name:"Step",Speed:1.5d,SpeedRange:0.5d}]}],Exit:{Loop:{Max:2,Current:2}}}]}
