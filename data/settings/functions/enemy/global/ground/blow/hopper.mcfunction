...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Skill:[{Interval:{Min:5,Max:20,Current:30},Call:[{Name:"Step",Direction:[0f,-10f],Speed:1.2d},{Name:"Step",Direction:[70f,-20f],Speed:0.6d},{Name:"Step",Direction:[-70f,-20f],Speed:0.6d}]}]}]}
