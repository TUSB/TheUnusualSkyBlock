### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,HasAI,CallOnDeath],CustomName:'{"translate":"デイドラ","color":"#FF0000","bold":true}',ActiveEffects:[{Amplifier:10b,Duration:2147483647,Id:8b,ShowParticles:0b},{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticle:0b}]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Death:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Other,Blow,FinalAttack,FinalAttackPotion01],Level:1}]]}],Turn:[{Target:{Look:"player",Radius:24d,Block:true},Skill:[{Interval:{Min:15,Max:60,Current:1},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Target:{Look:"player",Radius:24d,Block:true},Skill:[{Interval:{Min:5,Max:5,Current:5},Call:[{Name:"Step",Direction:[90f,-5f],Speed:1.0d},{Name:"Step",Direction:[-90f,-5f],Speed:1.0d}]}],Exit:{Loop:{Max:1,Current:1}}},{Target:{Look:"player",Radius:24d,Block:false},Skill:[{Interval:{Min:30,Max:30,Current:30},Loop:{Max:3,Current:3},Call:[{Name:"Step",Direction:[0f,0f],Speed:5.0d}]},{Interval:{Min:5,Max:5,Current:5},Call:[{Name:"Step",Direction:[0f,-80f],Speed:2.0d}]},{Interval:{Min:7,Max:7,Current:7},Call:[{Name:"Step",Direction:[0f,0f],Speed:5.0d}]}],Exit:{Loop:{Max:3,Current:3}}}]}
