### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie_villager",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDeath,CallOnInit,CallOnAttack,TickingRequired,DamageProjectile,EnemyProjectile,HasLootTable,AnalyseLog,"NonBurst"],Team:"None",CustomName:'{"translate":"ヒツジンさん","color":"#FFFFFF"}',IsBaby:true,Silent:true,PortalCooldown:3000}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$sこの世界において最弱の敵。チュートリアルは済んだか？ヒューマン。","with":[{"translate":"【能力：格闘・射的・ノンバースト】","color":"#00FF00"}]}]'
# AI
