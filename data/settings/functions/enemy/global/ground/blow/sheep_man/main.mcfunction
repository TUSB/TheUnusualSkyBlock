### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie_villager",CustomName:'{"translate":"ヒツジンさん","color":"#FFFFFF"}',IsBaby:true,Silent:true,Team:"Null",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDeath,CallOnInit,CallOnAttack,TickingRequired,DamageProjectile,EnemyProjectile,HasLootTable,AnalyseLog,NonBurst],PortalCooldown:3000}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:24d,IgnoreBlocks:true}}],Name:"Step",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:1.2d}],Death:[{Name:"Function",Tags:[Global,Ground,Blow,SheepMan,DeathSound]}],Attack:[{Name:"Function",Tags:[Global,Ground,Blow,SheepMan,DamageSound]}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:5,Max:15,Current:15},Call:[{Condition:[{Global:1b,Name:"HasTarget",Target:{Look:"Friendly",Radius:24d}},{Name:"MinMP",MP:1}],Name:"MergeNBT",NBT:{HandItems:[{id:"minecraft:white_wool",Count:1b},{}]}}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:5,Max:10,Current:5},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"Anchor",Anchor:"Eyes"},{Name:"Direction",Speed:1d},{Name:"Rotation",Direction:[-2f,-2f],DirectionRange:[4f,4f]}],Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,SheepMan,Bullet],Level:1}]]}],MP:1},{Interval:{Min:3,Max:3,Current:3},Loop:{Max:3,Current:3,Range:12},Call:[{Condition:[{Name:"MP",MP:1},{Name:"MinLv",Level:100}],Settings:[{Name:"Anchor",Anchor:"Eyes"},{Name:"Direction",Speed:1d},{Name:"Rotation",Direction:[-5f,-5f],DirectionRange:[10f,10f]}],Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,SheepMan,Bullet],Level:1}]]}]},{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{HandItems:[]}},{Name:"ChangeTurn",Loop:1}]}]}]}
