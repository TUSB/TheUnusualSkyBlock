### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",CustomName:'{"translate":"カトン・ニンジャ","color":"#FFFFFF"}',ActiveEffects:[{Id:8b,Amplifier:2b,Duration:2147483647,ShowParticles:0b}],Tags:[Mob,DelayedData,DelayedData]}
