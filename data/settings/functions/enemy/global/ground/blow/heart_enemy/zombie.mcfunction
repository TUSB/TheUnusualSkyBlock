### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"ハートゾンビ"}',Tags:[Mob,Enemy,DelayedData,CallOnDeath,HasLootTable]}
