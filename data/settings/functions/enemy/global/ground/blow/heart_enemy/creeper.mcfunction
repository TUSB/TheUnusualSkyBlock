### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:creeper",CustomName:'{"translate":"ハートクリーパー"}',Fuse:40s,Tags:[Mob,Enemy,DelayedData,CallOnDeath,HasLootTable]}
