### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:creeper",CustomName:'{"translate":"アマノジャクリーパー","color":"#FFFFFF"}',Fuse:200,ExplosionRadius:0f,Glowing:true,Tags:[Mob,DelayedData,CallOnDamage]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Settings:[{Name:"At",Target:{Look:"Player",Radius:8}},{Name:"Direction",Direction:[-180f,0f],Speed:2d}],Name:"Teleport"},{Name:"MergeNBT",NBT:{ExplosionRadius:5b,Fuse:0s,ignited:true}}]}
