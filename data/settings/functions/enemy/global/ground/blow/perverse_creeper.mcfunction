...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Name:"Teleport",Direction:[-180f,0f],Target:{Look:"Player",Radius:8},Speed:2d},{Name:"MergeNBT",NBT:{ExplosionRadius:5b,Fuse:0s,ignited:true}}]}
