### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:silverfish",CustomName:'{"translate":"無視","color":"#FFFFFF"}',Tags:[Mob,Enemy,DelayedData,HasLootTable]}
