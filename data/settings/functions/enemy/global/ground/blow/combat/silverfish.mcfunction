### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:silverfish",CustomName:'{"translate":"コンバットシルバーフィッシュ"}',PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,TickingRequired]}
