### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:witch",DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CallOnAttack]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Name:"Damage",Player:{DamageType:["Global"],BypassArmor:true},Distance:{Max:0d}}]}
