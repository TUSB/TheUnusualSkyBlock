...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Name:"Damage",Player:{DamageType:["Global","Blast"],DeathCause:'[{"translate":"%%sは%%sに爆破された。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Distance:{Max:0d},AEC:{Effects:[{Id:14b,Amplifier:9b,Duration:5,ShowParticles:false}]}}]}
