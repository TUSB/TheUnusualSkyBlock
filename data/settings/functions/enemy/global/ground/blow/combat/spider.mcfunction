### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:spider",CustomName:'{"translate":"コンバットスパイダー"}',PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CallOnAttack,CooldownRequired,HasLootTable]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Name:"Damage",Player:{Damage:0d},Distance:{Max:0d},AEC:{Effects:[{Id:14b,Amplifier:5b,Duration:5,ShowParticles:false}]},Condition:[{Name:"RandomChance",Chance:0.04d}]}]}
