### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:spider",CustomName:'{"translate":"コンバットスパイダー"}',DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CallOnAttack]}
