...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"ChangeStatus",Defense:{Limit:250},SpecialDefense:{Limit:250}}],Damage:[{Name:"ChangeStatus",Defense:{Add:4},SpecialDefense:{Add:4}}],TurnCount:7,Turn:[{Index:1,Exit:{Time:200,TimeCount:200}},{Index:2,Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:20,IgnoreBlocks:true}}]}},{Index:3,Skill:[{Call:[{Name:"MergeNBT",NBT:{Attributes:[{Name:generic.movement_speed,Base:0d}]}},{Name:"ChangeStatus",Defense:{Add:1000,Limit:1500},SpecialDefense:{Add:1000,Limit:1500}}]},{Interval:{Min:3,Max:5,Current:3},Loop:{Max:8,Current:8},Call:[{Name:"Function",Tags:[Global,Ground,Function,Combat,ZombieMutation1-2]}]},{Call:[{Name:"Function",Tags:[Global,Ground,Function,Combat,ZombieMutation1-1]},{Name:"ChangeAI",Damage:[{Name:"ChangeStatus",Defense:{Add:4},SpecialDefense:{Add:4}},{Name:"Heal",Range:0,Multiplier:1d,Condition:[{Name:"RandomChance",Chance:0.09d},{Name:"MP",MP:13}]}],Tick:[{Name:"Function",Tags:[Global,Ground,Function,Combat,ZombieAura1]}]},{Name:"ChangeStatus",Attack:{Add:30},Defense:{Add:20},SpecialDefense:{Add:20}},{Name:"MergeNBT",NBT:{Attributes:[{Name:generic.movement_speed,Base:0.28d},{Name:generic.knockback_resistance,Base:0.3d}]}},{Name:"ChangeStatus",Defense:{Add:-1000,Limit:250},SpecialDefense:{Add:-1000,Limit:250}}]}],Exit:{Loop:{Max:3,Current:3}}},{Index:4,Exit:{Time:200,TimeCount:200}},{Index:5,Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:20,IgnoreBlocks:true}}]}},{Index:6,Skill:[{Call:[{Name:"MergeNBT",NBT:{Attributes:[{Name:generic.movement_speed,Base:0d}]}},{Name:"ChangeStatus",Defense:{Add:1000,Limit:1500},SpecialDefense:{Add:1000,Limit:1500}}]},{Interval:{Min:3,Max:5,Current:3},Loop:{Max:8,Current:8},Call:[{Name:"Function",Tags:[Global,Ground,Function,Combat,ZombieMutation2-2]}]},{Call:[{Name:"Function",Tags:[Global,Ground,Function,Combat,ZombieMutation2-1]},{Name:"ChangeAI",Damage:[{Name:"ChangeStatus",Defense:{Add:4},SpecialDefense:{Add:4}},{Name:"Heal",Range:0,Multiplier:1d,Condition:[{Name:"RandomChance",Chance:0.09d},{Name:"MP",MP:13}]},{Name:"ChangeTurn",Set:8}],Tick:[{Name:"Function",Tags:[Global,Ground,Function,Combat,ZombieAura2]}]},{Name:"ChangeStatus",Attack:{Add:32},HP:{Add:41},Defense:{Add:39},SpecialDefense:{Add:39}},{Name:"MergeNBT",NBT:{Attributes:[{Name:generic.movement_speed,Base:0.34d},{Name:generic.knockback_resistance,Base:1d}]}},{Name:"ChangeStatus",Defense:{Add:-1000,Limit:250},SpecialDefense:{Add:-1000,Limit:250}}]}],Exit:{Loop:{Max:3,Current:3}}},{Index:7}]}
