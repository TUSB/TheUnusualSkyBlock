### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CallOnDamage,TickingRequired]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Settings:[{Name:"Direction",Direction:[0f,0f],DirectionRange:[360f,0f],Speed:4d,SpeedRange:8d,Absolute:{Horizontal:true}}],Name:"Spawn",Count:2,CountRange:3,SpawnEntities:[[{Tags:[Global,Ground,Blow,Combat,Skeleton],Level:8}]],Condition:[{Name:"HasTarget",Target:{Look:"Enemy",Radius:32d}},{Name:"RandomChance",Chance:0.1d}]}]}
