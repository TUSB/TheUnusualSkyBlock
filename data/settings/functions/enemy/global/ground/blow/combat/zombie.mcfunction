### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,CallOnInit,TickingRequired]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,Combat,ZombieBaby],Level:1}]]}]}
