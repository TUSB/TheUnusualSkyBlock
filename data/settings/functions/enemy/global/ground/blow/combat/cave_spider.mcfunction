### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:cave_spider",CustomName:'{"translate":"コンバットケイブスパイダー"}',DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CallOnAttack,HasLootTable]}
