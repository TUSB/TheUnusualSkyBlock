...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Name:"Damage",Player:{Damage:0d},Distance:{Max:0d},AEC:{Effects:[{Id:14,Amplifier:8b,Duration:5,ShowParticles:false}]},Condition:[{Name:"RandomChance",Chance:0.04d}]}]}
