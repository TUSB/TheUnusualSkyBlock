### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:vindicator",CustomName:'{"translate":"コンバットヴィンディケーター"}',DeathLootTable:"empty",Tags:[Mob,DelayedData,CallOnInit]}
