### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:magma_cube",CustomName:'{"translate":"コンバットマグマキューブ"}',Size:1,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,CallOnDeath,CallOnTimeOut,TickingRequired,HasLootTable]}
