### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:magma_cube",Tags:[Mob,Enemy,DelayedData,CallOnDeath,CallOnTimeOut,TickingRequired,HasLootTable,NoLootTableAdd],CustomName:'{"translate":"コンバットマグマキューブ"}',Size:7,PortalCooldown:3000}
