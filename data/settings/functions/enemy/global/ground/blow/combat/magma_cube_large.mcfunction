### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:magma_cube",CustomName:'{"translate":"コンバットマグマキューブ"}',Size:3,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CallOnDeath,HasLootTable]}
