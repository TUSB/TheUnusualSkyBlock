### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:slime",Tags:[Mob,Enemy,DelayedData,CallOnDeath,CallOnTimeOut,TickingRequired,HasLootTable,NoLootTableAdd],CustomName:'{"translate":"コンバットスライム"}',Size:3,PortalCooldown:3000}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Death:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,Combat,SlimeLittle],Level:1}]],Count:1,CountRange:2}],Time:[{Name:"ChangeAI",Death:[{}]}]}
