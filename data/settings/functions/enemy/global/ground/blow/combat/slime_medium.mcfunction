### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:slime",CustomName:'{"translate":"コンバットスライム"}',Size:3,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,CallOnDeath,CallOnTimeOut,TickingRequired,HasLootTable]}
