...
execute if entity @s[tag=SpawnerVase] run function settings:enemy/global/ground/blow/spawner_vase/
...
execute if entity @s[tag=ElusiveVase] run function settings:enemy/global/ground/blow/elusive_vase/
