...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Target:{Look:"player",Radius:12d,Block:false},Move:{Front:1d,Side:0d,Rotate:{Horizontal:5d,Vertical:5d}}}]}
