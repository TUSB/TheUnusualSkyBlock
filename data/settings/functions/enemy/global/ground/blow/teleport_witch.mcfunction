### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:witch",Tags:[Mob,DelayedData,HasAI]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:50,Max:200,Current:50},Call:[{Settings:[{Name:"At",Target:{Look:"Player",Radius:24,IgnoreBlocks:1b}},{Name:"Direction",Direction:[-60f,0f],DirectionRange:[120f,0f],Speed:3d,SpeedRange:3d}],Name:"Teleport"},{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Other,Blow,RootAec,SpawnParticles],Level:1}]]}]}]}]}
