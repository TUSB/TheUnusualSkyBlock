### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Silent:1b,IsBaby:1b,ActiveEffects:[{Id:14,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],PortalCooldown:5,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CallOnInit,CallOnTimeOut,CooldownRequired]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Damage",Player:{Damage:28d,DeathCause:'[{"translate":"%1$sは%2$sの地鳴りによって転ばせられ頭部の陥没により絶命した。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Distance:{Min:0,Max:1}}],Time:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,DropZombie,Rumble2],Level:1}]],Count:1}]}
#Function
playsound block.composter.fill hostile @a[distance=..20] ~ ~ ~ 0.7 1.5 0
particle block stone ^0 ^ ^-1 0 0 0 0 1 force
particle block stone ^0.58779 ^ ^-0.80902 0 0 0 0 1 force
particle block stone ^0.95106 ^ ^-0.30902 0 0 0 0 1 force
particle block stone ^0.95106 ^ ^0.30902 0 0 0 0 1 force
particle block stone ^0.58779 ^ ^0.80902 0 0 0 0 1 force
particle block stone ^0 ^ ^1 0 0 0 0 1 force
particle block stone ^-0.58779 ^ ^0.80902 0 0 0 0 1 force
