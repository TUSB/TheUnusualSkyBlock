### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Silent:1b,IsBaby:1b,ActiveEffects:[{Id:14b,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],PortalCooldown:5,DeathLootTable:"empty",Tags:[Mob,DelayedData,CallOnInit,CallOnTimeOut,CooldownRequired]}
...
particle block stone ^1.84062 ^ ^-4.64888 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^2.40877 ^ ^-4.38153 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^2.93893 ^ ^-4.04508 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^3.42274 ^ ^-3.64484 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^3.85257 ^ ^-3.18712 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.22164 ^ ^-2.67913 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.52414 ^ ^-2.1289 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.75528 ^ ^-1.54508 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.91144 ^ ^-0.93691 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.99013 ^ ^-0.31395 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.99013 ^ ^0.31395 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.91144 ^ ^0.93691 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.75528 ^ ^1.54508 0 0 0 0 1 force @a[tag=ShowParticles]
particle block stone ^4.52414 ^ ^2.1289 0 0 0 0 1 force @a[tag=ShowParticles]
