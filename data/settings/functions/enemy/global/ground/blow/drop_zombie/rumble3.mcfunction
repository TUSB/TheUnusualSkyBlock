### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Silent:1b,IsBaby:1b,ActiveEffects:[{Id:14b,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],PortalCooldown:5,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CallOnInit,CooldownRequired]}
