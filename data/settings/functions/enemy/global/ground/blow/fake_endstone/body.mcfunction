### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:magma_cube",Silent:1b,CustomName:'{"translate":"block.minecraft.end_stone"}',ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:false}],Size:1,NoAI:0b,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,CallOnDeath,CallOnTimeOut,TickingRequired]}
