### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:marker",CustomName:'{"translate":"トゲの床ばら撒き","color":"#FF8000","bold":true}',PortalCooldown:12,Tags:[DelayedData,HasAI,TickingRequired]}
