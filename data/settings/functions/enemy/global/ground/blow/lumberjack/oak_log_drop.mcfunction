### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:item",Item:{id:"oak_log",Count:1b},PortalCooldown:70,Tags:[DelayedData,HasAI,CallOnInit,CallOnTimeOut,CooldownRequired]}
