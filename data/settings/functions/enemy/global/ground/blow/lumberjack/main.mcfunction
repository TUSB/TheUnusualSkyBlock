...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Death:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Ground,Blow,Lumberjack,GoldenAppleDrop],Level:1}]],Count:3,CountRange:8}]}
