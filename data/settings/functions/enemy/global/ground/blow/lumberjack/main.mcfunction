### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie_villager",CustomName:'{"translate":"木こり","color":"#FFFFFF"}',Silent:true,VillagerData:{level:99,profession:"toolsmith",type:"taiga"},Tags:[Mob,DelayedData,CallOnDeath,CallOnDamage]}
