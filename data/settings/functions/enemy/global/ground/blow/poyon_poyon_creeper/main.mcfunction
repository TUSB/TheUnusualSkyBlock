### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:creeper",CustomName:'{"translate":"ぽよんぽよんクリーパー"}',PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,CooldownRequired,HasLootTable]}
