### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:creeper",CustomName:'{"translate":"バックザ・ク・リーパー","color":"#FFFFFF"}',Fuse:45,ExplosionRadius:3f,Tags:[Mob,DelayedData,DelayedData,HasAI,CallOnDamage]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Name:"Teleport",Direction:[-180f,0f],Target:{Look:"player",Radius:8},Speed:2d}]}
