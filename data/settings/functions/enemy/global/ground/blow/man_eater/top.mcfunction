### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:slime",CustomName:'{"translate":"マンイーター"}',Size:2,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,TickingRequired]}
