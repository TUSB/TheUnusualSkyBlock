### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:creeper",CustomName:'{"translate":"アイスクリーパー","color":"#FFFFFF"}',Fuse:40s,Tags:[Mob,DelayedData,CallOnInit,CallOnAttack,HasLootTable]}
