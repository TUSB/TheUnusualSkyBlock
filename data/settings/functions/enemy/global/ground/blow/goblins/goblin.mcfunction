### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,HasAI,CallOnInit,CooldownRequired,CallOnTime],CustomName:'{"translate":"ゴブリン","color":"#FFFFFF"}',IsBaby:true,PortalCooldown:1800}
...
data modify storage tusb_mob: "遅延ステータス"."物理攻撃力"."基礎ポイント" set value 4
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:2.0d,Target:{Look:"player",Radius:24d,IgnoreBlocks:true}}],Time:[{Execute:"All",Name:"Spawn",Count:1,CountRange:8,SpawnEntities:[[{Tags:[Global,Ground,Blow,Goblins,Goblin,SpawnParticles],Level:1}]],Condition:{Name:"RandomChance",Chance:0.20d}},{Name:"Kill"}],Turn:[{Skill:[{Interval:{Min:6,Max:36,Current:200},Call:[{Name:"Step",Direction:[0f,-13f],Speed:0.8d,SpeedRange:1.5d,Target:{Look:"player",Radius:8d},Condition:{Name:"HasTarget",Target:{Look:"player",Radius:8d}}}]}]}]}
