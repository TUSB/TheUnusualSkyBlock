### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,HasAI,CallOnDeath,CallOnInit],CustomName:'{"translate":"ゴブリン","color":"#FFFFFF"}',IsBaby:true,PortalCooldown:600}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:1.2d,Target:{Look:"player",Radius:24d,IgnoreBlocks:true}}],Death:[{Name:"Spawn",Count:1,CountRange:8,SpawnEntities:[[{Tags:[Global,Ground,Blow,Goblins,Goblin,SpawnParticles],Level:1}]],Condition:{Name:"RandomChance",Chance:1.00d}}],Turn:[{Skill:[{Interval:{Min:8,Max:48,Current:250},Call:[{Name:"Step",Direction:[0f,-13f],Speed:0.7d,SpeedRange:1.3d,Target:{Look:"player",Radius:8d},Condition:{Name:"HasTarget",Target:{Look:"player",Radius:8d}}}]}]}]}
