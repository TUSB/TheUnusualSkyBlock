...
# 対象の最大HPの7%を確定で与える
    ...
    data modify storage score_damage: Argument set value {BypassArmor:1b,BypassResistance:1b,DamageType:[Null],DeathCause:'[{"translate":"%1$sは%2$sによって空の塵となった。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'}
