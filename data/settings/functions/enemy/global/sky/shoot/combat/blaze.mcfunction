### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:blaze",CustomName:'{"translate":"コンバットブレイズ"}',Tags:[Mob,Enemy,DelayedData,HasAI,AnalyseLog]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"標準的なブレイズです。"}]'
# AI
