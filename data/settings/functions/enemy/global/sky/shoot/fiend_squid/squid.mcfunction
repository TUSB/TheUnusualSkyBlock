### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:squid",CustomNameVisible:true,CustomName:'{"translate":"アオリイカ","color":"#FFFFFF"}',Air:32767s,NoGravity:true,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnTimeOut,CooldownRequired,HasLootTable]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/currency_and_magic_stone/tier1/mix",Count:1,Chance:0.5d}]
# AI
