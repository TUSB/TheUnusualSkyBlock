...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:0.15d}],Attack:[{Name:"Damage",Player:{DamageType:[Global],DeathCause:'[{"translate":"%1$sは%2$sによって目の前が真っ暗になった。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},MP:{MP:5,Percent:true},AEC:{Particle:"squid_ink",Duration:80,Radius:2f,effects:[{id:"minecraft:invisibility",amplifier:9b,duration:5,show_particles:false}]}}]}
