### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:ghast",CustomName:'{"translate":"ガスト","color":"#FFFFFF","bold":true}',ExplosionPower:2b,PortalCooldown:1000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,TickingRequired,HasLootTable,AnalyseLog]}
