...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"RandomChance",Chance:0.5d}],Name:"Function",Tags:[Global,Sky,Shoot,CrimsonEye,Effect]}],Tick:[{Name:"Function",Tags:[Global,Sky,Shoot,CrimsonEye,Tick]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:90,Max:150,Current:125},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:16d,IgnoreBlocks:true}}],Settings:[{Name:"Direction",Direction:[-180f,0f],DirectionRange:[360f,0f],Speed:0d,SpeedRange:3d}],Name:"Spawn",SpawnEntities:[[{Tags:[Global,Sky,Shoot,CrimsonEye,BlazeMain],Level:30}],[{Tags:[Global,Sky,Shoot,CrimsonEye,BlazeEffect],Level:30}]]}]},{Interval:{Min:90,Max:150,Current:125},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:16d,IgnoreBlocks:true}}],Name:"Spawn",Count:3,SpawnEntities:[[{Tags:[Global,Sky,Shoot,CrimsonEye,Blood],Level:30}],[{Tags:[Global,Sky,Shoot,CrimsonEye,BloodAuraMarker],Level:30}]]}]}]}]}
