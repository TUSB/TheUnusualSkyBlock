...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:3.0d},{Name:"Function",Tags:[Global,Ground,Shoot,CommonParticle,Cannon]}],Tick:[{Name:"Function",Tags:[Global,Sky,Shoot,Cheriff,ParticleAndSound2]}],ProjectileDamage:{Physical:100,Dark:400}}
#Function
