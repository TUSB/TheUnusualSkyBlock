...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Parabolic",MotionTick:20,MotionGravity:0.02d,Settings:[{Name:"At",Target:{Look:"Player",Radius:32d,IgnoreBlocks:true}}]}],Attack:[{Name:"Function",Tags:[Global,Sky,Shoot,SherbetEye,Attack1]}],Block:[{Name:"Function",Tags:[Global,Sky,Shoot,SherbetEye,ServantShotSound]}],Tick:[{Name:"Function",Tags:[Global,Sky,Shoot,SherbetEye,ServantShotParticle]}]}
