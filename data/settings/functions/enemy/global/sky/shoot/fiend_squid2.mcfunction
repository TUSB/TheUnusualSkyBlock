### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:squid",CustomNameVisible:true,CustomName:'{"translate":"アオリイカ","color":"#FFFFFF"}',Air:32767s,NoGravity:true,PortalCooldown:1600,Tags:[Mob,DelayedData,DelayedData,HasAI,CallOnTimeOut,CooldownRequired]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Time:[{Name:"Kill"}],Turn:[{Target:{Look:"player",Radius:32d},Rotate:[360f,360f]}]}
