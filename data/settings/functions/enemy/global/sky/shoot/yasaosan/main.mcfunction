### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:allay",Team:"Friendly",CustomName:'{"translate":"ヤサオサン","color":"#FFFF00","bold":true}',Silent:1b,ActiveEffects:[{Id:14,Amplifier:1b,Duration:-1,ShowParticles:false},{Id:28,Amplifier:0b,Duration:-1,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CallOnDeath,CallOnDamage,CallOnTick,TickingRequired,DamageProjectile,FriendlyProjectile,HasLootTable,AnalyseLog]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:item/carrot_on_a_stick/carrot_on_a_carrot",Count:1,CountRange:8,Chance:1d}]
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"優しい野菜。略してヤサオ。農業家からは尊敬の念を込めてサン付けされている。%1$s楽しそうに周囲を飛び回る性質がある。「今日も畑の肥料が足りなくなってきたな～！ 待ってろ肥料共～！」","with":[{"translate":"アイテムを右クリックで渡したり、音符ブロックを鳴らすと","color":"#00FF00"}]}]'
# AI
