...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/drop_item/tier4/common",Count:1,Chance:0.51d},{Loot:"item:item/carrot_on_a_stick/entity/jumping_board",Count:1,Chance:0.05d}]
