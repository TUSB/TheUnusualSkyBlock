...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$sトゲトゲのイガイガ。敵味方区別なく突き刺さる。当たるととても痛いので注意。","with":[{"translate":"【能力：ワープ・格闘・移動】","color":"#00FF00"}]}]'
# AI
