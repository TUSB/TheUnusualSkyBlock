...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Rotation",Direction:[-180f,-180f],DirectionRange:[360f,360f]}],Name:"SmartMotion",TP:true,Start:true,Speed:{Set:40d},Gravity:{Set:200d}},{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Sky,Blow,MadUrchin,ParticleAndSound],Level:1}]]}],Damage:[{Name:"SmartMotion",Speed:{Add:200d}},{Name:"Function",Tags:[Global,Event,Function,DamageSound,Machine]}],Block:[{Condition:[{Name:"RandomChance",Chance:0.1d},{Name:"HasTarget",Target:{Look:"Friendly",Radius:24d,IgnoreBlocks:true}},{Name:"HasTarget",Inverse:true,Target:{Look:"Friendly",Radius:24d}}],Settings:[{Name:"At",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"Direction",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:3d,SpeedRange:6d}],Name:"Teleport"},{Name:"SmartMotion",Speed:{Add:40d,Limit:200d}},{Name:"Function",Tags:[Global,Event,Function,DamageSound,Machine]},{Condition:[{Name:"MinMP",Inverse:true,Logic:"OR",MP:1},{Name:"HasTarget",Inverse:true,Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"CheckBlock",Block:[Lava]}],Name:"Kill"}],Tick:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,RandomPoseHead]},{Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Friendly",Radius:28d,IgnoreBlocks:true}}],Settings:[{Name:"At",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"Direction",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:8d,SpeedRange:16d}],Name:"Teleport"},{Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Friendly",Radius:24d,IgnoreBlocks:true}}],Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:48d}},{Name:"Rotation",Direction:[-20f,-20f],DirectionRange:[40f,40f]}],Name:"SmartMotion",TP:true,Speed:{Set:200d}},{Condition:[{Name:"CheckBlock",Inverse:true,Block:[Air]}],Settings:[{Name:"At",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true}},{Name:"Direction",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:8d,SpeedRange:16d}],Name:"Teleport"}],TurnCount:2,Turn:[{Index:1,Skill:[{Interval:{Min:60,Max:60,Current:60},Loop:{Max:1,Current:1},Call:[{}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:2,Max:2,Current:2},Loop:{Max:16,Current:16},Call:[{Settings:[{Name:"Rotation",Direction:[-180f,-180f],DirectionRange:[360f,360f]}],Name:"SmartMotion",TP:true,Speed:{Set:0d}}]},{Interval:{Min:1,Max:5,Current:1},Loop:{Max:1,Current:4,Range:16},Call:[{Settings:[{Name:"Rotation",Target:{Look:"Friendly",Radius:48d,IgnoreBlocks:true},Direction:[60f,60f],DirectionRange:[-30f,-30f]}],Name:"SmartMotion",TP:true,Speed:{Set:200d}}]},{Interval:{Min:60,Max:200,Current:60},Loop:{Max:1,Current:1},Call:[{Name:"SmartMotion",TP:true,Speed:{Set:0d}}]}]}],ProjectileDamage:{Physical:50,Ice:50}}
#Function
# Icosphere
