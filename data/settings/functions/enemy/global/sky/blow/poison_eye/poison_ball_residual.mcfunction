### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:area_effect_cloud",Radius:2f,Duration:2147483647,PortalCooldown:200,Tags:[DelayedData,HasAI,CallOnTimeOut,TickingRequired]}
