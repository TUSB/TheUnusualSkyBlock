### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,HasAI],CustomName:'{"translate":"テストデーモンアイ","color":"#FFFFFF"}',ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticle:0b}],NoGravity:true,IsBaby:true,Silent:true}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Target:{Look:"player",Radius:32d,Block:true},Move:{Front:2d,Side:0d},Rotate:[15f,0f],Exit:{Half:"front",Time:200}}]}
