...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Target:{Look:"player",Radius:32d},Move:{Front:0.2d},Rotate:[30f,30f],Skill:[{Interval:{Min:60,Max:60,Current:1},Call:[{Name:"ChangeTurn",Random:true}]}],Exit:{Loop:{Max:1,Current:1},Time:60}},{Target:{Look:"player",Radius:32d},Move:{Front:0.1d,Up:0.2d},Rotate:[30f,30f],Skill:[{Interval:{Min:60,Max:60,Current:1},Call:[{Name:"ChangeTurn",Random:true}]}],Exit:{Loop:{Max:1,Current:1},Half:"down",Time:30}},{Target:{Look:"player",Radius:32d},Move:{Front:0.1d,Up:-0.2d},Rotate:[30f,30f],Skill:[{Interval:{Min:60,Max:60,Current:1},Call:[{Name:"ChangeTurn",Random:true}]}],Exit:{Loop:{Max:1,Current:1},Half:"up",Time:30}}]}
