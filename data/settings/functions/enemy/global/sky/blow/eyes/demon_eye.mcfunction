### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,HasAI],CustomName:'{"translate":"デーモンアイ","color":"#FFFFFF"}',ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticles:0b}],NoGravity:true,IsBaby:true,Silent:true}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Target:{Look:"player",Radius:32d,Block:true},Move:{Front:0.23d,Side:0d},Rotate:[15f,0f],Exit:{Half:"front",Time:200}},{Target:{Look:"player",Radius:32d,Block:true},Move:{Front:0.23d,Side:0d},Rotate:[0f,15f],Exit:{Half:"up",Time:120}},{Target:{Look:"player",Radius:32d,Block:true},Move:{Front:0.23d,Side:0d},Rotate:[0f,15f],Exit:{Half:"down",Time:120}},{Target:{Look:"player",Radius:32d,Block:false},Move:{Front:0.23d,Side:0d},Rotate:[15f,15f],Skill:[{Interval:{Min:5,Max:20,Current:5},Loop:{Max:10,Current:10},Call:[{Name:"Step",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:0.8d,Target:{Look:"none",Radius:0d,Block:true}}]}],Exit:{Time:200}}]}
