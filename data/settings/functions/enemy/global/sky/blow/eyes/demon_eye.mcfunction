...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Target:{Look:"player",Radius:32d},Move:{Front:0.2d},Rotate:[30f,30f],Exit:{Time:60}},{Target:{Look:"player",Radius:32d},Move:{Up:0.2d},Rotate:[30f,30f],Exit:{Time:60}}]}
