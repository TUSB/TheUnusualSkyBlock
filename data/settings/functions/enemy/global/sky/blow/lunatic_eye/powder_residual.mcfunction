### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:area_effect_cloud",Particle:"dust 1.000 0.000 5.000 5",Radius:1f,Duration:20,Tags:[DelayedData,HasAI]}
