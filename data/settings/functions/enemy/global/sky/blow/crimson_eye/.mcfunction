...
execute if entity @s[tag=AuraAppearance] run function settings:enemy/global/sky/blow/crimson_eye/aura_appearance
execute if entity @s[tag=AuraCheck] run function settings:enemy/global/sky/blow/crimson_eye/aura_check
execute if entity @s[tag=DrippingBlood] run function settings:enemy/global/sky/blow/crimson_eye/dripping_blood
execute if entity @s[tag=DrippingBloodAppearance] run function settings:enemy/global/sky/blow/crimson_eye/dripping_blood_appearance
