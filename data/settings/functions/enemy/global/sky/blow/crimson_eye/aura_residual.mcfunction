### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:area_effect_cloud",Particle:"dust 1.000 0.000 0.000 1",Radius:3f,Duration:100,Tags:[DelayedData,HasAI]}
