...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Exit:{Time:240}},{Skill:[{Interval:{Min:5,Max:5,Current:1},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoGravity:true,ignited:true}}],Once:{Max:1}},{Interval:{Min:5,Max:5,Current:60},Call:[{Execute:"All",Name:"Step",Direction:[0f,-90f],Speed:0.7d,Target:{Look:"player",Radius:32d},Absolute:{Horizontal:true,Vertical:true}},{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Blow,Decoration,CloudDecorationAec],Level:1}]]}]}],Exit:{Time:120}},{Skill:[{Interval:{Min:5,Max:5,Current:5},Call:[{Execute:"All",Name:"Step",Direction:[0f,0f],Speed:0.7d,Target:{Look:"player",Radius:32d}},{Name:"Step",Direction:[-10f,-10f],DirectionRange:[20f,20f],Speed:0.15d,SpeedRange:0.5d,Target:{Look:"player",Radius:32d},Condition:{Name:"RandomChance",Chance:0.25d}},{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Blow,Decoration,CloudDecorationAec],Level:1}]]}]}],Exit:{Time:320}}]}
