...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"All",Radius:24d,IgnoreBlocks:true}}],Name:"Step",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:1d}],Attack:[{Name:"Damage",Player:{DamageType:[Global,Blast]},Mob:{Fire:50,Dark:50},MP:{MP:30,Percent:true},Distance:{Max:1d},AEC:{Effects:[{Id:14b,Amplifier:3b,Duration:200,ShowParticles:false}]}}],ProjectileDamage:{Fire:20,Dark:20}}
