### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:area_effect_cloud",CustomName:'{"translate":"炎獄滅石 -集- AEC","color":"#FFFFFF"}',Particle:"block air",Duration:200,Radius:0.001f,PortalCooldown:65,Tags:[DelayedData,HasAI,TickingRequired]}
