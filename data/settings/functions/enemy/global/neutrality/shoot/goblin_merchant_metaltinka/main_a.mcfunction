### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[Mob,Enemy,DelayedData,CallOnTimeOut,CallOnDamage,TickingRequired,LimitedTrades,HasLootTable,WanderingVillager,UpdateOffers],CustomName:'{"translate":"商業ゴブリン・メタルティンカ","color":"#00FFC2","bold":true}',PortalCooldown:3000,DeathLootTable:"empty",VillagerData:{level:99,profession:"armorer",type:"jungle"},DeathLootTableSeed:6L}
