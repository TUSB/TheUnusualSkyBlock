### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Team:"Friendly",CustomName:'{"translate":"商業ゴブリン・メタルティンカ","color":"#00FF00","bold":true}',PortalCooldown:1000,DeathLootTable:"empty",VillagerData:{level:99,profession:"armorer",type:"jungle"},DeathLootTableSeed:6L,Tags:[Mob,Enemy,DelayedData,CallOnDamage,CooldownRequired,LimitedTrades,HasLootTable]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Damage:[{Settings:[{Name:"Facing",Target:{Look:"All",Radius:32d}},{Name:"Anchor",Anchor:"Eyes"},{Name:"Direction",Speed:1d}],Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:32d}},{Name:"MP",MP:5,Percent:true}],Name:"Spawn",SpawnEntities:[[{Tags:[Global,Neutrality,Shoot,GoblinMerchantMetaltinka,InfernoStone],Level:1}],[{Tags:[Global,Neutrality,Shoot,GoblinMerchantMetaltinka,InfernoStoneAec],Level:1}]]}]}
