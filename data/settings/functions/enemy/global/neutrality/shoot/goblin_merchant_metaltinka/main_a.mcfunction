### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[Mob,Enemy,DelayedData,CallOnTimeOut,CallOnDamage,TickingRequired,LimitedTrades,HasLootTable,AnalyseLog,WanderingVillager,UpdateOffers],CustomName:'{"translate":"商業ゴブリン・メタルティンカ","color":"#00FFC2","bold":true}',PortalCooldown:3000,DeathLootTable:"empty",Offers:{Recipes:[{buy:{id:"minecraft:emerald",Count:32b},sell:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2001,CustomAttributes:1b,LootTable:"item:group/magic_stone/tier1_7/mix",display:{Name:'{"translate":"《魔石》メモリスター","color":"#8D00FF","bold":true,"italic":false}',Lore:['[{"translate":"???","color":"#FF0000","bold":true,"obfuscated":true},{"translate":"ﾁャ■ｽ 1/????","color":"#FF0000","bold":true,"italic":true,"obfuscated":false},{"translate":"???","color":"#FF0000","bold":true,"italic":false,"obfuscated":true},{"translate":"のバグ■ーﾀヲ記したｲ石。","color":"#FF0000","bold":true,"italic":false,"obfuscated":false}]','[{"text":"","color":"white","italic":false},{"text":"C","font":"icon","color":"light_purple"},{"text":" 索引顕界"}]','{"text":"---TUSBMemory---","obfuscated":true,"color":"gray","italic":false}']},Skill:{Type:"TUSBMemory",Initializing:1b,Job:"共通",Name:"索引顕界",Level:1,Interval:0,Trigger:"手に持って右クリック",Count:4}},Count:1b},maxUses:6},{buy:{id:"minecraft:iron_ingot",Count:1b},sell:{id:"minecraft:emerald",Count:3b},maxUses:6},{buy:{id:"minecraft:redstone",Count:1b},sell:{id:"minecraft:emerald",Count:1b},maxUses:6},{buy:{id:"minecraft:copper_ingot",Count:1b},sell:{id:"minecraft:emerald",Count:2b},maxUses:6},{buy:{id:"minecraft:gold_ingot",Count:1b},sell:{id:"minecraft:emerald",Count:3b},maxUses:6},{buy:{id:"minecraft:lapis_lazuli",Count:1b},sell:{id:"minecraft:emerald",Count:3b},maxUses:6},{buy:{id:"minecraft:amethyst_shard",Count:1b},sell:{id:"minecraft:emerald",Count:6b},maxUses:6},{buy:{id:"minecraft:diamond",Count:1b},sell:{id:"minecraft:emerald",Count:12b},maxUses:6},{buy:{id:"minecraft:netherite_ingot",Count:1b},sell:{id:"minecraft:emerald",Count:30b},maxUses:6},{buy:{id:"minecraft:emerald",Count:6b},sell:{id:"minecraft:iron_ingot",Count:1b},maxUses:4},{buy:{id:"minecraft:emerald",Count:2b},sell:{id:"minecraft:redstone",Count:1b},maxUses:4},{buy:{id:"minecraft:emerald",Count:4b},sell:{id:"minecraft:copper_ingot",Count:1b},maxUses:4},{buy:{id:"minecraft:emerald",Count:6b},sell:{id:"minecraft:gold_ingot",Count:1b},maxUses:4},{buy:{id:"minecraft:emerald",Count:6b},sell:{id:"minecraft:lapis_lazuli",Count:1b},maxUses:4},{buy:{id:"minecraft:emerald",Count:12b},sell:{id:"minecraft:amethyst_shard",Count:1b},maxUses:4},{buy:{id:"minecraft:emerald",Count:24b},sell:{id:"minecraft:diamond",Count:1b},maxUses:4},{buy:{id:"minecraft:emerald",Count:60b},sell:{id:"minecraft:netherite_ingot",Count:1b},maxUses:4}]},VillagerData:{level:99,profession:"armorer",type:"jungle"},DeathLootTableSeed:6L}
