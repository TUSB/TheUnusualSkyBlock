...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:1d}],Attack:[{Name:"Damage",Player:{},MP:{MP:50,Percent:true},Distance:{Max:1d},AEC:{Particle:"dust 1 0.8353 0.1843 1",Color:16766255,Duration:10,Radius:1f,Effects:[{Id:1,Amplifier:100b,Duration:5,ShowParticles:false}]}},{Name:"Function",Tags:[Global,Ground,Shoot,BananaGarbager,BananaSound]}],ProjectileDamage:{Physical:10,Lightning:20}}
