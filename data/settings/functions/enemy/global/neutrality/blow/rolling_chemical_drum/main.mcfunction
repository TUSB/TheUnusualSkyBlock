### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDeath,CallOnInit,CallOnTimeOut,CallOnDamage,TickingRequired,SmartMotion,Bounce,AnalyseLog,"NonBurst","Trap"],CustomName:'{"translate":"ケミカルドラム","color":"#FF8000","bold":true}',Silent:true,IsBaby:true,DeathTime:19s,active_effects:[{id:"minecraft:invisibility",amplifier:127b,duration:-1,show_particles:false},{id:"minecraft:slow_falling",duration:-1,amplifier:1b,show_particles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
