### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:sheep",Tags:[Mob,Enemy,DelayedData,HasAI,TickingRequired,HasLootTable,AnalyseLog,NoLootTableAdd],CustomName:'{"translate":"金羊裘","color":"#FFFFFF","bold":true}',Color:4b,CustomNameVisible:true,ActiveEffects:[{Id:8,Amplifier:9b,Duration:2147483647,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
