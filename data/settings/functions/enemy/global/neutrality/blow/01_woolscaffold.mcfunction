### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:sheep",CustomName:'{"translate":"羊毛","color":"#FFFFFF","bold":true}',Color:0b,CustomNameVisible:true,PortalCooldown:200,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,CallOnDamage,CooldownRequired,HasLootTable]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Item:{id:"minecraft:white_wool"},Count:4,Chance:0.48d}]
# AI
