### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:sheep",CustomName:'{"translate":"羊毛","color":"#FFFFFF","bold":true}',Color:0b,CustomNameVisible:true,Tags:[Mob,DelayedData,CallOnDamage]}
