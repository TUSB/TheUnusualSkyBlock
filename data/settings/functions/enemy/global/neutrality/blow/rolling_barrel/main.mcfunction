### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDeath,CallOnInit,CallOnTimeOut,CallOnDamage,TickingRequired,SmartMotion,Bounce,AnalyseLog,"NonBurst","Trap"],CustomName:'{"translate":"ローリングバレル","color":"#FF8000","bold":true}',Silent:true,IsBaby:true,DeathTime:19s,ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:false},{Id:28,Duration:-1,Amplifier:1b,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
