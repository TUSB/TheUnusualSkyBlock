...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"物資が入った無害箱。ただしたまに爆弾が混入している。"}]'
# AI
