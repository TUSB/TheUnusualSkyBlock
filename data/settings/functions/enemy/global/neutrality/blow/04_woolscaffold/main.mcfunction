### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:sheep",CustomName:'{"translate":"jeb_","color":"#FFFFFF","bold":true}',Tags:[Mob,Enemy,DelayedData,HasAI,CallOnInit,CallOnTimeOut,CallOnDamage,CallOnBlock,CallOnTick,TickingRequired,SmartMotion,Bounce,HasLootTable,AnalyseLog,"HideLevel"],active_effects:[{id:"minecraft:jump_boost",amplifier:9b,duration:9999,show_particles:false},{id:"minecraft:slow_falling",amplifier:100b,duration:9999,show_particles:false}],PortalCooldown:600,DeathLootTable:"empty"}
