...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Item:{id:"minecraft:white_wool"},Count:64,Chance:1d},{Item:{id:"minecraft:white_wool"},Count:64,Chance:1d},{Item:{id:"minecraft:white_wool"},Count:64,Chance:1d},{Item:{id:"minecraft:white_wool"},Count:64,Chance:1d},{Item:{id:"minecraft:white_wool"},Count:64,Chance:1d},{Item:{id:"minecraft:white_wool"},Count:64,Chance:1d},{Loot:"item:group/tusb_item/trap/bug_memory_star",Count:1,Chance:1d},{Loot:"item:item/carrot_on_a_stick/secret_exp_bug_memory_star",Count:4,Chance:1d},{Loot:"item:group/drop_item/tier8/common",Count:1,Chance:1d}]
