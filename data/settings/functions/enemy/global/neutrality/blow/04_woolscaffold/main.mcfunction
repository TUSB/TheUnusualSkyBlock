...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/drop_item/tier6/common",Count:1,Chance:1d}]
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"♪【脱走のテーマ曲】今すぐやるぞ！ 脱走脱走！ やるぞ！(いつやるのー?) 今！！ にくいぜ！！あの柵！今日こそ出てやる！(実家に帰らせていただきます～) 今だ！ ワープしろ！(無茶言うな！！) やるぜ脱走！ 今すぐ脱走！♪"}]'
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Rotation",Direction:[-180f,-180f],DirectionRange:[360f,360f]}],Name:"SmartMotion",TP:true,Start:true,Speed:{Set:80d},Gravity:{Set:0d}}],Damage:[{Element:[Dark],Name:"Damage",MP:{MP:50,Percent:true}},{Condition:[{Name:"MinMP",MP:99,Percent:true,Inverse:true}],Name:"Kill"}],Block:[{Name:"SmartMotion",TP:true,Speed:{Add:20d,Limit:200d}},{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:32d,IgnoreBlocks:true}},{Name:"RandomChance",Chance:0.15d},{Name:"MP",MP:15}],Settings:[{Name:"At",Target:{Look:"Self"}},{Name:"Rotation",Direction:[-180f,-180f],DirectionRange:[360f,360f]},{Name:"Direction",Speed:4d,SpeedRange:16d}],Name:"Teleport"}],Tick:[{Name:"Function",Tags:[Global,Event,Function,CommonParticle,Flash]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:10,Current:10},Call:[{Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Player",Radius:16d,IgnoreBlocks:true}}],Settings:[{Name:"At",Target:{Look:"Player",Radius:32d,IgnoreBlocks:true}},{Name:"Direction",Direction:[-180f,-180f],DirectionRange:[360f,360f],Speed:8d,SpeedRange:16d}],Name:"Teleport"},{Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Player",Radius:16d,IgnoreBlocks:true}}],Settings:[{Name:"Facing",Target:{Look:"Player",Radius:32d}},{Name:"Rotation",Direction:[-20f,-20f],DirectionRange:[40f,40f]}],Name:"SmartMotion",TP:true,Speed:{Add:10d,Limit:150d,Range:25d}},{Name:"SmartMotion",Speed:{Add:-10d,Limit:40d}}]}]}]}
