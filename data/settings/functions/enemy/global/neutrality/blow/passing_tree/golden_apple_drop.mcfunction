### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:item",Item:{id:"enchanted_golden_apple",Count:1b},PortalCooldown:70,Tags:[DelayedData,CallOnInit,CallOnTimeOut,CooldownRequired,DamageProjectile,EnemyProjectile]}
