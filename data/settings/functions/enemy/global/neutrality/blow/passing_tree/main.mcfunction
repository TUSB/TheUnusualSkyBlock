### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:vindicator",Team:"Friendly",CustomName:'{"translate":"通りすがりの木","color":"#FF8000","bold":true}',Silent:true,DeathTime:19s,Johnny:true,PatrolLeader:false,Patrolling:false,CanJoinRaid:false,ActiveEffects:[{Id:14,Amplifier:127b,Duration:2147483647,ShowParticles:false},{Id:18,Amplifier:127b,Duration:2147483647,ShowParticles:false},{Id:28,Amplifier:1b,Duration:2147483647,ShowParticles:false}],PortalCooldown:7000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDamage,TickingRequired,AnalyseLog]}
