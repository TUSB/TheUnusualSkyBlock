### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:sheep",CustomName:'{"translate":"銀羊裘","color":"#FFFFFF","bold":true}',Color:8b,CustomNameVisible:true,ActiveEffects:[{Id:8b,Amplifier:9b,Duration:2147483647,ShowParticles:false}],PortalCooldown:200,Tags:[Mob,DelayedData,HasAI,CooldownRequired,DamageProjectile]}
