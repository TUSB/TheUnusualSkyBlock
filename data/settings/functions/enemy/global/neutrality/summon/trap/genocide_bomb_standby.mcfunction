### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",Tags:[Mob,HasAI,CallOnInit,CallOnDamage,HideLevel],CustomName:'{"translate":"Grumm","color":"#000000"}',Silent:true,DeathTime:19s,ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticles:false},{Id:18b,Amplifier:127b,Duration:2147483647,ShowParticles:false},{Id:28b,Amplifier:1b,Duration:2147483647,ShowParticles:false}],DeathLootTable:"empty"}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Execute:"All",Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Blow,Trap,GenocideBombStandbyAec],Level:1}]]},{Name:"Step",Direction:[-180f,-180f],DirectionRange:[360f,360f],Absolute:{Horizontal:true,Vertical:true},Speed:0.01d}],Damage:[{Execute:"All",Name:"Spawn",SpawnEntities:[[{Tags:[Global,Neutrality,Summon,Trap,GenocideBombCountdown,SpawnParticles],Level:100}]]},{Name:"Kill"}]}
#Function
