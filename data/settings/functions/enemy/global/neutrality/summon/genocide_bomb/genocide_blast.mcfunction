...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Damage",Player:{Damage:9999d,DamageType:[Global],BypassArmor:true,BypassResistance:true,DeathCause:'[{"translate":"%1$sは%2$sの爆風で吹き飛んだ。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Mob:{Physical:999,Fire:999,Ice:999,Lightning:999,Light:999,Dark:999},Distance:{Max:6.0d}},{Name:"Kill"}]}
#Function
