...
#Function
playsound entity.wither.death neutral @a[distance=..32] ~ ~ ~ 0.4 0 0.1
playsound entity.blaze.ambient neutral @a[distance=..32] ~ ~ ~ 3 0
playsound block.end_portal.spawn neutral @a[distance=..32] ~ ~ ~ 3 1.5
playsound entity.generic.explode neutral @a[distance=..32] ~ ~ ~ 3 0
playsound block.end_portal_frame.fill neutral @a[distance=..32] ~ ~ ~ 3 0
playsound block.ender_chest.open neutral @a[distance=..32] ~ ~ ~ 10 0
