...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Damage",Player:{Damage:9999d,DamageType:[Global],BypassArmor:true,BypassResistance:true,DeathCause:'[{"translate":"%1$sは%2$sの超重力圧縮爆発の衝撃に巻き込まれ1ドットとなった。","with":[{"selector":"@s"},{"storage":"mob_data:","nbt":"MobName","interpret":true}]}]'},Mob:{Physical:999,Fire:999,Dark:999,Hit:true},Distance:{Max:6.0d}},{Name:"Kill"}]}
#Function
playsound entity.wither.death neutral @a[distance=..32] ~ ~ ~ 0.3 0.5 0.1
playsound entity.blaze.ambient neutral @a[distance=..32] ~ ~ ~ 0.3 0 0.1
playsound block.end_portal.spawn neutral @a[distance=..32] ~ ~ ~ 0.2 1.5 0.1
