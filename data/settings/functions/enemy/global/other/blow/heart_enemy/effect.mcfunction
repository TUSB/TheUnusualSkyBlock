### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:area_effect_cloud",Particle:"heart",Radius:0.3f,Duration:2147483647,PortalCooldown:3000,Tags:[DelayedData,HasAI,TickingRequired,HasLootTable]}
