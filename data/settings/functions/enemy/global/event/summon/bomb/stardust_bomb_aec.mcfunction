### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:area_effect_cloud",CustomName:'{"translate":"スターダストボムAEC","color":"#FFFFFF"}',Particle:"minecraft:explosion_emitter",Radius:0.5f,Duration:2,Tags:[HasAI,CallOnInit]}
