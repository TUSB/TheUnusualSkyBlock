### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,HasAI,CallOnInit,CooldownRequired,CallOnTimeOut],CustomName:'{"translate":"パンプキンモータ","color":"#FFFFFF"}',Silent:true,IsBaby:true,PortalCooldown:180,FallDistance:-99999f,ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticles:false},{Id:25b,Amplifier:100b,Duration:4,ShowParticles:false},{Id:28b,Amplifier:1b,Duration:2147483647,ShowParticles:false}]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Direction:[0f,-40f],Speed:0.2d,SpeedRange:0.6d,Target:{Look:"player",Radius:32d},Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:32d}}]}],Time:[{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Summon,Bomb,StardustBombAec],Level:1}]],Target:{Look:"player",Radius:32.0d},Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:32}}]}],Turn:[{Skill:[{Interval:{Min:4,Max:4,Current:30},Loop:{Max:10,Current:10},Call:[{Name:"Step",Direction:[0f,0f],Speed:1.0d,Target:{Look:"player",Radius:64d}}],Once:{Max:10}}]}]}
#Function
