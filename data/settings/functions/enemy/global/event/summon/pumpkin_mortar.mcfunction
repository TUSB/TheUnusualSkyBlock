### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,HasAI,CallOnDeath,CallOnInit],CustomName:'{"translate":"パンプキンモータ","color":"#FFFFFF"}',Silent:true,IsBaby:true,PortalCooldown:200,FallDistance:-99999f,ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2000000,ShowParticles:false},{Id:25b,Amplifier:100b,Duration:4,ShowParticles:false}]}
