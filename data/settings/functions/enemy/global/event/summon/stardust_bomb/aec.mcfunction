...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Spawn",Count:80,SpawnEntities:[[{Tags:[Global,Event,Summon,StardustBomb,Main],Level:1}]]}]}
#Function
playsound minecraft:block.beacon.activate hostile @a[distance=..32] ~ ~ ~ 2 2.0 0
