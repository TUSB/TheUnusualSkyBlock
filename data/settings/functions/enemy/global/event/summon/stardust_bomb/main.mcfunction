### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:shulker_bullet",CustomName:'{"translate":"スターダストボム","color":"#FFFFFF"}',NoGravity:true,PortalCooldown:100,Tags:[DelayedData,CallOnInit,CallOnTimeOut,TickingRequired,DamageProjectile,EnemyProjectile]}
