### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:arrow",CustomName:'{"translate":"デッドリーアロー","color":"#FFFFFF"}',life:1,Color:9109504,PortalCooldown:80,Tags:[DelayedData,HasAI,CallOnDeath,CallOnInit,CooldownRequired]}
