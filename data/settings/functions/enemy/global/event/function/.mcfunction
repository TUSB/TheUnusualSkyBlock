...
execute if entity @s[tag=ExitExchange] run function settings:enemy/global/event/function/exit_exchange
...
execute if entity @s[tag=Ride] run function settings:enemy/global/event/function/ride/
...
execute if entity @s[tag=Avoid] run function settings:enemy/global/event/function/avoid/
