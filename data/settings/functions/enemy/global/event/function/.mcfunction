...
execute if entity @s[tag=SmartMotionToRotation] run function settings:enemy/global/event/function/smart_motion_to_rotation
execute if entity @s[tag=TpWithRotation] run function settings:enemy/global/event/function/tp_with_rotation
execute if entity @s[tag=MotionToRotation] run function settings:enemy/global/event/function/motion_to_rotation
