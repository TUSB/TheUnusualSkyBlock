execute if entity @s[tag=AecHuge] run function settings:enemy/global/event/function/dark_explosion/aec_huge
execute if entity @s[tag=ParticleHuge] run function settings:enemy/global/event/function/dark_explosion/particle_huge
execute if entity @s[tag=Aec] run function settings:enemy/global/event/function/dark_explosion/aec
