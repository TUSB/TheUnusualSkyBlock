...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{Name:"Function",Tags:[Global,Event,Function,Common,RandomRotation]},{Name:"Function",Tags:[Global,Event,Function,DarkExplosion,Particle]}]}]}]}
#Function
# サウンド
