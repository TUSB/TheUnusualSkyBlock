...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Rotation",Direction:[-15f,-15f],DirectionRange:[30f,30f]}],Name:"Step",Speed:2d}],Attack:[{Name:"Damage",Mob:{Fire:100,Ice:100,Dark:100},Distance:{Min:0.1d,Max:3d}}],ProjectileDamage:{Fire:100,Ice:100,Dark:100}}
