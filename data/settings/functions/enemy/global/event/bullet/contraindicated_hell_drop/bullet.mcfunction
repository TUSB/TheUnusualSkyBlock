...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:1d}],Attack:[{Name:"Damage",Mob:{Fire:100,Ice:100,Dark:100},Distance:{Min:0.1d,Max:3d}}],ProjectileDamage:{Fire:100,Ice:100,Dark:100}}
