...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Enemy",Radius:48d,IgnoreBlocks:true}}],Name:"Step",Speed:1d}],Attack:[{Name:"Damage",Mob:{Light:100},Distance:{Max:3d},AEC:{Particle:"dust",Color:14406822,Duration:3,Radius:3f}}]}
