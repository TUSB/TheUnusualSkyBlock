...
execute if entity @s[tag=SecurityPoleDual] run function settings:enemy/global/event/bullet/security_pole_dual/
...
execute if entity @s[tag=LightBombHuge] run function settings:enemy/global/event/bullet/light_bomb_huge/
execute if entity @s[tag=IceBombHuge] run function settings:enemy/global/event/bullet/ice_bomb_huge/
execute if entity @s[tag=DeadlyPoisonBombHuge] run function settings:enemy/global/event/bullet/deadly_poison_bomb_huge/
execute if entity @s[tag=DarkBombHuge] run function settings:enemy/global/event/bullet/dark_bomb_huge/
execute if entity @s[tag=LightningBombHuge] run function settings:enemy/global/event/bullet/lightning_bomb_huge/
