...
execute if entity @s[tag=Light] run function settings:enemy/global/event/bullet/light/
...
execute if entity @s[tag=Etc] run function settings:enemy/global/event/bullet/etc/
