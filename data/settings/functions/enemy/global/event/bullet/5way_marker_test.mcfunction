### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:armor_stand",Marker:true,Invisible:true,PortalCooldown:2,Tags:[Mob,DelayedData,HasAI,CallOnInit,CooldownRequired]}
