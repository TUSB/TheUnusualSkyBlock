...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Enemy",Radius:24d,IgnoreBlocks:true}}],Name:"Step",Direction:[0f,-60f],Speed:0.7d}],Time:[{Name:"Kill"}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:3,Max:3,Current:20},Loop:{Max:5,Current:5},Call:[{Name:"Step",Direction:[0f,0f],DirectionRange:[0f,0f],Speed:0.7d,Settings:[{Name:"Facing",Target:{Look:"Enemy",Radius:64d,IgnoreBlocks:true}}]}]}]}]}
#Function
