### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",Team:"Friendly",CustomName:'{"translate":"迫撃砲"}',Silent:1b,NoAI:1b,PortalCooldown:6000,DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CallOnTimeOut,CooldownRequired]}
