### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:allay",Team:"Friendly",Tags:[Mob,DelayedData,HasAI,CallOnDeath,CallOnDamage,CallOnTick,TickingRequired,DamageProjectile,FriendlyProjectile,HasLootTable,AnalyseLog,"Helper"],CustomName:'{"translate":"ヤサオサン","color":"#FFFF00","bold":true}',Silent:1b,ActiveEffects:[{Id:14,Amplifier:1b,Duration:-1,ShowParticles:false},{Id:28,Amplifier:0b,Duration:-1,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Death:[{Name:"Function",Tags:[Global,Event,Function,DamageSound,SteveHighPitch]}],Damage:[{Name:"Function",Tags:[Global,Event,Function,DamageSound,SteveHighPitch]}],Tick:[{Condition:[{Name:"RandomChance",Chance:0.15d}],Name:"Function",Tags:[Global,Friendly,Shoot,Yasaosan,ParticleAndSound1]}],TurnCount:3,Turn:[{Index:1,Skill:[{Interval:{Min:20,Max:100,Current:20},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:32d}}],Name:"ChangeTurn",Set:2},{Condition:[{Name:"HasTarget",Target:{Look:"Enemy",Radius:32d,MinRadius:0.5d}}],Name:"ChangeTurn",Set:3}]}]},{Index:2,Skill:[{Interval:{Min:3,Max:3,Current:3},Loop:{Max:4,Current:8,Range:4},Call:[{Name:"Function",Tags:[Global,Event,Function,AttackSound,ThrownBeing]},{Name:"Function",Tags:[Global,Event,Function,CommonExe,ReverseLinkingRotation]},{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:64d,MinRadius:0.1d,IgnoreBlocks:true}},{Name:"Anchor",Anchor:"Eyes"},{Name:"Rotation",Direction:[-2f,-2f],DirectionRange:[4f,4f]},{Name:"Direction",Speed:1d}],Name:"Spawn",Count:1,SpawnEntities:[[{Tags:[Global,Friendly,Shoot,Yasaosan,Bullet],Level:1}]]}],MP:3},{Interval:{Min:20,Max:60,Current:30},Loop:{Max:1,Current:1},Call:[{Name:"ChangeTurn",Set:1},{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:16d,IgnoreBlocks:true}}],Name:"Function",Tags:[Global,Friendly,Shoot,Yasaosan,Grow]}]}]},{Index:3,Skill:[{Interval:{Min:3,Max:3,Current:3},Loop:{Max:4,Current:8,Range:4},Call:[{Name:"Function",Tags:[Global,Event,Function,AttackSound,ThrownBeing]},{Name:"Function",Tags:[Global,Event,Function,CommonExe,ReverseLinkingRotation]},{Settings:[{Name:"Facing",Target:{Look:"Enemy",Radius:64d,MinRadius:0.1d,IgnoreBlocks:true}},{Name:"Anchor",Anchor:"Eyes"},{Name:"Rotation",Direction:[-2f,-2f],DirectionRange:[4f,4f]},{Name:"Direction",Speed:1d}],Name:"Spawn",Count:1,SpawnEntities:[[{Tags:[Global,Friendly,Shoot,Yasaosan,Bullet],Level:1}]]}],MP:3}],Exit:{Loop:{Max:1,Current:1}}}],ProjectileDamage:{Physical:150,Light:10}}
#Function
# 出現時半径64m以内にいるヘルパーグループのMOBが8体以上である時、一番古い遠くにいるモブから削除する。
execute as @e[tag=Helper,tag=!Garbage,distance=..64,sort=arbitrary,limit=8] as @e[sort=furthest,limit=1] run tag @s add Garbage
