### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:allay",Team:"Friendly",Tags:[Mob,DelayedData,HasAI,CallOnDeath,CallOnDamage,CallOnTick,TickingRequired,DamageProjectile,FriendlyProjectile,HasLootTable,AnalyseLog,"Helper"],CustomName:'{"translate":"チェリフ","color":"#FFFF00","bold":true}',Silent:1b,ActiveEffects:[{Id:14,Amplifier:1b,Duration:-1,ShowParticles:false},{Id:28,Amplifier:0b,Duration:-1,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$s治安警備をする保安魔果実。マウンテン丸男からは畏怖の念を込めて無糖果さんと呼ばれている。%2$s楽しそうに周囲をワープし飛び回る性質がある。「今日も弾丸が撃ちたくなってきたぜぇぇええ～！ 待ってろ賞金首共～！」","with":[{"translate":"【能力：ワープ・格闘・移動・射的】","color":"#00FF00"},{"translate":"アイテムを右クリックで渡したり、音符ブロックを鳴らすと","color":"#FF7500"}]}]'
# AI
