...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Friendly,Shoot,SalamanderKid,ExplosionAftertaste]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:2,Max:2,Current:20},Loop:{Max:2,Current:2},Call:[{Name:"Spawn",Count:1,SpawnEntities:[[{Tags:[Global,Friendly,Shoot,SalamanderKid,ExplosionAttacker],Level:1}]]},{Name:"Kill"}]}],Exit:{Loop:{Max:1,Current:1}}}]}
