### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:bat",Team:"Friendly",CustomName:'{"translate":"サラマンダー","color":"#FFFF00"}',Silent:1b,ActiveEffects:[{Id:14b,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],PortalCooldown:3000,Tags:[Mob,DelayedData,HasAI,TickingRequired]}
