...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:group/magic_stone/tier1_7/mix",Count:3,Chance:0.3d},{Loot:"item:group/magic_stone/tier1_4/mystery",Count:1,Chance:1d}]
