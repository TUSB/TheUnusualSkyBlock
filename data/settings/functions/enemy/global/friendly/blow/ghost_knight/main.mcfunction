### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",Team:"Friendly",CustomName:'{"translate":"幽霊騎士","color":"#FFFF00","bold":true}',Silent:true,ActiveEffects:[{Id:14,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],NoGravity:1b,PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CallOnDeath,TickingRequired]}
