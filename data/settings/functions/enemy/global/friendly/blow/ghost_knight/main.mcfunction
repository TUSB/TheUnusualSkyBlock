### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",Team:"Friendly",Silent:1b,CustomName:'{"translate":"亡霊騎士"}',ActiveEffects:[{Id:14b,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],Team:"Friendly",AbsorptionAmount:100f,NoGravity:1b,PortalCooldown:1200,DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CallOnDeath,CallOnTimeOut,CooldownRequired]}
