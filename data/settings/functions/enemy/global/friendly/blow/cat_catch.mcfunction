### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Team:"Friendly",CustomName:'{"translate":"ネコキャッチ","color":"#00FF00","bold":true}',ActiveEffects:[{Id:11b,Amplifier:4b,Duration:50}],PortalCooldown:3000,DeathLootTable:"empty",VillagerData:{level:99,profession:"cartographer",type:"plains"},DeathLootTableSeed:6L,Tags:[Mob,DelayedData,CallOnTimeOut,CallOnDamage,TickingRequired,LimitedTrades,AnalyseLog]}
data modify storage tusb_mob: "即時ステータス"."見た目" set value {ArmorItems:[{},{},{},{id:"chest",Count:1b}],ArmorDropChances:[-1E40f,-1E40f,-1E40f,-1E40f]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"頼むから安全な場所で取引させてほしい。"}]'
# AI
