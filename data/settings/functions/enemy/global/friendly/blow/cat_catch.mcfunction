### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Team:"Friendly",CustomName:'{"translate":"ネコキャッチ","color":"#00FF00","bold":true}',ActiveEffects:[{Id:11,Amplifier:4b,Duration:50}],PortalCooldown:3000,DeathLootTable:"empty",VillagerData:{level:99,profession:"cartographer",type:"plains"},DeathLootTableSeed:6L,Tags:[Mob,DelayedData,CallOnTimeOut,CallOnDamage,TickingRequired,LimitedTrades,AnalyseLog]}
