...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Friendly,Blow,FriendWolf,ThunderRush1]}],TurnCount:5,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:10,Current:10},Loop:{Max:1,Current:1},Call:[{Name:"ChangeAI",Tick:[{}]},{Name:"MergeNBT",NBT:{NoGravity:false,active_effects:[{id:"minecraft:invisibility",amplifier:127b,duration:0,show_particles:false},{id:"minecraft:slow_falling",amplifier:1b,duration:0,show_particles:false}]}}]}],Exit:{Loop:{Max:1,Current:1}}},{Index:2,Skill:[{Interval:{Min:10,Max:10,Current:10},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Enemy",Radius:8d,IgnoreBlocks:true}}],Name:"ChangeTurn",Set:3}]}]},{Index:3,Skill:[{Interval:{Min:10,Max:10,Current:10},Loop:{Max:1,Current:1},Call:[{Name:"Function",Tags:[Global,Friendly,Blow,FriendWolf,HowlingSound]}]},{Interval:{Min:20,Max:20,Current:20},Loop:{Max:1,Current:1},Call:[{Name:"ChangeAI",Tick:[{Name:"Function",Tags:[Global,Friendly,Blow,FriendWolf,ThunderRush1]}]}]},{Interval:{Min:10,Max:10,Current:10},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Enemy",Radius:16d,IgnoreBlocks:true}}],Name:"ChangeTurn",Set:4},{Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Enemy",Radius:16d,IgnoreBlocks:true}}],Name:"ChangeTurn",Set:1}]}]},{Index:4,Skill:[{Interval:{Min:10,Max:10,Current:10},Loop:{Max:1,Current:1},Call:[{Name:"MergeNBT",NBT:{NoGravity:true,active_effects:[{id:"minecraft:invisibility",amplifier:127b,duration:-1,show_particles:false},{id:"minecraft:slow_falling",amplifier:1b,duration:-1,show_particles:false}]}}]},{Interval:{Min:10,Max:10,Current:10},Loop:{Max:1,Current:1},Call:[{Name:"ChangeAI",Tick:[{Name:"Function",Tags:[Global,Friendly,Blow,FriendWolf,ThunderRush1]}]}]}],Exit:{Loop:{Max:2,Current:2}}},{Index:5,Skill:[{Interval:{Min:20,Max:30,Current:20},Loop:{Max:1,Current:1,Range:4},Call:[{Settings:[{Name:"Facing",Target:{Look:"Enemy",Radius:24d}},{Name:"Anchor",Anchor:"Eyes"}],Name:"Step",Speed:3d},{Name:"Function",Tags:[Global,Friendly,Blow,FriendWolf,Lightning]},{Name:"Function",Tags:[Global,Event,Function,CommonExe,RandomRotation]},{Name:"Function",Tags:[Global,Friendly,Blow,FriendWolf,Lightning]}]},{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"At",Target:{Look:"Player",Radius:24}},{Name:"Direction",Direction:[-180f,0f],Speed:2d}],Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Enemy",Radius:16d,IgnoreBlocks:true}},{Name:"CheckNBT",NBT:{OnGround:false}}],Name:"Teleport"}]},{Interval:{Min:2,Max:2,Current:2},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Global:true,Inverse:true,Target:{Look:"Enemy",Radius:16d,IgnoreBlocks:true}}],Name:"MergeNBT",NBT:{NoGravity:false,active_effects:[{id:"minecraft:invisibility",amplifier:127b,duration:0,show_particles:false}]}},{Name:"ChangeTurn",Set:1}]}]}],ProjectileDamage:{Physical:50,Lightning:50}}
#Function
