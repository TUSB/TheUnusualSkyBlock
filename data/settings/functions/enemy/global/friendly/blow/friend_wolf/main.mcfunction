### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:wolf",Team:"Friendly",Tags:[Mob,DelayedData,HasAI,TickingRequired,DamageProjectile,FriendlyProjectile,BeforeEvolution],CustomNameVisible:true,CustomName:'{"translate":"フレンド・ウルフ","color":"#FFFF00","bold":true}',ActiveEffects:[{Id:11b,Amplifier:4b,Duration:50}],Motion:[0d,0.5d,0d],PortalCooldown:3000,DeathLootTable:"empty"}
