...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"elixir",Count:1,Chance:0.25d},{Loot:"item:group/mob/drop_item/villager",Count:1,Chance:0.6d}]
