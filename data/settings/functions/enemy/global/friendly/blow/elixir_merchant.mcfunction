...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"elixir",Count:1,Chance:0.51d},{Loot:"item:group/drop_item/all/villager",Count:1,Chance:0.51d}]
# AI
