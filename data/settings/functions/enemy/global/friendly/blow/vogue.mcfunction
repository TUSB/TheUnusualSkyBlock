...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:item/carrot_on_a_stick/tier3_iron_memory_star",Count:1,CountRange:3,Chance:1d},{Loot:"item:group/drop_item/all/villager",Count:1,Chance:0.51d}]
