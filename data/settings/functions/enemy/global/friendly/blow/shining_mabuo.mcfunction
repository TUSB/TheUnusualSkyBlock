### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[Mob,DelayedData,CallOnTimeOut,CallOnDamage,TickingRequired,LimitedTrades,HasLootTable,AnalyseLog,WanderingVillager],CustomName:'{"translate":"シャイニングマブオ","color":"#00FF00","bold":true}',PortalCooldown:3000,DeathLootTable:"empty",Offers:{Recipes:[{buy:{id:"minecraft:emerald",Count:8b},sell:{id:"minecraft:glowstone",Count:8b},maxUses:10},{buy:{id:"minecraft:emerald",Count:8b},sell:{id:"minecraft:sea_lantern",Count:8b},maxUses:10},{buy:{id:"minecraft:emerald",Count:8b},sell:{id:"minecraft:ochre_froglight",Count:8b},maxUses:10},{buy:{id:"minecraft:emerald",Count:8b},sell:{id:"minecraft:pearlescent_froglight",Count:8b},maxUses:10},{buy:{id:"minecraft:emerald",Count:8b},sell:{id:"minecraft:verdant_froglight",Count:8b},maxUses:10}]},VillagerData:{level:99,profession:"cleric",type:"plains"},DeathLootTableSeed:3L}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Item:{id:"minecraft:glowstone"},Count:1,Chance:0.35d},{Loot:"item:group/drop_item/all/villager",Count:1,Chance:0.35d}]
