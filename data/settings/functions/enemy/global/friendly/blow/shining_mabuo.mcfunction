...
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Item:{id:"minecraft:glowstone"},Count:1,Chance:0.25d},{Loot:"item:group/drop_item/all/villager",Count:1,Chance:0.25d}]
