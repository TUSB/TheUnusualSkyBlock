### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Team:"Friendly",CustomName:'{"translate":"ドンチャン","color":"#FFFF00"}',Age:-9999,InLove:0,ForcedAge:-9999,Silent:true,DeathTime:19s,ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDeath,CallOnInit,CallOnTimeOut,CallOnDamage,TickingRequired,AnalyseLog]}
...
# ステータス
data modify storage tusb_mob: "遅延ステータス"."ステータス"."最大HP" set value 113
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]}],Death:[{Name:"Damage",Mob:{Physical:10,Fire:100,Hit:true},Distance:{Min:0d,Max:7d},Explosion:-1},{Name:"Spawn",SpawnEntities:[[{Tags:[Global,Event,Function,FireExplosion,AecHuge],Level:1}]]},{Name:"Function",Tags:[Global,Event,Function,AttackSound,Explosion]},{Name:"Message",Message:'{"text":"test"}'}],Time:[{Name:"ChangeAI",Death:[{}]}],Damage:[{Name:"MergeNBT",NBT:{NoAI:false}},{Condition:[{Name:"CheckBlock",Inverse:true,Block:[Water,Lava,Air]}],Name:"Function",Tags:[Global,Event,Function,CommonExe,UpAlign1]},{Name:"Function",Tags:[Global,Event,Function,DamageSound,Metal]},{Name:"ChangeTurn",Set:3}],TurnCount:4,Turn:[{Index:1,Skill:[{Interval:{Min:2,Max:2,Current:2},Call:[{Condition:[{Name:"CheckNBT",Global:true,NBT:{OnGround:true}}],Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]},{Name:"MergeNBT",NBT:{NoAI:true}},{Name:"ChangeTurn",Set:2}]}]},{Index:2,Skill:[{Interval:{Min:5,Max:5,Current:5},Call:[{Condition:[{Name:"MinHP",Inverse:true,HP:100,Percent:true},{Name:"MinHP",HP:61,Percent:true}],Name:"MergeNBT",NBT:{ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Type:0b,Colors:[I;10551102]},CustomModelData:1043}}]}},{Condition:[{Name:"MinHP",Inverse:true,HP:60,Percent:true},{Name:"MinHP",HP:31,Percent:true}],Name:"MergeNBT",NBT:{ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Type:0b,Colors:[I;16772670]},CustomModelData:1043}}]}},{Condition:[{Name:"MinHP",Inverse:true,HP:30,Percent:true},{Name:"MinHP",HP:0,Percent:true}],Name:"MergeNBT",NBT:{ArmorItems:[{},{},{},{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Type:0b,Colors:[I;16727614]},CustomModelData:1043}}]}}]}]},{Index:3,Skill:[{Interval:{Min:2,Max:2,Current:2},Call:[{Condition:[{Name:"CheckNBT",Global:true,NBT:{OnGround:true}}],Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]},{Name:"MergeNBT",NBT:{NoAI:true}},{Name:"ChangeTurn",Set:4}]}]},{Index:4,Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{Settings:[{Name:"Anchor",Anchor:"Eyes"}],Name:"Spawn",Count:1,SpawnEntities:[[{Tags:[Global,Friendly,Blow,Donchian,Bullet],Level:1}],[{Tags:[Global,Friendly,Blow,Donchian,BulletMarker],Level:1}]]},{Name:"ChangeTurn",Set:2}]}]}]}
