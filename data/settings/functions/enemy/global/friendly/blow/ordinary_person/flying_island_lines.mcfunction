...
# 位置指定
execute in area:flying_island positioned -585 89 -814 if entity @s[distance=..1] run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].CCHelper set from storage mob_data: CCHelper
