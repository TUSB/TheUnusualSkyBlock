### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[DelayedData,CallOnTimeOut,CooldownRequired,LimitedTrades,UpdateOffers],CustomName:'{"translate":"《武器防具》トッテツ","color":"#00FFC2","bold":true}',AbsorptionAmount:9999999f,Invulnerable:true,DeathTime:19s,PortalCooldown:6000,DeathLootTable:"empty",VillagerData:{level:99,profession:"weaponsmith",type:"taiga"},DeathLootTableSeed:2147483647L}
