...
#トッテツ通常時
execute if score @s MP matches 0 run data merge entity @s {PortalCooldown:3000,CustomName:'{"translate":"トッテツ","color":"#00FF00","bold":true}',CustomNameVisible:false}
...
#トッテツタイムセール時
execute if score @s MP matches 1 run data merge entity @s {PortalCooldown:1000,CustomName:'{"translate":"タイムセール開催中！","color":"#00FF00","bold":true}',CustomNameVisible:true}
