### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[Mob,DelayedData,CallOnTimeOut,CallOnDamage,TickingRequired,LimitedTrades,HasLootTable,AnalyseLog,WanderingVillager],CustomName:'{"translate":"マウンテン丸男","color":"#00FF00","bold":true}',PortalCooldown:3000,DeathLootTable:"empty",Offers:{Recipes:[{buy:{id:"minecraft:emerald",Count:16b},sell:{id:"minecraft:oak_log",Count:8b},maxUses:8},{buy:{id:"minecraft:emerald",Count:16b},sell:{id:"minecraft:spruce_log",Count:8b},maxUses:8},{buy:{id:"minecraft:emerald",Count:16b},sell:{id:"minecraft:birch_log",Count:8b},maxUses:8},{buy:{id:"minecraft:emerald",Count:16b},sell:{id:"minecraft:acacia_log",Count:8b},maxUses:8},{buy:{id:"minecraft:emerald",Count:16b},sell:{id:"minecraft:dark_oak_log",Count:8b},maxUses:8},{buy:{id:"minecraft:emerald",Count:16b},sell:{id:"minecraft:jungle_log",Count:8b},maxUses:8},{buy:{id:"minecraft:emerald",Count:16b},sell:{id:"minecraft:mangrove_log",Count:8b},maxUses:8}]},VillagerData:{level:99,profession:"leatherworker",type:"jungle"},DeathLootTableSeed:3L}
