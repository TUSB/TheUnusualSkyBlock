...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:0.3d}],Attack:[{Name:"Damage",Player:{Damage:0d},Distance:{Max:1d},AEC:{Effects:[{Id:14,Amplifier:7b,Duration:80,ShowParticles:false}]}}]}
