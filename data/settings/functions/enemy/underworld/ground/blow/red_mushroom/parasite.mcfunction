### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:vindicator",CustomName:'{"translate":"赤キノコに寄生された村人","color":"#FFFFFF","bold":true}',Silent:true,PatrolLeader:false,Patrolling:false,CanJoinRaid:false,PortalCooldown:3000,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDeath,CallOnInit,CallOnDamage,CallOnAttack,TickingRequired,HasLootTable]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Event,Function,Attributes,MovementSpeedRandom],MinSpeed:10,RangeSpeed:25}],Death:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:48d}},{Name:"RandomChance",Chance:0.35d}],Name:"Spawn",SpawnEntities:[[{Tags:[Underworld,Ground,Blow,RedMushroom,Metamorphose,SpawnParticles],Level:22}]]}],Damage:[{Name:"Function",Tags:[Global,Event,Function,DamageSound,Mankind]}],Attack:[{Name:"Function",Tags:[Global,Event,Function,DamageSound,Mankind]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:60,Max:120,Current:80},Call:[{Settings:[{Name:"Facing",Target:{Look:"Friendly",Radius:16d}}],Name:"Step",Direction:[0f,-13f],Speed:0.8d,SpeedRange:1.6d}],MP:3}]}]}
