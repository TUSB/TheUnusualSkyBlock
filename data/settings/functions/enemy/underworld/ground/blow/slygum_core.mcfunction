### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:slime",CustomName:'{"translate":"スライガム","color":"#FFFFFF"}',Size:0,NoAI:true,NoGravity:true,DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI]}
