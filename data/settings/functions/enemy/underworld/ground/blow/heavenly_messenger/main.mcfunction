...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Underworld,Ground,Blow,HeavenlyMessenger,Align]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:10,Current:10},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Enemy",Radius:5}}],Name:"Function",Tags:[Underworld,Ground,Blow,HeavenlyMessenger,Parasite]},{Condition:[{Name:"HasTarget",Target:{Look:"Friendly",Radius:5d}}],Name:"Damage",Player:{BypassArmor:true,BypassResistance:true},MP:{MP:50,Percent:true},Distance:{Min:0.1d,Max:2d},AEC:{Particle:"dust",Color:14218751,Duration:10,Radius:0.5f,Effects:[{Id:14b,Amplifier:4b,Duration:5,ShowParticles:false}]}},{Name:"Function",Tags:[Underworld,Ground,Blow,HeavenlyMessenger,Align]}]}]}]}
