...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"圧倒的な増殖力と寄生能力を備え、水に擬態する能力、一度触れた敵対生物を凍らせ、身動きが取れなくさせながら溶かす致命的な攻撃力を持つ危険な生物です。この凶悪な存在は簡単にバイオハザードを引き起こす可能性がある為、一匹残らず駆除する必要があるとされている。また本物の水に触れると、その細胞が溶解し死亡する弱点を抱えている。"}]'
# AI
