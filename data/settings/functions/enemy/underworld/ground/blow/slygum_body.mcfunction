### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:slime",Size:0,NoAI:1b,NoGravity:1b,PortalCooldown:20,DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CooldownRequired]}
