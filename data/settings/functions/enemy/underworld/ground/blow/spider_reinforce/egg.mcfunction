### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,Enemy,DelayedData,CallOnTimeOut,TickingRequired,HideLevel],CustomName:'{"translate":"Grumm","color":"#000000"}',Silent:1b,ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:0b},{Id:18,Amplifier:4,Duration:2147483647,ShowParticles:0b}],PortalCooldown:600,DeathLootTable:"empty"}
