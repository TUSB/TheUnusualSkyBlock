### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:spider",CustomName:'{"translate":"リインフォーススパイダー","color":"#FFFFFF"}',DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CallOnDamage,CallOnAttack,HasLootTable]}
