### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:item",CustomName:'{"translate":"蜘蛛の巣ショット","color":"#FF0000","bold":true}',NoGravity:1b,Age:100,PickupDelay:32767,PortalCooldown:100,DeathLootTable:"empty",Tags:[DelayedData,HasAI,CallOnDeath,CallOnInit,CallOnTimeOut,CooldownRequired,DamageProjectile,EnemyProjectile]}
