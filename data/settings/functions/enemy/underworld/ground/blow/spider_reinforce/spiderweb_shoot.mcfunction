### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:item",NoGravity:1b,Age:100,PickupDelay:32767,PortalCooldown:100,DeathLootTable:"empty",Tags:[DelayedData,HasAI,CallOnDeath,CallOnInit,CallOnTimeOut,CooldownRequired,DamageProjectile,EnemyProjectile]}
...
playsound entity.spider.hurt hostile @a[distance=..20] ~ ~ ~ 0.7.0 2.0
playsound entity.wither.shoot hostile @a[distance=..20] ~ ~ ~ 0.7.0 2.0
