...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:1,Turn:[{Index:1,Target:{Look:"player",Radius:20d},Move:{Front:0.6d,Side:0d,Up:0.3d},Rotate:[-5f,-5f],Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{Name:"Spawn",SpawnEntities:[[{Tags:["Underworld","Ground","Blow","Slygum","Body"],Level:1}]],Speed:2,SpeedRange:2.5,DirectionRange:[180f,180f],Direction:[-90f,-90f]}]}]}]}
