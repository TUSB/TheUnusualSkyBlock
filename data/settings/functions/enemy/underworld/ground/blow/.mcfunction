...
execute if entity @s[tag=RedMushroom] run function settings:enemy/underworld/ground/blow/red_mushroom/
execute if entity @s[tag=BluishPurpleMushroom] run function settings:enemy/underworld/ground/blow/bluish_purple_mushroom/
