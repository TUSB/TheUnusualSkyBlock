...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Step",Speed:0.5d}],Attack:[{Name:"Function",Tags:[Underworld,Ground,Shoot,SludgeGarbager,SludgeSound]}]}
