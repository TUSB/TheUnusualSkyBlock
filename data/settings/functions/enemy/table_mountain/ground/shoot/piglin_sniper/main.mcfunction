...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {TurnCount:3,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Call:[{}]}],Exit:{Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:40,IgnoreBlocks:true}}]}},{Index:2,Target:{Look:"player",Radius:40d,IgnoreBlocks:1b},Rotate:[-10f,-10f],Skill:[{Interval:{Min:20,Max:20,Current:20},Call:[{Name:"Casting"}]}],Exit:{Time:1,TimeCount:1}},{Index:3,Target:{Look:"player",Radius:40d,IgnoreBlocks:1b},Skill:[{Interval:{Min:20,Max:20,Current:20},Call:[{Name:"Spawn",Speed:1,Direction:[0f,-90f],Absolute:{Vertical:true},Rotation:{},SpawnEntities:[[{Tags:[TableMountain,Ground,Shoot,PiglinSniper,FireworkRocket],Level:1}]]}]}],Exit:{Time:1,TimeCount:1}}]}
