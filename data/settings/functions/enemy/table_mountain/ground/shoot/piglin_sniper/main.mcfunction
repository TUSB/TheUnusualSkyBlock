### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:piglin",CustomName:'{"translate":"ピグリン","color":"#FF0000"}',PortalCooldown:600,DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CooldownRequired,HasLootTable]}
