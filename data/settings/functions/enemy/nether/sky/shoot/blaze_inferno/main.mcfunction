### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:blaze",CustomNameVisible:true,CustomName:'{"translate":"ブレイズインフェルノ","color":"#FFFFFF"}',Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDamage,HasLootTable]}
