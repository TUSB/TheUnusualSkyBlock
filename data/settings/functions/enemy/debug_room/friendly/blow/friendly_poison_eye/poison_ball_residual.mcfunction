...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Time:[{Name:"Kill"}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Global:true,Target:{Look:"player",Radius:2d,IgnoreBlocks:true}},{Name:"RandomChance",Chance:0.75d}],Name:"Function",Tags:[DebugRoom,Friendly,Blow,FriendlyPoisonEye,PoisonEffect]},{Name:"Kill"}]}]}]}
