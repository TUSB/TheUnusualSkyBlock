### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Team:"Friendly",CustomName:'{"translate":"ポイズンアイ"}',Silent:1b,ActiveEffects:[{Id:14b,Amplifier:1b,Duration:2147483647,ShowParticles:0b},{Id:28b,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],NoGravity:true,IsBaby:true,Team:"Friendly",AbsorptionAmount:100f,DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI]}
