...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Blink",Count:3,Chance:1d,TriggerOn:{Physical:true}}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:40,Max:100,Current:0},Loop:{Max:1,Current:0},Call:[{}]}]}]}
