### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"基準マン","color":"#FFFFFF"}',DeathLootTable:"empty",Tags:[Mob,DelayedData,DelayedData,HasAI,CallOnInit]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Message",Message:'{"text":"こんにちは、私は標準的な能力のゾンビです。"},Condition:[{Name:"HasTarget",Target:{Look:"player",Radius:8}}]'}]}
