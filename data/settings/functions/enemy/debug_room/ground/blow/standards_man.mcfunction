### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"基準マン","color":"#FFFFFF"}',DeathLootTable:"empty",Tags:[Mob,DelayedData,HasAI,CallOnInit]}
