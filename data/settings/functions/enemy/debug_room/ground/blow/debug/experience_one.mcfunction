### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:wither",Tags:[Mob,HasAI],CustomNameVisible:true,CustomName:'{"translate":"経験値1","color":"#FFFFFF"}',DeathLootTable:"empty"}
