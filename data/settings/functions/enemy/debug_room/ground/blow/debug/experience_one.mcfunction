### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:wither",CustomNameVisible:true,CustomName:'{"translate":"経験値1","color":"#FFFFFF"}',DeathLootTable:"empty",Tags:[Mob,DelayedData,HasLootTable]}
