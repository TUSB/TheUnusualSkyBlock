### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:husk",CustomName:'"定期的に突進行動をしてくるハスク"',Tags:[Mob,DelayedData,DelayedData,HasAI]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Target:{Look:"player",Radius:8d},Move:{Front:2d},Rotate:[0f,0f]}]}
