...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Target:{Look:"player",Radius:5d},Move:{Front:2d,Side:1d},Rotate:[10f,0f],Skill:[{Interval:{Min:30,Max:100,Current:60},Loop:{Max:1,Current:1},Call:[{Name:"A"}]},{Interval:{Min:70,Max:90,Current:80},Loop:{Max:2,Current:2},Call:[{Name:"B"}]}],Exit:{Time:1200}},{Target:{Look:"player",Radius:5d},Move:{Front:2d,Side:1d},Rotate:[10f,0f],Skill:[{Interval:{Min:10,Max:80,Current:30},Loop:{Max:1,Current:1},Call:[{Name:"A"}]},{Interval:{Min:5,Max:30,Current:10},Loop:{Max:2,Current:2},Call:[{Name:"B"}]},{Interval:{Min:20,Max:20,Current:10},Loop:{Max:5,Current:5},Call:[{Name:"C"}]}],Exit:{Time:600}}]}
