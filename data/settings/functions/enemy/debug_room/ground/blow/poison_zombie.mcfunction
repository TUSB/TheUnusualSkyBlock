### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,DelayedData,DelayedData,HasAI,CallOnDamage]}
...
data modify storage tusb_mob: "遅延ステータス"."ステータス"."物理防御力" set value 55
data modify storage tusb_mob: "遅延ステータス"."ステータス"."魔法攻撃力" set value 33
data modify storage tusb_mob: "遅延ステータス"."ステータス"."魔法防御力" set value 22
# AI
