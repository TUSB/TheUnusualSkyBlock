### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:silverfish",Passengers:[{id:"minecraft:potion",Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:harming"}}}],PortalCooldown:1000000,Tags:[Mob,DelayedData,CooldownRequired]}
