### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:villager",Tags:[Mob,HasAI,CallOnInit],CustomName:'{"translate":"デバッグマン","color":"#FFFFFF"}',DeathLootTable:"empty"}
