### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnTimeOut,TickingRequired,HideLevel],CustomName:'{"translate":"Grumm","color":"#000000"}',IsBaby:true,Silent:true,ActiveEffects:[{Id:14,Amplifier:127b,Duration:-1,ShowParticles:false},{Id:18,Amplifier:127b,Duration:-1,ShowParticles:false},{Id:28,Amplifier:127b,Duration:-1,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty"}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Time:[{Condition:[{Name:"HasTarget",Global:true,Target:{Look:"Player",Radius:24d,IgnoreBlocks:false}}],Name:"Spawn",SpawnEntities:[[{Tags:[DebugRoom,Ground,Shoot,SecurityPolePrototype,Body],Level:1}],[{Tags:[DebugRoom,Ground,Shoot,SecurityPolePrototype,Main],Level:1}]],Count:1}],TurnCount:2,Turn:[{Index:1,Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:20,IgnoreBlocks:false}}]}},{Index:2,Skill:[{Call:[{Name:"DelayAction",Tags:[Casting,Cast,Normal]}]},{Interval:{Min:40,Max:40,Current:40},Call:[{Condition:[{Name:"HasTarget",Global:true,Target:{Look:"Player",Radius:24d,IgnoreBlocks:false}}],Settings:[{Name:"Align",Vector:[X,Y,Z],Center:[X,Z]},{Name:"Direction",Direction:[0f,-90f],Absolute:{Vertical:true},Speed:2d}],Name:"Spawn",SpawnEntities:[[{Tags:[DebugRoom,Ground,Shoot,SecurityPolePrototype,Body],Level:1}],[{Tags:[DebugRoom,Ground,Shoot,SecurityPolePrototype,Main],Level:1}]],Count:1},{Name:"Kill"}]}],Exit:{Loop:{Max:2,Current:2}}}]}
