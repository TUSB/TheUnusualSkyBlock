...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:64d,IgnoreBlocks:true},Anchor:"Eyes"}],Name:"Step",Speed:1.2d,SpeedRange:0.4d}],Attack:[{Name:"Damage",Player:{Damage:0d,DamageType:[Global]},Distance:{Max:0.1d},AEC:{Particle:"block air",Duration:10,Radius:0.5f,Effects:[{Id:17b,Amplifier:1b,Duration:200}]}}]}
