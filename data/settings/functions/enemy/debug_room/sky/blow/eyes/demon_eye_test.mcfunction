### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"テストデーモンアイ","color":"#FFFFFF"}',ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticles:0b}],NoGravity:true,IsBaby:true,Silent:true,Tags:[Mob,DelayedData,HasAI]}
