...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Settings:[{Name:"Facing",Target:{Look:"Player",Radius:32d,IgnoreBlocks:true}}],Name:"Step",Speed:0.6d,SpeedRange:0.1d}],Tick:[{Name:"Function",Tags:[DebugRoom,Sky,Shoot,NightmareEye,StraightAppearance]}]}
