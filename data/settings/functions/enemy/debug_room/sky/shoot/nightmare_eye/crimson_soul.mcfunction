...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Tick:[{Name:"Function",Tags:[DebugRoom,Sky,Shoot,NightmareEye,CrimsonSoulAppearance]}],TurnCount:4,Turn:[{Index:1,Target:{Look:"Player",Radius:64d},Move:{Front:0.2d},Rotate:[-1f,-1f],Skill:[{Interval:{Min:60,Max:60,Current:1},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:30d,IgnoreBlocks:true}}],Name:"ChangeTurn",Random:true}]}],Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:15d,IgnoreBlocks:true}}]}},{Index:2,Target:{Look:"Player",Radius:64d},Move:{Front:0.1d,Up:0.25d},Rotate:[-1f,-1f],Skill:[{Interval:{Min:60,Max:60,Current:1},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:30d,IgnoreBlocks:true}}],Name:"ChangeTurn",Random:true}]}],Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:15d,IgnoreBlocks:true}}]}},{Index:3,Target:{Look:"Player",Radius:64d},Move:{Front:0.1d,Up:-0.25d},Rotate:[-1f,-1f],Skill:[{Interval:{Min:60,Max:60,Current:1},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:30d,IgnoreBlocks:true}}],Name:"ChangeTurn",Random:true}]}],Exit:{Condition:[{Name:"HasTarget",Target:{Look:"Player",Radius:15d,IgnoreBlocks:true}}]}},{Index:4,Target:{Look:"Player",Radius:64d},Move:{Front:-0.2d},Rotate:[-1f,-1f],Skill:[{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{}]}],Exit:{Condition:[{Name:"HasTarget",Inverse:true,Target:{Look:"Player",Radius:20d,IgnoreBlocks:true}}]}}]}
