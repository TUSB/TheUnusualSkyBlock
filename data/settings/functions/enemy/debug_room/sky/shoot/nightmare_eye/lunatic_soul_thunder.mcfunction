...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Damage",Player:{DamageType:[Global,Fire,Blast]},Distance:{Min:0.1d,Max:1d}},{Condition:[{Name:"RandomChance",Chance:0.4d}],Name:"Function",Tags:[DebugRoom,Sky,Shoot,NightmareEye,Paralysis]},{Name:"Function",Tags:[DebugRoom,Sky,Shoot,NightmareEye,LunaticSoulThunderAppearance]},{Name:"Kill"}],Attack:[{Condition:[{Name:"RandomChance",Chance:0.9d}],Name:"Function",Tags:[DebugRoom,Sky,Shoot,NightmareEye,Paralysis]}]}
#Function
