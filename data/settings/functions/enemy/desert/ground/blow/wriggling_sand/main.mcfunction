...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]}],Death:[{Name:"Function",Tags:[Global,Event,Function,DamageSound,Dark]}],Damage:[{Name:"Function",Tags:[Global,Event,Function,DamageSound,Dark]}],TurnCount:1,Turn:[{Index:1,Skill:[{Interval:{Min:10,Max:10,Current:10},Loop:{Max:1,Current:1},Call:[{Condition:[{Name:"CheckBlock",Block:[Lava],Logic:"OR"},{Name:"MinMP",MP:80,Inverse:1b}],Name:"Kill"},{Condition:[{Name:"HasTarget",Target:{Look:"Enemy",Radius:5}}],Name:"Function",Tags:[Desert,Ground,Blow,WrigglingSand,Parasite]},{Condition:[{Name:"HasTarget",Target:{Look:"Friendly",Radius:5d}}],Name:"Damage",Player:{BypassArmor:true,BypassResistance:true},Distance:{Min:0.1d,Max:2d},AEC:{Particle:"dust",Color:16719360,Duration:10,Radius:0.5f,Effects:[{Id:14,Amplifier:8b,Duration:5,ShowParticles:false},{Id:14,Amplifier:3b,Duration:120,ShowParticles:false}]}},{Name:"Function",Tags:[Global,Event,Function,CommonExe,BlockAlign]},{Name:"SmartMotion",Stop:true}]},{Interval:{Min:1,Max:1,Current:1},Loop:{Max:1,Current:1},Call:[{Settings:[{Name:"Rotation",Direction:[-180f,-180f],DirectionRange:[360f,360f]}],Condition:[{Name:"Function",Tags:[Desert,Ground,Blow,WrigglingSand,Spread]}],Name:"SmartMotion",TP:true,Start:true,Rotation:{Horizontal:15f},Speed:{Set:100d,Range:50d},Gravity:{Set:500d}}]}]}]}
