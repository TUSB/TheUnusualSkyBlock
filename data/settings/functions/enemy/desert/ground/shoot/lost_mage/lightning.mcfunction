...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Initial:[{Name:"Damage",Player:{DamageType:[Global,Fire,Blast]},Distance:{Min:0.1d,Max:1d}},{Condition:[{Name:"RandomChance",Chance:0.4d}],Name:"Function",Tags:[Desert,Ground,Shoot,LostMage,LightningParalysis]},{Name:"Kill"}],Attack:[{Condition:[{Name:"RandomChance",Chance:0.6d}],Name:"Function",Tags:[Desert,Ground,Shoot,LostMage,LightningParalysis]}]}
#Function
