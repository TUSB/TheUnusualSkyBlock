### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:snowball",PortalCooldown:300,Tags:[DelayedData,HasAI,CallOnInit,CallOnTimeOut,TickingRequired]}
