...
effect give @a[distance=..3] minecraft:mining_fatigue 120 3
effect give @a[distance=..3] minecraft:hunger 20 4
effect give @a[distance=..3] minecraft:jump_boost 20 19
effect give @a[distance=..3] minecraft:nausea 20 0

particle minecraft:dust 0 0 0 2 ~ ~ ~ 1.5 0 1.5 0.01 50 force @a[distance=..64,tag=ShowParticles]
