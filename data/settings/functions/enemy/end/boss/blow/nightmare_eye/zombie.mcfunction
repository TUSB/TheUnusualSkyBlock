### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"ナイトメアゾンビ","color":"#FFFFFF"}',PortalCooldown:600,Tags:[Mob,Enemy,DelayedData,TickingRequired]}
