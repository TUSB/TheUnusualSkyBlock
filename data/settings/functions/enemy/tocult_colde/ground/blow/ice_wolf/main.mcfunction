### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:wolf",CustomName:'{"translate":"アイスウルフ","color":"#FFFFFF"}',AngerTime:2147483647,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnAttack,CallOnTick,HasLootTable]}
...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Attack:[{Condition:[{Name:"RandomChance",Chance:0.15d}],Name:"Function",Tags:[TocultColde,Ground,Blow,IceWolf,Freeze]}],Tick:[{Name:"Function",Tags:[TocultColde,Ground,Blow,IceWolf,Appearance]}]}
