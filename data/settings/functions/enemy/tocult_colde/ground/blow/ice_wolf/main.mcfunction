### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:wolf",CustomName:'{"translate":"アイスウルフ","color":"#FFFFFF"}',AngerTime:2147483647,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnAttack,CallOnTick]}
