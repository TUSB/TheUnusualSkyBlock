...
data modify storage tusb_mob: "即時ステータス"."見た目" set value {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:66}},{}],ArmorItems:[{},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:37590}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:37590}}},{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{Unbreakable:true,CustomModelData:14}}],ArmorDropChances:[-1E40f,-1E40f,-1E40f,-1E40f]}
