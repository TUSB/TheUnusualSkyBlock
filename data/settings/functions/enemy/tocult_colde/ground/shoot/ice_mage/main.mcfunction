### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:skeleton",Silent:1b,CustomName:'{"translate":"アイスメイジ","color":"#FFFFFF"}',DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,HasAI,CallOnTick,HasLootTable]}
