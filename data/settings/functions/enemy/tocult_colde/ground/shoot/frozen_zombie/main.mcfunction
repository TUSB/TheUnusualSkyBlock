### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:zombie",CustomName:'{"translate":"フローズンゾンビ"}',PortalCooldown:2000,Tags:[Mob,Enemy,DelayedData,HasAI,CooldownRequired,HasLootTable]}
