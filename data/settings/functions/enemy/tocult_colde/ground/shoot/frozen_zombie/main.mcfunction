...
# AI
data modify storage tusb_mob: "遅延ステータス".AI set value {Turn:[{Skill:[{Interval:{Min:20,Max:100,Current:40},Call:[{Name:"MergeNBT",NBT:{HandItems:[{id:"minecraft:snowball",Count:1b},{}]}}]},{Interval:{Min:20,Max:35,Current:20},Call:[{Condition:[{Global:1b,Name:"HasTarget",Target:{Look:"player",Radius:16,IgnoreBlocks:1b}}],Name:"MergeNBT",NBT:{HandItems:[]}},{Name:"Spawn",Direction:[30f,-60f],Speed:1.5d,SpawnEntities:[[{Tags:[TocultColde,Ground,Shoot,FrozenZombie,Snowball],Level:20}]]}]}]}]}
