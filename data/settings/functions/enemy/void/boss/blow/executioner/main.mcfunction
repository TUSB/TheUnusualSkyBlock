### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:wither_skeleton",CustomName:'{"translate":"執行者","color":"#AA00FF","bold":true}',ActiveEffects:[{Id:14b,Amplifier:127b,Duration:2147483647,ShowParticles:false}],PortalCooldown:6666,Tags:[Mob,Enemy,DelayedData,HasAI,CallOnDeath,CallOnDamage,CooldownRequired,HasLootTable]}
