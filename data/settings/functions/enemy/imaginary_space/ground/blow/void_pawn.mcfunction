### 即時ステータス
data modify storage tusb_mob: "即時ステータス"."ベース" set value {id:"minecraft:husk",CustomName:'{"translate":"虚無の手先","color":"#FF0000","bold":true}',ActiveEffects:[{Id:14,Amplifier:127b,Duration:2147483647,ShowParticles:false},{Id:28,Amplifier:127b,Duration:2147483647,ShowParticles:false}],PortalCooldown:3000,DeathLootTable:"empty",Tags:[Mob,Enemy,DelayedData,TickingRequired]}
