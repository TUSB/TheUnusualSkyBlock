...
execute positioned ~ ~500 ~ anchored eyes run summon slime ^ ^-0.2 ^1 {DeathLootTable:"minecraft:empty",Size:0,AbsorptionAmount:2.5f,Tags:["Freeze"],Health:0.1f,ActiveEffects:[{Id:20b,Amplifier:1b,Duration:80,ShowParticles:false},{Id:14b,Duration:2147483647,ShowParticles:false}],NoAI:true,NoGravity:true,Invulnerable:true,Silent:true}
