...
execute if entity @s[tag=ReversedOnHurt,scores={DecrementTimer=10}] store result entity @s Motion[0] double -0.001 run data get entity @s Motion[0] 1000
# execute if entity @s[tag=ReversedOnHurt,scores={DecrementTimer=10}] store result entity @s Motion[1] double -0.001 run data get entity @s Motion[1] 1000
execute if entity @s[tag=ReversedOnHurt,scores={DecrementTimer=10}] store result entity @s Motion[2] double -0.001 run data get entity @s Motion[2] 1000
