...
execute store result entity 0-0-FF-0-FF Rotation[0] float 1 run scoreboard players get @s CircleAngle
...
execute as @e[tag=Edge,sort=nearest,limit=1] at @s facing entity @e[tag=Edge,sort=furthest,limit=1] feet positioned ^ ^2000 ^ rotated as 0-0-FF-0-FF rotated ~ 0 positioned ^ ^ ^-10 facing entity @s feet positioned ^ ^ ^2000 rotated as 0-0-FF-0-FF rotated ~ 0 positioned ^ ^ ^10 facing entity @s feet positioned as @s positioned as @e[tag=Edge,sort=furthest,limit=1] positioned ^ ^ ^2000 facing entity @s feet positioned ^ ^ ^2000 run tp @e[tag=Point,limit=1] ~ ~ ~ ~ ~
