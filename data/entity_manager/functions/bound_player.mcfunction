...
execute as @a[limit=1,sort=nearest,gamemode=!spectator,gamemode=!creative,distance=..64] run function calc_manager:get/pos1
execute unless entity @a[limit=1,sort=nearest,gamemode=!spectator,gamemode=!creative,distance=..64] run function calc_manager:get/pos1
