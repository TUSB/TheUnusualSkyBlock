...
execute if score $Inn Global matches 0 run particle minecraft:smoke ~ ~ ~ 0 0 0 0.3 30 force @a[tag=ShowParticles]
execute if score $Inn Global matches 0 run particle minecraft:barrier ~-3 ~ ~-3 0 0 0 0 0 force @a[tag=ShowParticles]
execute if score $Inn Global matches 0 run particle minecraft:barrier ~-3 ~ ~3 0 0 0 0 0 force @a[tag=ShowParticles]
execute if score $Inn Global matches 0 run particle minecraft:barrier ~3 ~ ~-3 0 0 0 0 0 force @a[tag=ShowParticles]
execute if score $Inn Global matches 0 run particle minecraft:barrier ~3 ~ ~3 0 0 0 0 0 force @a[tag=ShowParticles]
execute if score $Inn Global matches 0 run particle minecraft:barrier ~-3 ~6 ~-3 0 0 0 0 0 force @a[tag=ShowParticles]
execute if score $Inn Global matches 0 run particle minecraft:barrier ~-3 ~6 ~3 0 0 0 0 0 force @a[tag=ShowParticles]
execute if score $Inn Global matches 0 run particle minecraft:barrier ~3 ~6 ~-3 0 0 0 0 0 force @a[tag=ShowParticles]
execute if score $Inn Global matches 0 run particle minecraft:barrier ~3 ~6 ~3 0 0 0 0 0 force @a[tag=ShowParticles]
...
execute if score $Inn Global matches 1 run particle minecraft:happy_villager ~ ~3 ~ 3 3 3 0 100 force @a[tag=ShowParticles]
execute if score $Inn Global matches 1 run particle minecraft:firework ~ ~3 ~ 3 3 3 0 100 force @a[tag=ShowParticles]
