...
execute if data storage calc: SearchForward{Stop:[Mob]} positioned ^ ^ ^1 positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[tag=Mob,dx=0,dy=0,dz=0] run data modify storage calc: SearchForward.Loop set value 0
