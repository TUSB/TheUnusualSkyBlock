...
# 最上位が１なら残り値を１減らす
execute store result score _ _ run data get storage calc: Bit.Flags
execute if score _ _ matches ..-1 store result storage calc: Bit._ int 1 run data get storage calc: Bit._ 0.999999999
