...
# 探索
execute positioned ^ ^ ^5 as @e[distance=..5,tag=Mob] positioned as @s positioned ^ ^ ^2000 facing entity @a[tag=CasterPlayer,limit=1] eyes positioned ^ ^ ^2000 positioned ~-0.5 ~-0.5 ~-0.5 if entity @s[dx=0,dy=0,dz=0] run tag @s add CasterTargetCand
