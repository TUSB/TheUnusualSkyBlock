...
execute store result score _ _ run data get entity 0-0-0-0-0 Rotation[1] 10
execute if score _ _ matches -899..898 store result score @s[type=arrow] ArrowRotation run data get entity 0-0-0-0-0 Rotation[0] -1
