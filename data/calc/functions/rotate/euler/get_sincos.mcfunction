...
data modify storage calc: Rotate.Triangle.Y set from storage calc: Triangle.SinCos

## X+Yのsincosを取得
execute store result storage calc: Triangle.Rotation float 1 run scoreboard players get $X+Y _
function calc:triangle/sincos
data modify storage calc: Rotate.Triangle.X+Y set from storage calc: Triangle.SinCos
...
function calc:triangle/sincos
data modify storage calc: Rotate.Triangle.X+Z set from storage calc: Triangle.SinCos
...
function calc:triangle/sincos
data modify storage calc: Rotate.Triangle.Y+Z set from storage calc: Triangle.SinCos
