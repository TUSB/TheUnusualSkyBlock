...
execute store result score _ sm.X run data get storage calc: Rotate.Quaternion.AxisVector[0] 1000
execute store result score _ sm.Y run data get storage calc: Rotate.Quaternion.AxisVector[1] 1000
execute store result score _ sm.Z run data get storage calc: Rotate.Quaternion.AxisVector[2] 1000