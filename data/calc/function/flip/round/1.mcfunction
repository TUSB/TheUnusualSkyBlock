...
execute store result score __ _ run data get storage calc: Rotation.1[0] 1000
...
execute store result storage calc: Rotation.1[0] float 0.001 run scoreboard players get __ _
execute store result storage calc: Rotation.1[1] float 0.001 run scoreboard players get __ Calc
