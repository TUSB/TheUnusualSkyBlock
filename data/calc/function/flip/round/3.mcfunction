...
execute store result score __ Calc run data get storage calc: Rotation.3[1] 1000
...
execute store result storage calc: Rotation.3[0] float 0.001 run scoreboard players get __ _
execute store result storage calc: Rotation.3[1] float 0.001 run scoreboard players get __ Calc
