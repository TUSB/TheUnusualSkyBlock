...
execute store result storage calc: SearchAbove.Pos int 1 run scoreboard players operation _ Calc += _ _
...
execute if score _ _ matches 320.. run data modify storage calc: SearchAbove set value {NothingAbove:1b}
