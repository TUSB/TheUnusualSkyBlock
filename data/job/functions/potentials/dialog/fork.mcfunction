...
execute if score @s PotentialTrigger matches 21 run function job:potentials/dialog/sublevel
execute if score @s PotentialTrigger matches 31 run scoreboard players set @s PotentialTrigger 131
execute if score @s PotentialTrigger matches 32 unless score @s PotentialLock matches 1.. run function job:potentials/dialog/reset
