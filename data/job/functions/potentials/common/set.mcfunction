...
execute if score @s PotentialTrigger matches 122..149 run function job:status/operation_start
execute if score @s PotentialTrigger matches 122..149 run tag @s add OhMyDatCall
