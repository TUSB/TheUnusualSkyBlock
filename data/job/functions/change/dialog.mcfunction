...
execute if score _ CanChangeJobFlag matches 00.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"text":" < "},{"text":"K","font":"icon","color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"この職業はここで変更できないようだ……"}}},{"text":" >"}]'
...
execute if score _ CanChangeJobFlag matches 00.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"text":" < "},{"text":"N","font":"icon","color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"この職業はここで変更できないようだ……"}}},{"text":" >"}]'
...
execute if score _ CanChangeJobFlag matches 00.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"text":" < "},{"text":"H","font":"icon","color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"この職業はここで変更できないようだ……"}}},{"text":" >"}]'
...
execute if score _ CanChangeJobFlag matches 00.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"text":" < "},{"text":"W","font":"icon","color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"この職業はここで変更できないようだ……"}}},{"text":" >"}]'
...
execute if score _ CanChangeJobFlag matches 00.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"text":" < "},{"text":"B","font":"icon","color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"この職業はここで変更できないようだ……"}}},{"text":" >"}]'
...
execute if score _ CanChangeJobFlag matches 00.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"text":" < "},{"text":"S","font":"icon","color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"この職業はここで変更できないようだ……"}}},{"text":" >"}]'
...
execute if score _ CanChangeJobFlag matches 00.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"text":" < "},{"text":"P","font":"icon","color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"この職業はここで変更できないようだ……"}}},{"text":" >"}]'
...
execute if score _ CanChangeJobFlag matches 00.. run data modify block 2 3 2 front_text.messages[0] set value '[{"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true},{"text":" < "},{"text":"T","font":"icon","color":"gray","hoverEvent":{"action":"show_text","value":{"translate":"この職業はここで変更できないようだ……"}}},{"text":" >"}]'

execute if score @s ChangeJobLock matches ..0 run tellraw @s {"block":"2 3 2","nbt":"front_text.messages[0]","interpret":true}
