...
execute if entity @s[advancements={area:system/island_capture={skylands.046=true}}] run data modify storage area: capture.skylands.046 set value true
# ##flying_island
...
title @a title [{"translate":"島 攻略率"},{"score":{"name": "_","objective": "_"}},"/",{"score":{"name": "#","objective": "_"}},"(",{"score":{"name": "#","objective": "Calc"}},"%)"]
