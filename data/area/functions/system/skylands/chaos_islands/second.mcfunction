...
# クリスタルを召喚する
    ...
    execute unless entity @e[tag=Spawner,x=259,y=95,z=-894,dx=0,dy=0,dz=0] unless entity @e[tag=Spawner,x=188,y=93,z=-923,dx=0,dy=0,dz=0] unless entity @e[tag=Spawner,x=243,y=95,z=-957,dx=0,dy=0,dz=0] run data modify storage main: System.Islands.Chaos.002 set value 1b
