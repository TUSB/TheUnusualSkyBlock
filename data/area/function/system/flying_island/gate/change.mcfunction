...
execute if score _ _ matches 0 if data storage area: {FlyingIslandGate:"PrisonGate"} run function area:system/flying_island/gate/trade_gate
execute if score _ _ matches 0 if data storage area: {FlyingIslandGate:"TradeGate"} run function area:system/flying_island/gate/water_gate
execute if score _ _ matches 0 if data storage area: {FlyingIslandGate:"WaterGate"} run function area:system/flying_island/gate/prison_gate
...
# 1日後にまた実行
schedule function area:system/flying_island/gate/change 1d replace
