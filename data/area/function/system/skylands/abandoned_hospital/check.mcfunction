...
execute if entity @s[advancements={area:system/skylands/abandoned_hospital={flower_pot=true}}] if block -113 186 -665 #area:potted_pots if block -113 186 -663 #area:potted_pots run summon marker -114.5 185.5 -664.5 {Tags:[HospitalGimmic]}
