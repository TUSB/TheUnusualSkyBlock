...
execute rotated ~ 0 run summon minecraft:item ^ ^0.5 ^2.5 {NoGravity:true,Motion:[0d,0.005d,0d],Item:{id:"minecraft:clock",count:1,components:{enchantment_glint_override:true,custom_data:{NoHold:1b}}},Age:5930,PickupDelay:32767}
