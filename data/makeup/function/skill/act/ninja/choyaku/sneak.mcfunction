#> makeup:skill/act/ninja/choyaku/sneak
#
# 跳躍スニーク演出
...
execute if score @s Choyaku < _ Choyaku run playsound minecraft:entity.witch.throw player @a[distance=..16] ~ ~ ~ 1 0.4
execute if score @s Choyaku >= _ Choyaku run playsound minecraft:item.trident.riptide_1 player @a[distance=..16] ~ ~ ~ 1 1.2
