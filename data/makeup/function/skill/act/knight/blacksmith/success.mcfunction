...
execute rotated ~ 0 run summon minecraft:item ^ ^1.2 ^0.5 {NoGravity:1b,Item:{id:"minecraft:iron_sword",count:1b,components:{enchantments:{sharpness:1},custom_data:{NoHold:1b}}},Age:5950,PickupDelay:32767}
