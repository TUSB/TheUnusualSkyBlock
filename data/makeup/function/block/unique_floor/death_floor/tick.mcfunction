#> makeup:block/unique_floor/death_floor/tick
...
playsound minecraft:ambient.crimson_forest.mood block @s ~ ~ ~ 0.5 2
## マジックシールド
execute if score @s MagicShield matches ..999 run playsound minecraft:block.anvil.land block @a[distance=..16] ~ ~ ~ 0.5 2
