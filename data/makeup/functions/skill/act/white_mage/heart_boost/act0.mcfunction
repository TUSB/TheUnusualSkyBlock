...
execute rotated ~ 0 run summon minecraft:item ^ ^0.3 ^2 {NoGravity:true,Motion:[0d,0.05d,0d],Item:{id:"minecraft:enchanted_golden_apple",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:sharpness"}],NoHold:1b}},Age:5960,PickupDelay:32767}
