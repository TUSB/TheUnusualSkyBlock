...
execute rotated ~ 0 run summon minecraft:item ^ ^0.5 ^2.5 {NoGravity:true,Motion:[0d,0.005d,0d],Item:{id:"minecraft:clock",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:sharpness"}],NoHold:1b}},Age:5930,PickupDelay:32767}
