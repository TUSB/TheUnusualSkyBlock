...
execute rotated ~ 0 run summon minecraft:item ^ ^1.0 ^1 {NoGravity:1b,Item:{id:"minecraft:mushroom_stew",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:sharpness"}],NoHold:1b}},Age:5980,PickupDelay:32767}
