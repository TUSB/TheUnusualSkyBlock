playsound tusb.levelup hostile @a[distance=..32] ~ ~ ~ 1.0 1.8
...
execute as @e[tag=Initializing,limit=1] store result entity @s RadiusPerTick float 0.00125 run scoreboard players get _ _
