...
### 繰り返し回数
execute store result score @s RepeaterCount at 1-0-0-0-0 run data get entity @e[distance=0,tag=DataHolder,limit=1] Item.tag.Parameter.MoveSettings.Repeater.RepeatCount 1
