...
### 定義持ちなら読み込み
execute if score $MoveSettings ItSelf matches 1.. run function behaviour_manager:definition_reader/moves/read_data
### 定義なしならデフォルト読み込み
execute if score $MoveSettings ItSelf matches ..0 run function behaviour_manager:definition_reader/moves/default_data
