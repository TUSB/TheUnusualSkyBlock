...
execute if score _ _ matches 1.. unless block ~ ~-3 ~ minecraft:warped_wart_block at @s run function makeup:block/unique_floor/drop_floor
execute if score _ _ matches 1.. if block ~ ~-3 ~ minecraft:warped_wart_block positioned ~ ~-1 ~ run function block:unique_floor/drop_floor
