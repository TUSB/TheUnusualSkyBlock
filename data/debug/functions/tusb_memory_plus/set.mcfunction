...
#Loreセット
#スキル名
data modify block 2 3 2 front_text.messages[0] set value '[{"text":"","color":"white","italic":false},{"storage":"skill:","nbt":"Skill.Icon","font":"icon","color":"light_purple"},{"text":" "},{"storage":"skill:","nbt":"Skill.Skill"}]'
