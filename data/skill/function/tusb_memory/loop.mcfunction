...
execute if data storage skill: Skill.Damage in area:control_area run data modify block 2 3 2 front_text.messages[0] set value '{"storage":"skill:","nbt":"damage_json.damage","italic":false,"interpret":true}'
