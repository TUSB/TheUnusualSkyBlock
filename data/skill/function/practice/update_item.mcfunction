...
#インターバル適用
execute store result storage item: Item.components."minecraf:custom_data".Skill.LastUsed int 1 run time query gametime
execute unless data storage item: Item.components."minecraf:custom_data".Skill{Interval:0} run data modify storage item: Item.components."minecraf:custom_data".Skill.ShowInterval set value 1b
