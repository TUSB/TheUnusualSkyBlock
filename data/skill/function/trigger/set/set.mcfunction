...
execute unless data storage item: Item.components."minecraft:custom_data".Skill if data storage item: Item.components."minecraft:item_name" run data modify storage item: Item.components."minecraft:custom_data".UniqueName set value 1b
#以前のスキルLoreを削除
...
execute unless data storage item: Item.components."minecraft:custom_data".UniqueName run data modify storage item: Item.components."minecraft:item_name" set from block 2 3 2 front_text.messages[0]
execute unless data storage item: Item.components."minecraft:custom_data".UniqueName store result storage skill: Skill.LoreCount int 0.99999 run data get storage skill: Skill.LoreCount
#固有のNameがあればスキル名をLoreに入れる
execute if data storage item: Item.components."minecraft:custom_data".UniqueName run data modify storage item: Item.components."minecraft:lore" append from block 2 3 2 front_text.messages[0]
#説明
...
#不要なNBT削除
data remove storage item: Item.components."minecraft:custom_data".Skill.Lore
data remove storage item: Item.components."minecraft:custom_data".Skill.ClickEvent
#プレイヤーのアイテム更新
