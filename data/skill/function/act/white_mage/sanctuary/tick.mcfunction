#> skill:act/white_mage/sanctuary/tick
#
# サンクチュアリtick
scoreboard players operation _ Level = @s Level
execute if score $Ticks Count matches 1 as @e[predicate=entity:friendly,distance=..8] run function skill:act/white_mage/sanctuary/tick_friendly
