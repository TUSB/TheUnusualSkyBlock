#> skill:act/white_mage/holy/act0
#
# ホーリー発動
...
# 投射物を召喚
execute anchored eyes run summon arrow ^ ^ ^0.5 {Tags:[Skill,Holy,NativeTask,FlyingRequired,KillInGround,IgnoreReflection],damage:1}
