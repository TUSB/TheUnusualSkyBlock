...
execute if score @s Interval matches ..0 if entity @e[tag=Enemy,distance=..15,limit=1,sort=nearest] run function skill:act/white_mage/holy/re_aim
...
execute as @e[type=!#undead,tag=Enemy,distance=..5] run function skill:damage/apply/
...
execute as @e[type=#undead,tag=Enemy,distance=..5] at @s run function skill:act/white_mage/holy/undead
