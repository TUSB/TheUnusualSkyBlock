#> skill:act/ninja/isukumi/act0
#
# 居縮発動

function makeup:skill/act/ninja/isukumi/act

execute if score _ Level matches 1 run scoreboard players set _ Isukumi 100
execute if score _ Level matches 2 run scoreboard players set _ Isukumi 200
execute if score _ Level matches 3 run scoreboard players set _ Isukumi 400
