...
# スニークしていれば範囲化
execute unless score @s SneakTime matches 1.. run return fail
scoreboard players remove _ Calc 1
execute as @a[distance=0.1..15] at @s run function skill:act/ninja/yokake/fork
