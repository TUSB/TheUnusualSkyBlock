...
#次の消費MP軽減量を計算
execute if score _ Level matches 1 run scoreboard players set _ _ 2
execute if score _ Level matches 2 run scoreboard players set _ _ 3
