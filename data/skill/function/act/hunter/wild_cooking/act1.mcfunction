#> skill:act/hunter/wild_cooking/act1
#
# ワイルドクッキング発動

# 焚き火召喚
summon snowball ^ ^ ^ {Item:{id:"minecraft:firework_star",count:1b,components:{custom_model_data:{floats:[10001]}}},Passengers:[{id:"minecraft:block_display",Tags:[Skill,NativeTask,WildCooking],Glowing:1b,block_state:{Name:"minecraft:campfire"},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[1f,1f,1f],translation:[-0.5f,0f,-0.5f]}}]}
