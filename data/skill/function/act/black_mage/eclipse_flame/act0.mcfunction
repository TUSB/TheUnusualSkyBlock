#> skill:act/black_mage/eclipse_flame/act0
#
# エクリプスフレイム発動
...
# 矢を召喚
execute anchored eyes run summon arrow ^ ^ ^0.5 {item:{id:"minecraft:tipped_arrow",count:1,components:{"minecraft:potion_contents":{custom_color:13720589}}},Tags:[Skill,EclipseFlameBullet,NativeTask,FlyingRequired,KillInGround],damage:1,Passengers:[{id:"minecraft:area_effect_cloud",Duration:1200,Tags:[Skill,EclipseFlameCore,NativeTask]}]}
