...
execute if data storage mob_data: Call.Speed.Add store result score _ _ run data get storage mob_data: Call.Speed.Set
...
execute if data storage mob_data: Call.Gravity.Add store result score _ _ run data get storage mob_data: Call.Gravity.Set
