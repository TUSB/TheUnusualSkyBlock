###Heal
### # _ 回復最大範囲 (1mごと、最大32m,デフォルトで8m,100倍で取得)
### _ Calc ヒール量(魔法攻撃力 * 倍率)
### @s _ 倍率(10000倍で取得,デフォルトで1.0倍)
### @s Calc 定数(10000)
scoreboard players set # _ 800
...
###範囲調整
execute if score # _ matches 3201.. run scoreboard players set # _ 3200
execute if score # _ matches ..-1 run scoreboard players set # _ 0
