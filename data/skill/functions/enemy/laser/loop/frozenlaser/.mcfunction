#ダメージ処理
execute positioned ^ ^ ^0.5 as @a[gamemode=!creative,gamemode=!spectator,scores={SnowballTime=0..},dx=0,dy=0,dz=0] run function skill:enemy/laser/loop/frozenlaser/damege
