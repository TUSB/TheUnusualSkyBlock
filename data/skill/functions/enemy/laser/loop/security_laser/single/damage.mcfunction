data modify storage score_damage: Argument.DeathCause set value '[{"selector":"@s"},{"translate":"は"},{"nbt":"MobName","storage":"score_damage:","interpret":true},{"translate":"によって蒸発させられた。"}]'
