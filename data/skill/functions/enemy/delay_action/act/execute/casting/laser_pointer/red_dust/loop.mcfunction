...
execute unless data storage mob_data: ExecutingAction{Loop:0} positioned ^ ^ ^0.5 if block ~ ~ ~ #main:no_collision run function skill:enemy/delay_action/act/execute/casting/laser_pointer/red_dust/loop