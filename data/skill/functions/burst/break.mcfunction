...
execute if score @s Job matches 6 run tellraw @a ["",{"translate":"%1$sは%2$sを纏った！！！","color":"green","with":[{"selector":"@s"},{"text":"召喚士のオーラ","hoverEvent":{"action":"show_text","contents":{"translate":"範囲内の敵にどれか１つの弱点属性を付与する。"}}}]}]
