...
data modify block 0 4 0 Text1 set value '[{"text":"","color":"white","italic":false},{"text":" 残り使用回数: "},{"storage":"item:","nbt":"Item.tag.Skill.Count"}]}}]'
data modify storage item: Item.tag.display.Lore[-1] set from block 0 4 0 Text1
#カウント0で破壊
