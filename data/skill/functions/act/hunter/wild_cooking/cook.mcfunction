...
execute if score _ Calc <= _ _ run data modify entity @e[type=item,nbt={Item:{tag:{WildCooking:1b}}},tag=!Initialized,distance=0,limit=1] {} merge value {Glowing:1b,Age:4800}
#演出
