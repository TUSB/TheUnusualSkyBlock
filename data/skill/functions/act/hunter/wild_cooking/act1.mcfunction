...
#焚き火召喚
summon snowball ^ ^ ^ {Item:{id:"minecraft:firework_star",Count:1b,tag:{CustomModelData:10001}},Passengers:[{id:"minecraft:block_display",Tags:[Skill,NativeTask,WildCooking],Glowing:1b,block_state:{Name:"minecraft:campfire"}}]}
