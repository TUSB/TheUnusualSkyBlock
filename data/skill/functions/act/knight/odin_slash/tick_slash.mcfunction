...
execute if score @s OdinSlash matches 13..26 positioned ^ ^-2 ^10 as @e[dx=19,dy=3,dz=19,tag=Mob] run function skill:damage/apply/
execute if score @s OdinSlash matches 0 as @e[distance=..7,tag=Mob] run function skill:damage/apply/
