...
# 弾召喚
summon minecraft:armor_stand ~ ~0.8 ~ {Tags:[OdinSlash2,CooldownRequired,NativeTask],PortalCooldown:10,NoGravity:true,Marker:true,Invisible:true}
execute rotated ~60 -30 run tp @e[tag=!Initialized,limit=1] ~ ~0.8 ~ ~ ~
