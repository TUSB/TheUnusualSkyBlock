...
tellraw @s [{"translate":"アナライズ：【 %1$s 】","with":[{"selector":"@e[tag=Mob,distance=..0.01,sort=nearest,limit=1]"}]}]
...
execute as @e[tag=Mob,tag=AnalyseLog,distance=..0.01,sort=nearest,limit=1] run function oh_my_dat:please
