...
#投射物を召喚
execute anchored eyes run summon arrow ^ ^ ^0.5 {Tags:[Skill,Shuriken,NativeTask,FlyingRequired,KillInGround,HasSkillSnowball],NoGravity:1b,damage:1,Color:3752270,SoundEvent:"minecraft:item.trident.hit",Passengers:[{id:"minecraft:snowball",Tags:[SkillSnowball],Item:{id:"minecraft:snowball",Count:1b,tag:{CustomModelData:1}}}]}
