...
function calc:get/angle

#Mob Rotation - 0-0-0-0-1 Rotation
#Rotation[0] = @s _  Rotation[1] _ Calc
execute store result score _ Calc run data get storage calc: Rotation[1] 1000
...
execute store result score @s _ run data get storage calc: Rotation[0] 1000
