...
#回復コウモリ召喚 - 2tick後に現れる
# summon minecraft:bat ~ ~ ~ {PortalCooldown:400,Tags:[GinSpiritBat,TickingRequired,NativeTask,Initializing,Initialized],Invulnerable:true,Team:Light_Purple,DeathTime:19s,Attributes:[{Name:"generic.max_health",Modifiers:[{Amount:0.1d,UUID:[I;0,0,0,0]},{Amount:3.6d,UUID:[I;0,0,0,1]},{Amount:1d,UUID:[I;0,0,0,2]}]}],ActiveEffects:[{Id:14,Amplifier:127,Duration:-1,ShowParticles:0b},{Id:24,Amplifier:127,Duration:-1,ShowParticles:0b}]}
