...
#3
execute if score _ FillSize matches 3..4 if score @s FillSize matches 3 run data modify block 2 3 2 Text1 set value '[{"block":"2 3 2","nbt":"Text1","interpret":true},{"text":" "},{"text":"5x5","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger ChangeSettings set 103"}}]'
execute if score _ FillSize matches 3..4 unless score @s FillSize matches 3 run data modify block 2 3 2 Text1 set value '[{"block":"2 3 2","nbt":"Text1","interpret":true},{"text":" "},{"text":"5x5","color":"white","clickEvent":{"action":"run_command","value":"/trigger ChangeSettings set 103"}}]'
#4
execute if score _ FillSize matches 4 if score @s FillSize matches 4 run data modify block 2 3 2 Text1 set value '[{"block":"2 3 2","nbt":"Text1","interpret":true},{"text":" "},{"text":"7x7","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger ChangeSettings set 104"}}]'
execute if score _ FillSize matches 4 unless score @s FillSize matches 4 run data modify block 2 3 2 Text1 set value '[{"block":"2 3 2","nbt":"Text1","interpret":true},{"text":" "},{"text":"7x7","color":"white","clickEvent":{"action":"run_command","value":"/trigger ChangeSettings set 104"}}]'
