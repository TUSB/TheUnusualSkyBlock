...
#summon minecraft:snow_golem ~ ~ ~ {Team:Friendly,Health:200f,active_effects:[{id:"haste",duration:-1,amplifier:0b,show_particles:false},{id:"minecraft:levitation",duration:18,amplifier:2b,show_particles:true},{id:"minecraft:slow_falling",duration:30,amplifier:0b,show_particles:true}],Attributes:[{Name:"generic.max_health",Base:200d},{Name:"generic.movement_speed",Base:0.4d},{Name:"generic.follow_range",Base:48d}],CustomName:'{"translate":"フレンドリー"}',CustomNameVisible:true,DeathLootTable:""}
