...
summon minecraft:snow_golem ~ ~ ~ {Team:Friendly,Health:200f,ActiveEffects:[{Id:3b,Duration:2147483647,Amplifier:0b,ShowParticles:false},{Id:25b,Duration:18,Amplifier:2b,ShowParticles:true},{Id:28b,Duration:30,Amplifier:0b,ShowParticles:true}],Attributes:[{Name:"generic.max_health",Base:200d},{Name:"generic.movement_speed",Base:0.4d},{Name:"generic.follow_range",Base:48d}],CustomName:'{"text":"フレンドリー"}',CustomNameVisible:true,DeathLootTable:"minecraft:empty"}
