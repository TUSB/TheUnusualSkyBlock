...
#投射物を召喚
execute anchored eyes run summon arrow ^ ^ ^0.5 {Tags:[Skill,PomPom,NativeTask,CooldownRequired,KillInGround],PortalCooldown:7,NoGravity:1b,damage:1,Color:16777215}
