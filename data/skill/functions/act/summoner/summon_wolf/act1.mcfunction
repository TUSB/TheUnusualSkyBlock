...
summon minecraft:wolf ~ ~ ~ {Motion:[0d,0.5d,0d],Tags:[NativeTask,CooldownRequired],PortalCooldown:3000,Team:Friendly,AbsorptionAmount:50f,ActiveEffects:[{Id:5b,Duration:2147483647,Amplifier:0b,ShowParticles:false},{Id:11b,Amplifier:4b,Duration:50}],Attributes:[{Name:"generic.attack_damage",Base:4d,Modifiers:[{Amount:28d,Operation:0,UUID:[I;0,0,0,1]}]},{Name:"generic.movement_speed",Base:0.4d},{Name:"generic.follow_range",Base:48d}],CustomName:'{"translate":"フレンドリー"}',CustomNameVisible:true}
