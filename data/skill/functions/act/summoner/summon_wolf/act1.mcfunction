...
summon minecraft:wolf ~ ~ ~ {CustomName:'{"translate":"フレンド・ウルフ","color":"#FFFF00","bold":true}',CustomNameVisible:true,Motion:[0d,0.5d,0d],PortalCooldown:3000,Team:Friendly,ActiveEffects:[{Id:5,Duration:2147483647,Amplifier:0b,ShowParticles:false},{Id:11,Amplifier:4b,Duration:50}],Attributes:[{Name:"generic.movement_speed",Base:0.4d},{Name:"generic.follow_range",Base:48d}]}
