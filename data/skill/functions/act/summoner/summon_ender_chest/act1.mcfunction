...
execute if block ~ ~-0.875 ~ minecraft:air positioned ~ ~-0.875 ~ align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ minecraft:air run summon minecraft:armor_stand ~ ~ ~ {Marker:true,Invisible:true,Invulnerable:true,NoGravity:true,Tags:[SummonedBlock,NativeTask,Initializing]}
