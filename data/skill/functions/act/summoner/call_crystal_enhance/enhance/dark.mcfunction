...
## TODO マナリフレッシュ実装後適用
# execute if score @s Level matches 201 run scoreboard players set $ManaRefreshValue Global 301
# execute if score @s Level matches 202 run scoreboard players set $ManaRefreshValue Global 601
# execute if score @s Level matches 203 run scoreboard players set $ManaRefreshValue Global 901

# execute if score @s Level matches 201..209 run scoreboard players operation @a[distance=..10] ManaRefresh > $ManaRefreshValue Global
