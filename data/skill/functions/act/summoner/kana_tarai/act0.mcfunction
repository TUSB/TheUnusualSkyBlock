...
#ダメージを保存
execute as @e[tag=KanaTaraiInit,distance=..32] run function skill:damage/save
tag @e[tag=KanaTaraiInit,distance=..32] remove KanaTaraiInit
#演出
