...
#プレイヤーTP
execute if score @s SneakTime matches 1.. if score _ Level matches 1 as @a[distance=0.01..10,gamemode=!creative,gamemode=!spectator,tag=!Unmoved] positioned as 0-0-0-0-0 run tp @s ~ ~ ~
execute if score @s SneakTime matches 1.. if score _ Level matches 2 as @a[distance=0.01..20,gamemode=!creative,gamemode=!spectator,tag=!Unmoved] positioned as 0-0-0-0-0 run tp @s ~ ~ ~
execute if score @s SneakTime matches 1.. if score _ Level matches 3 as @a[distance=0.01..30,gamemode=!creative,gamemode=!spectator,tag=!Unmoved] positioned as 0-0-0-0-0 run tp @s ~ ~ ~
#演出
