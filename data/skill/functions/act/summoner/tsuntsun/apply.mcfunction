...
execute store result entity @s Attributes[{Name:"minecraft:generic.attack_damage"}].Base double 0.015 run data get entity @s Attributes[{Name:"minecraft:generic.attack_damage"}].Base 100
#演出
