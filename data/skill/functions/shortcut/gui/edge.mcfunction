...
execute in area:control_area run data modify block 2 3 2 Text1 set value '[{"text":""},{"storage":"skill:","nbt":"SkillShortcut[0].Icon","font":"icon","color":"green"},{"storage":"skill:","nbt":"SkillShortcut[0].Skill"}]'
execute in area:control_area run data modify storage skill: SkillShortcut[0].SkillName set from block 2 3 2 Text1
