...
execute if entity @s[advancements={skill:shortcut={mainhand=true}}] store success score _ Calc run data modify storage item: Item set from entity @s SelectedItem
