...
#Loreセット
#スキル名
data modify block 0 4 0 Text1 set value '[{"text":"","color":"white","italic":false},{"storage":"skill:","nbt":"Skill.Icon","font":"icon","color":"green"},{"text":" "},{"storage":"skill:","nbt":"Skill.Skill"}]'
data modify storage item: Items[0].tag.display.Lore append from block 0 4 0 Text1
#説明
...
data modify storage item: Items[0].tag.display.Lore append from block 0 4 0 Text1
#消費MP
data modify block 0 4 0 Text1 set value '[{"text":"","color":"white","italic":false},{"text":"M","font":"icon","color":"aqua"},{"text":" 消費MP: "},{"storage":"skill:","nbt":"Skill.MP"}]}}]'
data modify storage item: Items[0].tag.display.Lore append from block 0 4 0 Text1
#スキル付与
