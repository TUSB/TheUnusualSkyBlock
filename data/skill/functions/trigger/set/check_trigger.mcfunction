...
execute if data storage skill: Skill{Trigger:"弓を構えて矢を撃つ"} if data entity @s SelectedItem{id:"minecraft:bow"} store success score _ _ run function skill:trigger/set/set
execute if data storage skill: Skill{Trigger:"クロスボウを構えて矢を撃つ"} if data entity @s SelectedItem{id:"minecraft:crossbow"} store success score _ _ run function skill:trigger/set/set
