...
#職業一覧
data modify block 2 3 2 Text1 set value '[{"text":"<"},{"text":" K ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 1000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"剣士"}]}},{"text":"> <"},{"text":" N ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 2000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"忍者"}]}},{"text":"> <"},{"text":" H ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 3000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"狩人"}]}},{"text":"> <"},{"text":" W ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 4000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"白魔道士"}]}},{"text":"> <"},{"text":" B ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 5000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"黒魔道士"}]}},{"text":"> <"},{"text":" S ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 6000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"召喚士"}]}},{"text":"> <"},{"text":" P ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 7000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"絡繰士"}]}},{"text":"> <"},{"text":" T ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 8000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"怪盗"}]}},{"text":"> <"},{"text":" C ","font":"icon","color":"aqua","clickEvent":{"action":"run_command","value":"/scoreboard players set @s ChangeSkill 9000"},"hoverEvent":{"action":"show_text","contents":[{"translate":"共通"}]}},{"text":">"},{"storage":"skill:","nbt":"NewLine","interpret":true},{"text":"----------------------------------------------------"},{"storage":"skill:","nbt":"NewLine","interpret":true}]'
#習得しているスキル一覧
