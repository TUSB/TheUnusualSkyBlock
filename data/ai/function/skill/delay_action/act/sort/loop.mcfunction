...
data modify storage mob_data: AddingAction set from storage mob_data: SortingActionData[-1]
function ai:skill/delay_action/append/search
data remove storage mob_data: SortingActionData[-1]
execute if data storage mob_data: SortingActionData[-1] run function ai:skill/delay_action/act/sort/loop
