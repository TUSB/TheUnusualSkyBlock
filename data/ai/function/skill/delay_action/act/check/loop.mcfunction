...
###Execute
execute if score @s _ matches ..0 run function ai:skill/delay_action/act/execute/
###Dataを戻す
...
###Loop
execute if data storage mob_data: CheckingAction[-1] run function ai:skill/delay_action/act/check/loop
