...
execute if score 00000000-0000-0000-0000-000000000000 Calc matches 801.. if score 00000000-0000-0000-0000-000000000001 Calc matches ..1600 run tag @e[tag=Enemy,distance=8.01..16] add TargetCards
execute if score 00000000-0000-0000-0000-000000000000 Calc matches 1601.. if score 00000000-0000-0000-0000-000000000001 Calc matches ..3200 run tag @e[tag=Enemy,distance=16.01..32] add TargetCards
execute if score 00000000-0000-0000-0000-000000000000 Calc matches 3201.. if score 00000000-0000-0000-0000-000000000001 Calc matches ..6400 run tag @e[tag=Enemy,distance=32.01..64] add TargetCards
execute if score 00000000-0000-0000-0000-000000000000 Calc matches 6401.. if score 00000000-0000-0000-0000-000000000001 Calc matches ..12800 run tag @e[tag=Enemy,distance=64.01..128] add TargetCards

#細かく調べてダメージを与える
execute as @e[tag=TargetCards] run function ai:skill/damage/check_distance
