#> ai:skill/laser/loop/security_laser/single/damage
data modify storage score_damage: Argument.DeathCause set value '[{"translate":"%1$sは%2$sによって蒸発させられた。","with":[{"selector":"@s"},{"nbt":"MobName","storage":"mob_data:","interpret":true}]}]'
