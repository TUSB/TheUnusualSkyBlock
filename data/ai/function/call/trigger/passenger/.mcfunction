...
##下にいるかを確認
execute if data storage mob_data: AI.Passenger{Type:"down",Check:1b} if predicate entity:vehicle if predicate ai:not_trigger_call_passenger run function ai:call/trigger/passenger/trigger
