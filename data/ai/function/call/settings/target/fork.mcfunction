...
execute if data storage mob_data: Target{Look:"Parent"} run function ai:call/settings/target/parent
execute if data storage mob_data: Target{Look:"Child"} run function ai:call/settings/target/child

execute if score @s Calc matches 1 at @s facing entity 0-0-0-0-0 feet facing ^ ^ ^-1 positioned as 0-0-0-0-0 run function ai:call/settings/target/loop
