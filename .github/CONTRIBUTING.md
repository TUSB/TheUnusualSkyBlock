...
- **基本ルール**:  
  コメントする人は何人たりとも、TUSB基本ポリシーに従ったコメントを行うべきです。[[ポリシー](https://skyblock.jp/overview/)]
- **レビューコメント**:  
  一般的に他人の成果物に対してコメントを行う場合、余計な推察やコミュニケーション事故が発生しがちです。なるべく意図が伝わりリスペクトするように心がけましょう。  
...
- **コミットメッセージの命名規則**:
  ...
  - **変更を表す動詞の原形**: メッセージの説明で先頭に英語で最初大文字の動詞の原形  
    ...
    ([参考2](https://note.com/haru_notes/n/n3d9c406e9ac6))
  - **簡単な説明**: 何をしたのか一言でわかる文章にしてください。  
    長くなる場合はDescriptionに書いても問題ありません。
...
- **適切な粒度**:  
  コミットの粒度は適切に保ってください。1コミットにつき1要素（1ロジック）の変更が望ましいです。
